...
description: 'Lync Server 2013: modificación de las propiedades de la cuenta de usuario.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48559356"
---
# <a name="modifying-user-account-properties-in-lync-server-2013"></a>Modificación de las propiedades de la cuenta de usuario en Lync Server 2013
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Configurar la telefonía para un usuario en Lync Server 2013](lync-server-2013-configure-telephony-for-a-user.md)

  - [Mover usuarios a otro grupo de servidores en Lync Server 2013](lync-server-2013-move-users-to-another-pool.md)
