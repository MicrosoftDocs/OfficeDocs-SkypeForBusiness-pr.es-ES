...
description: 'Lync Server 2013: personalización del comportamiento de Lync y la interfaz de usuario.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Iniciar Lync desde otra aplicación](lync-server-2013-starting-lync-from-another-application.md)

  - [Configuración de las opciones predeterminadas de imagen en Lync Server 2013](lync-server-2013-configuring-default-picture-options.md)
