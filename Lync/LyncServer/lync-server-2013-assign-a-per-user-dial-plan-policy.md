...
## <a name="assign-a-per-user-dial-plan-by-using-windows-powershell-cmdlets"></a>Asignación de un plan de marcado Per-User mediante cmdlets de Windows PowerShell
