...
# <a name="phase-7-complete-post-migration-tasks"></a>Fase 7: completar las tareas posteriores a la migración
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Migrar los grupos de respuesta](migrate-response-groups.md)
  ...
  - [Configuración de servidores de aplicaciones de confianza](configure-trusted-application-servers.md)
