...
En Lync Server 2013, la Directiva de conferencia define la programación del usuario y la experiencia de participación, y la configuración de unión a reuniones que se encuentra en la página Configuración de reunión define lo siguiente:
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Ver las opciones de configuración de reuniones en Lync Server 2013](lync-server-2013-view-meeting-configuration-settings.md)
