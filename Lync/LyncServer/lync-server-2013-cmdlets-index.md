...
# <a name="lync-server-2013-cmdlets-index"></a>Índice de cmdlets de 2013 de Lync Server
...
Para recuperar una lista completa de los cmdlets disponibles para administrar Lync Server, escriba lo siguiente en el símbolo del sistema del shell de administración de Lync Server:

    Get-Command * -Module Lync -CommandType cmdlet

Para obtener detalles sobre el uso del shell de administración de Lync Server, consulte el blog de [http://go.microsoft.com/fwlink/p/?linkId=203150](http://go.microsoft.com/fwlink/p/?linkid=203150)Windows PowerShell de Lync Server en.

<div>

## <a name="lync-server-2013-cmdlets"></a>Cmdlets de 2013 de Lync Server

A continuación se muestra una lista de los cmdlets que se distribuyen con Lync Server 2013:
  ...
  - [Importar-CsRgsAudioFile](https://technet.microsoft.com/en-us/library/Gg412830(v=OCS.15))
  ...
  - [Mover-CsRgsConfiguration](https://technet.microsoft.com/en-us/library/Gg398782(v=OCS.15))

  - [Mover-CsUser](https://technet.microsoft.com/en-us/library/Gg398528(v=OCS.15))
  ...
  - [Nuevo: CsBandwidthPolicyServiceConfiguration](https://technet.microsoft.com/en-us/library/Gg398175(v=OCS.15))
  ...
  - [Nuevo: CsHostedVoicemailPolicy](https://technet.microsoft.com/en-us/library/Gg398653(v=OCS.15))
  ...
  - [Nuevo: CsMediaConfiguration](https://technet.microsoft.com/en-us/library/Gg425881(v=OCS.15))
  ...
  - [Nuevo: CsRgsAgentGroup](https://technet.microsoft.com/en-us/library/Gg413065(v=OCS.15))

  - [Nuevo: CsRgsAnswer](https://technet.microsoft.com/en-us/library/Gg412812(v=OCS.15))

  - [Nuevo: CsRgsCallAction](https://technet.microsoft.com/en-us/library/Gg398136(v=OCS.15))

  - [Nuevo: CsRgsHoliday](https://technet.microsoft.com/en-us/library/Gg398075(v=OCS.15))

  - [Nuevo: CsRgsHolidaySet](https://technet.microsoft.com/en-us/library/Gg398403(v=OCS.15))

  - [Nuevo: CsRgsHoursOfBusiness](https://technet.microsoft.com/en-us/library/Gg398291(v=OCS.15))

  - [New-CsRgsPrompt](https://technet.microsoft.com/en-us/library/Gg398486(v=OCS.15))

  - [Nuevo: CsRgsQuestion](https://technet.microsoft.com/en-us/library/Gg398186(v=OCS.15))

  - [Nuevo: CsRgsQueue](https://technet.microsoft.com/en-us/library/Gg398989(v=OCS.15))

  - [Nuevo: CsRgsTimeRange](https://technet.microsoft.com/en-us/library/Gg399040(v=OCS.15))

  - [Nuevo: CsRgsWorkflow](https://technet.microsoft.com/en-us/library/Gg398246(v=OCS.15))

  - [Nuevo: CsRoutingConfiguration](https://technet.microsoft.com/en-us/library/Gg399056(v=OCS.15))

  - [Nuevo: CsServerApplication](https://technet.microsoft.com/en-us/library/Gg398096(v=OCS.15))
  ...
  - [Nuevo: CsVoicemailReroutingConfiguration](https://technet.microsoft.com/en-us/library/Gg425849(v=OCS.15))
