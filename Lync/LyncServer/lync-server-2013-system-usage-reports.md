...
---
# <a name="system-usage-reports-in-lync-server-2013"></a>Informes de uso del sistema en Lync Server 2013
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Informe de Resumen de conferencia en Lync Server 2013](lync-server-2013-conference-summary-report.md)
