...
## <a name="scaled-consolidated-edge-using-dns-load-balancing-with-public-ip-addresses"></a>Borde consolidado escalado mediante el equilibrio de carga de DNS con direcciones IP públicas
