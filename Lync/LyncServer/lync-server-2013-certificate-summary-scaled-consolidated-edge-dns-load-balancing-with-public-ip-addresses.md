...
## <a name="scaled-consolidated-edge-using-dns-load-balancing-with-public-ip-addresses"></a>Perímetro consolidado escalado que usa el equilibrio de carga de DNS con direcciones IP públicas
...
<tbody>
<tr class="odd">
<td><p>Servidor perimetral consolidado en escala (perímetro externo)</p></td>
