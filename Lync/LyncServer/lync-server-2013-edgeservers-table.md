...
La tabla EdgeServers es una tabla de apoyo. Cada registro almacena información sobre un servidor perimetral implicado en llamadas que tienen registros en la base de datos.
