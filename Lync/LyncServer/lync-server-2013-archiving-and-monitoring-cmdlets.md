...
Los cmdlets de archivado y supervisión permiten que los administradores administren el archivado de sesiones de conferencia y mensajería instantánea; para registrar información de detalles de llamadas; y para supervisar Microsoft Lync Server 2013 mediante la calidad de la experiencia (QoE).


> [!NOTE]
> Para obtener más información acerca de los cmdlets, vea&nbsp;el blog de Lync <A href="https://go.microsoft.com/fwlink/p/?linkid=263432">https://go.microsoft.com/fwlink/p/?linkId=263432</A>Server Windows PowerShell en. El contenido de cada blog y su dirección URL están sujetos a cambio sin previo aviso.



<div>

## <a name="archiving-and-monitoring-cmdlets"></a>Cmdlets de archivado y supervisión
