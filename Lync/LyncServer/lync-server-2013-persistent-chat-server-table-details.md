...
TOCTitle: Detalles de la tabla del servidor de chat persistente
ms:assetid: c22d4a76-da50-49de-9038-e0ed7b8e1b58
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg615034(v=OCS.15)
ms:contentKeyID: 48276577
ms.date: 01/07/2017
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Detalles de la tabla del servidor de chat persistente en Lync Server 2013

 

_**Última modificación del tema:** 2012-06-25_

En los temas siguientes se detallan las columnas de cada tabla del esquema de la base de datos de Chat persistente.
