...
Puede administrar las directivas de PIN de Lync Server 2013 en el panel de control de Lync Server 2013 o en el shell de administración de Lync Server. Use los siguientes procedimientos para configurar las directivas de PIN para su organización.

<div>

## <a name="in-this-section"></a>En esta sección

  - [Ver información de directivas de PIN en Lync Server 2013](lync-server-2013-view-pin-policy-inforrmation.md)
