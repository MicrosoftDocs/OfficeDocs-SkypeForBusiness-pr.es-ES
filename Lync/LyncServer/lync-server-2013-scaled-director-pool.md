...
---
# <a name="scaled-director-pool-in-lync-server-2013"></a>Grupo de Director escalado en Lync Server 2013
...
El director puede implementarse en una configuración de un solo Director o como un grupo de directores. En esta sección se define una topología y una configuración para dos topologías de Director agrupado. Si tiene previsto implementar un solo Director, consulte el tema [Director único en Lync Server 2013](lync-server-2013-single-director.md) para planear las consideraciones de la topología.
