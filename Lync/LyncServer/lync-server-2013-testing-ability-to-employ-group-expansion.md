...
Test-CsGroupExpansion: no se pudo registrar el punto de conexión. Consulte ErrorCode por motivos específicos.
...
Si Test-CsGroupExpansion da error, es posible que desee volver a ejecutar la prueba, pero esta vez incluya el parámetro verbose:
...
Estas son algunas de las razones comunes por las que Test-CsGroupExpansion podría producir un error:
