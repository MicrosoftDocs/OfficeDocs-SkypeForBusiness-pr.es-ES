...
Los usuarios finales se benefician de poder conectar con los clientes, socios y proveedores en sus términos. Se beneficia de la compatibilidad de un solo cliente de comunicaciones en tiempo real a la vez que se mantienen las características de control, cumplimiento y archivado de Lync. Lync-Skype conectividad, [disponible públicamente en mayo de 2013](https://blogs.technet.com/b/lync/archive/2013/05/23/lync-skype-connectivity-available-today.aspx), se basa en el heredado de que Lync/Office Communications Server (OCS)/Live Communications Server (LCS) se estableció por primera vez con PIC en la conexión a MSN/Windows Live, AOL y Yahoo.Para obtener más información acerca de la conectividad de Lync-Skype, consulte [Lync-Skype Connectivity](https://office.microsoft.com/lync/lync-skype-connectivity-fx103789635.aspx). La Federación con Windows Live, AOL y Yahoo se encuentran en una ruta hacia el final de la vida.Esta página documenta el estado de cada servicio.
...
Lync-Skype conectividad: la adición de contactos, el uso compartido de presencia, la mensajería instantánea y las llamadas de audio entre los usuarios de Lync y Skype, también está disponible para todos los clientes de Lync.
