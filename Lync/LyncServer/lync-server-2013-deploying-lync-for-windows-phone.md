...
# <a name="deploying-lync-for-windows-phone-in-lync-server-2013"></a>Implementar Lync para Windows Phone en Lync Server 2013
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Instalar Lync para Windows Phone en Lync Server 2013](lync-server-2013-installing-lync-for-windows-phone.md)

  - [Quitar Lync para Windows Phone en Lync Server 2013](lync-server-2013-removing-lync-for-windows-phone.md)
