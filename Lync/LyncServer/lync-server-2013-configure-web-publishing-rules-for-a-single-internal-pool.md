...
1.  Enlace el certificado que va a usar para el proxy inverso en el protocolo HTTPS. Haga clic en **Inicio**, seleccione **programas**, seleccione **herramientas administrativas**y, a continuación, haga clic en **Administrador de Internet Information Services (IIS)**.
    ...
    > [!NOTE]  
    > Puede encontrar ayuda adicional, capturas de pantalla y orientación sobre la implementación y la configuración de IIS ARR en el artículo de NextHop <A href="http://go.microsoft.com/fwlink/?linkid=293391">mediante el uso de IIS ARR como proxy inverso para Lync Server 2013</A>.
