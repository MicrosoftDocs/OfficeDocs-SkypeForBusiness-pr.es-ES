...
Para obtener la lista más actualizada de la configuración de la Directiva de conferencia, consulte el tema de ayuda del cmdlet [set-CsClientPolicy](https://docs.microsoft.com/powershell/module/skype/Set-CsClientPolicy) .
