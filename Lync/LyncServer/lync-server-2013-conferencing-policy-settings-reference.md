...
Para obtener la lista más actualizada de la configuración de directiva de conferencias, vea el tema de ayuda sobre el cmdlet [set-ClientPolicy](https://docs.microsoft.com/powershell/module/skype/Set-CsClientPolicy) .
