...
# <a name="get-cswebserviceconfiguration-for-address-book-management-in-lync-server-2013"></a>Get-CsWebServiceConfiguration para la administración de libretas de direcciones en Lync Server 2013
...
Get-CsWebServiceConfiguration devuelve información de la configuración de los servicios web actualmente en uso en su organización. De interés para los servicios de la libreta de direcciones es el estado de la función de expansión lista de distribución. Si el atributo EnableGroupExpansion es verdadero, su organización actualmente permite la expansión grupal.
