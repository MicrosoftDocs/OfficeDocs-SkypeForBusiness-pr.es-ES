...
---
# <a name="software-setup-for-lync-server-2013"></a>Configuración de software de Lync Server 2013
...
En esta sección se detalla la configuración del software que se necesita una vez que haya configurado el hardware en su entorno.
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Solicitar certificados de antemano (opcional) para Lync Server 2013](lync-server-2013-request-certificates-in-advance-optional.md)

  - [Configurar IIS para Lync Server 2013](lync-server-2013-configure-iis.md)

  - [Instalación de Windows PowerShell 3,0 para Lync Server 2013](lync-server-2013-installing-windows-powershell-3-0.md)
