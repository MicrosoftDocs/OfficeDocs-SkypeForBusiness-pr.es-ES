...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dn720559(v=OCS.15)
ms:contentKeyID: 62227432
ms.date: 01/07/2017
...
<p><a href="lync-server-2013-deploying-monitoring.md">Implementación de supervisión en Lync Server 2013</a></p></td>
...
<td><p>Deploy Call Reliability and Media Quality MonitoringCall reliability and media quality monitoring use the Servidor de supervisión computer as their watcher node to monitor call reliability and media quality of Lync Server. Both of these features query the Servidor de supervisión databases to do analysis.</p></td>
<td><p>Central Site</p>
<p>Branch Site</p></td>
</tr>
<tr class="even">
