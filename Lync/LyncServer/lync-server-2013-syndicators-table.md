...
# <a name="syndicators-table-in-lync-server-2013"></a>Tabla de sindicación en Lync Server 2013
...
SyndicatorsTable es únicamente para uso interno. Esta tabla se introdujo en Microsoft Lync Server 2013.
