...
# <a name="frontend-table-in-lync-server-2013"></a>Tabla de FrontEnd en Lync Server 2013
...
La tabla de FrontEnd es solo para uso interno. Esta tabla se introdujo en Microsoft Lync Server 2013.
