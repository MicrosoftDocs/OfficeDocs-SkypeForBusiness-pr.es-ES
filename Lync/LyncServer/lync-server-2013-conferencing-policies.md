...
# <a name="conferencing-policies-in-lync-server-2013"></a>Directivas de conferencia en Lync Server 2013
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Ver información de directiva de conferencia en Lync Server 2013](lync-server-2013-view-conferencing-policy-information.md)
  ...
  - [Eliminar una directiva de conferencia existente en Lync Server 2013](lync-server-2013-delete-an-existing-conferencing-policy.md)
