---
title: Tabla UserAgentDef (QoE) en Lync Server 2013
TOCTitle: Tabla UserAgentDef (QoE) en Lync Server 2013
ms:assetid: cfd8e3e0-4076-4162-9381-5276da8316d9
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205259(v=OCS.15)
ms:contentKeyID: 48276735
ms.date: 01/07/2017
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Tabla UserAgentDef (QoE) en Lync Server 2013

 

_**Última modificación del tema:** 2015-03-09_

La tabla UserAgentDef asigna identificadores de agente de usuario a los nombres descriptivos de agente. Los agentes de usuario son clientes de software que se usan para conectarse con Microsoft Lync Server 2013.
