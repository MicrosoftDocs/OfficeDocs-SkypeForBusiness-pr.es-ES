...
Si el historial del salón de chat persiste (la persistencia del salón de chat es una configuración opcional en una categoría que se aplica a todas las salas de la categoría; el valor predeterminado es persistir, pero se puede desactivar si se configura la categoría **Habilitar el historial de conversaciones** en falso), el contenido se conserva cuando el salón de chat está deshabilitado. Pero, dicho contenido no aparecerá en las búsquedas mientras el salón de chat permanezca deshabilitado. Si vuelve a habilitar el salón de chat, los usuarios podrán buscar mensajes publicados antes de que se deshabilitara el salón de chat.
