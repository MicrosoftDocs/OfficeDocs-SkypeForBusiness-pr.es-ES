...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Requisitos de la infraestructura de red para Lync Server 2013](lync-server-2013-network-infrastructure-requirements.md)
  ...
  - [Requisitos de puertos para Lync Server 2013](lync-server-2013-port-requirements.md)
