...
Si Test-CsVoicePolicy no devuelve una coincidencia que podría significar que la Directiva de voz no comparte el uso de RTC con una ruta de voz. Para comprobar que, use un cmdlet similar al siguiente para comprobar que los usos de RTC asignados a la Directiva de voz:
