...
Para obtener información detallada sobre cómo trabajar con vínculos de región de red, vea la documentación del shell de administración de Lync Server para los siguientes cmdlets:
...
La topología de ejemplo tiene un vínculo entre las regiones de Norteamérica y APAC, y uno entre las regiones de EMEA y APAC. Cada uno de estos vínculos de región está restringido por el ancho de banda de WAN, tal como se describe en la tabla de información de ancho de banda de vínculos de región en la sección [ejemplo: recopilación de los requisitos para el control de admisión de llamadas en Lync Server 2013](lync-server-2013-example-of-gathering-your-requirements-for-call-admission-control.md) de la documentación de planeación.

<div>

## <a name="to-create-network-region-links-by-using-lync-server-management-shell"></a>Para crear vínculos de región de red mediante el Shell de administración de Communications Server
...
## <a name="to-create-network-region-links-by-using-lync-server-control-panel"></a>Para crear vínculos de región de red mediante el Panel de control de Lync Server
...
7.  Haga clic en **región \#de red 2**y, a continuación, haga clic en una región de red en la lista \#que desea vincular a la región de red 1.
