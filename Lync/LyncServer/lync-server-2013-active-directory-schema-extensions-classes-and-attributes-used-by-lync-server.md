...
Esta sección de referencia incluye la información siguiente:
  ...
  - Cambios que se realizan en una unidad organizativa (OU) de Active Directory mediante el \_ cmdlet Grant CsSetupPermission.

  - Cambios que se realizan en una unidad organizativa de Active Directory mediante el \_ cmdlet Grant CsOUPermission.
