...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dn727307(v=OCS.15)
ms:contentKeyID: 62388668
ms.date: 01/07/2017
...
<td><p>When run locally using the Shell de administración de Lync Server, users must be members of the RTCUniversalServerAdmins security group, and need to have Administrator privileges on the SQL server.</p>
