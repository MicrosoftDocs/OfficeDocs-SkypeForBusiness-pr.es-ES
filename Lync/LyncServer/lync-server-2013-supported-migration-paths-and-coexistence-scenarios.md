...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Rutas de migración de servidor compatibles y escenarios de coexistencia en Lync Server 2013](lync-server-2013-supported-server-migration-paths-and-coexistence-scenarios.md)
