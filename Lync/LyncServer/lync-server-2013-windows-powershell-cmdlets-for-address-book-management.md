...
Lync Server proporciona varios cmdlets de la interfaz de línea de comandos de Windows PowerShell para administrar y configurar el servicio de libreta de direcciones. Algunos de estos cmdlets son sustituciones para los comandos ABserver. exe usados en versiones anteriores de Office Communications Server. En los siguientes temas se incluyen los cmdlets que se usan para establecer, crear y recuperar información sobre el servicio de libreta de direcciones, su configuración e información sobre los servicios web que usa el servicio de libreta de direcciones cuando los clientes recuperan el servicio de libreta de direcciones archivos y configuración.
