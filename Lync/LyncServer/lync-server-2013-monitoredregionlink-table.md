...
# <a name="monitoredregionlink-table-in-lync-server-2013"></a>Tabla MonitoredRegionLink en Lync Server 2013
...
<td><p>Se hace referencia a ella desde la <a href="lync-server-2013-region-table.md">tabla región de Lync Server 2013</a>.</p></td>
</tr>
<tr class="even">
