...
Después de configurar las plataformas y la infraestructura del sistema para el archivado, debe usar el generador de topologías para agregar el archivado a la topología y, a continuación, publicar la topología.

<div>

## <a name="in-this-section"></a>En esta sección

  - [Adición de bases de datos de archivado a la topología de 2013 de Lync Server](lync-server-2013-adding-archiving-databases-to-the-lync-server-2013-topology.md)

  - [Publicación de la topología actualizada para agregar bases de datos de archivado en Lync Server 2013](lync-server-2013-publishing-the-updated-topology-to-add-archiving-databases.md)
