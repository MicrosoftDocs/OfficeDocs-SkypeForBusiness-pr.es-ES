...
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>Obtener disponibilidad de grupo de servidores de chat persistente en Lync Server 2013
