...
# <a name="configuring-call-park-in-lync-server-2013"></a>Configurar el estacionamiento de llamadas en Lync Server 2013
...
Esta sección le guiará a través de la configuración de la llamada de estacionamiento.
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Habilitar el parque de llamadas para los usuarios en Lync Server 2013](lync-server-2013-enable-call-park-for-users.md)

  - [Comprobar reglas de normalización del parque de llamadas en Lync Server 2013](lync-server-2013-verify-normalization-rules-for-call-park.md)

  - [Faculta Comprobar la implementación del parque de llamadas en Lync Server 2013](lync-server-2013-optional-verify-call-park-deployment.md)
