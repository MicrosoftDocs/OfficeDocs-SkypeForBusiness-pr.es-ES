...
Si vuelve a usar un servidor de administración central desde una implementación existente de Lync Server 2013, debe ejecutar el procedimiento que se describe a continuación para asegurarse de que el panel de control de Lync Server y Windows PowerShell funcionan correctamente.
