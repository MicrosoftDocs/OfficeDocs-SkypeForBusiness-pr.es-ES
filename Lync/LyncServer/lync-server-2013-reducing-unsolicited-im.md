...
# <a name="reducing-unsolicited-im-for-lync-server-2013"></a><span data-ttu-id="c3ddc-102">Reducir la mensajería instantánea no solicitada para Lync Server 2013</span><span class="sxs-lookup"><span data-stu-id="c3ddc-102">Reducing unsolicited IM for Lync Server 2013</span></span>
