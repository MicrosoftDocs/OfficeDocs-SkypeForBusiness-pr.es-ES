...
Microsoft Lync Server 2013 proporciona cmdlets que permiten administrar aplicaciones de Lync Server y aplicaciones de terceros de confianza.
...
**[Cmdlets de extremos de aplicación en Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
