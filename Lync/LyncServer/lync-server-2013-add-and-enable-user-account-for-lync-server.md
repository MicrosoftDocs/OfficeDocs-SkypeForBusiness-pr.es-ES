...
# <a name="add-and-enable-user-account-for-lync-server-2013"></a>Agregar y habilitar la cuenta de usuario para Lync Server 2013
...
Después de habilitar una cuenta de usuario en usuarios y equipos de Active Directory, puede usar el panel de control de Lync Server para crear y habilitar nuevas cuentas de usuario de Lync Server 2013 mediante la adición de un usuario de Active Directory a Lync Server.
