...
description: 'Lync Server 2013: cmdlets de extremos de la aplicación.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568926"
---
# <a name="application-endpoints-cmdlets-in-lync-server-2013"></a>Cmdlets de extremos de aplicación en Lync Server 2013
...
Los extremos de la aplicación son objetos de contacto dentro de los servicios de dominio de Active Directory. Puede usar cmdlets desde dentro del shell de administración de Lync Server para administrar estos contactos para Microsoft Lync Server 2013.

<div>

## <a name="application-endpoints-cmdlets"></a>Cmdlets de extremos de aplicación
