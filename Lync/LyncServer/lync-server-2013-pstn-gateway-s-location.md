...
Las llamadas enrutadas a través de puertas de enlace RTC y PBX pueden requerir restricciones de enrutamiento Location-Based en función de la ubicación de dichos sistemas. El enrutamiento Location-Based se puede habilitar en la granularidad en función de cada tronco.

Enrutamiento de Location-Based introduce el siguiente conjunto de reglas cuando se habilita en un tronco:

  - Cuando se habilita Location-Based enrutamiento por tronco, las reglas definidas en ese tronco se aplicarán solo a las llamadas enrutadas a través de ese tronco.
...
Los troncos pueden habilitarse para Location-Based enrutamiento de dos maneras:
