...
## <a name="assigning-a-per-user-pin-policy-by-using-windows-powershell-cmdlets"></a>Asignación de una directiva de PIN Per-User mediante cmdlets de Windows PowerShell
