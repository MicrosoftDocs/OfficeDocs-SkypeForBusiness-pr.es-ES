...
Al Informe de control de admisión de llamadas se obtiene acceso desde la página de inicio de Informes de supervisión. Desde el Informe de control de admisión de llamadas, puede obtener acceso a cualquiera de los informes siguientes:
  ...
  - Informe de detalles de conferencia: para obtener acceso a este informe, hada clic en la métrica Detalles desde una sesión de conferencia.

  - Informe de detalles de sesiones punto a punto: para obtener acceso a este informe, haga clic en la métrica Detalles desde una sesión punto a punto.
...
<ul>
<li><p>[Todas]</p></li>
<li><p>Llamada rechazada por el control de admisión de llamadas</p></li>
<li><p>Llamadas que se han vuelto a enrutar a través de RTC por el control de admisión de llamadas</p></li>
</ul></td>
</tr>
</tbody>
</table>
