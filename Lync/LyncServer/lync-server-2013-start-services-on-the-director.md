...
description: 'Lync Server 2013: inicie los servicios en el director.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
Después de instalar el almacén de configuración local, instalar los componentes de Lync Server y configurar los certificados en un director, debe iniciar los servicios de Lync Server en el servidor. Puede usar el siguiente procedimiento para iniciar servicios en cada uno de los directores de su implementación.

<div>

## <a name="to-start-services-on-a-director"></a>Para iniciar servicios en un director

1.  En el Asistente para la implementación de Lync Server, en la página **Lync server 2013** , haga clic en el botón **Ejecutar** junto a **paso 4: iniciar servicios**.
