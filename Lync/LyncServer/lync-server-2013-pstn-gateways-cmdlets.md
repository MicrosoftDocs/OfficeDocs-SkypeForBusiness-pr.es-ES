...
Los cmdlets [Test-CsPstnOutboundCall](https://technet.microsoft.com/en-us/library/Gg398207(v=OCS.15)) y [Test-CsPstnPeerToPeerCall](https://technet.microsoft.com/en-us/library/Gg398662(v=OCS.15)) permiten comprobar que los usuarios pueden hacer llamadas a través de la red PSTN.
