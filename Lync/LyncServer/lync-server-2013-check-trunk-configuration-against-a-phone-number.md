...
Ejecutar Test-CsTrunkConfiguration sin la primera ejecución Get-CsTrunkConfiguration no funcionará. Por ejemplo, se producirá un error en este comando sin que se devuelva ningún dato:
