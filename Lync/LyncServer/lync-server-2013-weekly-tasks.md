...
Asegúrese de que la RTCBPA.msi esté instalada en todos los servidores de Lync Server 2013 y genere un informe de comprobación del Estado semanal. Anote los resultados y corrija si es necesario.
...
<tr class="even">
<td><p>Informes de Per-User</p></td>
