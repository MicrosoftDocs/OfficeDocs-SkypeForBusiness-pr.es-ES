...
En esta sección se describe cómo implementar Lync 2013 para iPhone y Lync 2013 para iPad para sus usuarios móviles.

<div>

## <a name="in-this-section"></a>En esta sección

  - [Instalar Lync para iPhone y iPad en Lync Server 2013](lync-server-2013-installing-lync-for-iphone-and-ipad.md)

  - [Quitar Lync para iPhone y iPad en Lync Server 2013](lync-server-2013-removing-lync-for-iphone-and-ipad.md)
