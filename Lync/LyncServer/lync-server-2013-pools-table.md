...
description: 'Lync Server 2013: tabla pools.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
La tabla pools es una tabla de apoyo que almacena información sobre los distintos grupos de servidores. Cada registro de la tabla representa un grupo.
