...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486241
ms.date: 01/07/2017
...
For more information on OU permissions, see the article [La herencia de permisos está deshabilitada en los contenedores Computer, Users o InetOrgPerson en Lync Server 2013](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
