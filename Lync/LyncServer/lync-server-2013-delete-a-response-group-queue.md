...
Use uno de los procedimientos siguientes para eliminar una cola.
...
4.  En el campo de búsqueda, escriba parte o todo el nombre de la cola que desea eliminar.

5.  En la lista de colas, haga clic en la cola que desee, haga clic en **Editar**y, a continuación, haga clic en **eliminar**.
