...
Si Test-CsAddressBookWebQuery da error, es posible que desee volver a ejecutar la prueba, pero esta vez incluya el parámetro verbose:
...
Estas son algunas de las razones comunes por las que Test-CsAddressBookWebQuery podría producir un error:
