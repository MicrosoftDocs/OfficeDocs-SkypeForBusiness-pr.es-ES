...
# <a name="planning-for-location-based-routing-in-lync-server-2013"></a>Planeación del enrutamiento basado en ubicación en Lync Server 2013
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Consideraciones técnicas sobre el enrutamiento basado en ubicación en Lync Server 2013](lync-server-2013-technical-considerations-for-location-based-routing.md)
