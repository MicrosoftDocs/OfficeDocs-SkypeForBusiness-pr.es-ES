...
# <a name="managing-microsoft-sip-processing-language-mspl-applications-in-lync-server-2013"></a>Administración de aplicaciones de lenguaje de procesamiento SIP de Microsoft (MSPL) en Lync Server 2013
...
Puede usar los procedimientos de esta sección para administrar aplicaciones de lenguaje de procesamiento SIP de Microsoft (MSPL).
