...
---
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Cmdlets avanzados de telefonía IP empresarial en Lync Server 2013
...
Al implementar Enterprise Voice en una organización, también pueden implementarse otras aplicaciones y características para mejorar la experiencia del usuario y la eficiencia de la organización. Entre estas características se encuentran la configuración de medios, el control de admisión de llamadas, E9-1-1 mejorado (E9-1-1) y las llamadas de emergencia.

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>Cmdlets avanzados de Enterprise Voice

En la lista siguiente figuran cmdlets para administrar características avanzadas de una implementación de Enterprise Voice:

**[Cmdlets de control de admisión de llamadas en Lync Server 2013](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Cmdlets 9-1-1 mejorados en Lync Server 2013](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[Cmdlets de apariencia de línea compartida (SLA)](shared-line-appearance-sla-cmdlets.md)**
...
**[Cmdlets de desvío de medios en Lync Server 2013](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Cmdlets de configuración de medios en Lync Server 2013](lync-server-2013-media-configuration-cmdlets.md)**
