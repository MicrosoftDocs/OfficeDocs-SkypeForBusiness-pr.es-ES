...
description: 'Lync Server 2013: cmdlets de la aplicación de voz.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="voice-application-cmdlets"></a>Cmdlets de aplicaciones de voz

A continuación se presenta una lista de los cmdlets que se ocupan de las aplicaciones de voz:

**[Cmdlets de aplicación de estacionamiento de llamadas en Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Cmdlets de aplicación de grupo de respuesta en Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Cmdlets de números sin asignar en Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
