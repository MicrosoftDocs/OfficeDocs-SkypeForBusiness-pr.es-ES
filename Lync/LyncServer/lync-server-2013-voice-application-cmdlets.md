...
# <a name="voice-application-cmdlets-in-lync-server-2013"></a>Cmdlets de la aplicación de voz en Lync Server 2013
...
Las aplicaciones de voz se ejecutan en el servicio de aplicación en el servidor front-end. Estas aplicaciones le ayudan a administrar las llamadas telefónicas entrantes y salientes permitiéndole detener llamadas, tratar números sin asignar, coordinarse con mensajería unificada de Exchange (UM) y ejecutar la aplicación de grupo de respuesta.

<div>

## <a name="voice-application-cmdlets"></a>Cmdlets de la aplicación de voz

A continuación se muestra una lista de cmdlets que tratan las aplicaciones de voz:

**[Cmdlets de aplicaciones de estacionamiento de llamadas en Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Cmdlets de mensajería unificada de Exchange en Lync Server 2013](lync-server-2013-exchange-um-cmdlets.md)**
...
**[Cmdlets de la aplicación de grupos de respuesta en Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Cmdlets de número sin asignar en Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
