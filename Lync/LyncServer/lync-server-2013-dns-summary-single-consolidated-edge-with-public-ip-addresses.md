...
# <a name="dns-summary---single-consolidated-edge-with-public-ip-addresses-in-lync-server-2013"></a>Resumen DNS - Servidor perimetral consolidado simple con direcciones IP públicas en Lync Server 2013
...
Puede configurar dos adaptadores de red en el servidor perimetral de la siguiente manera:
  ...
  - **Adaptador de red 2 (interfaz externa)**
    ...
    Se asignan tres direcciones IP públicas a este adaptador de red, por ejemplo, 131.107.155.10 para Edge de Access, 131.107.155.20 para Edge de conferencias web, 131.107.155.30 para Edge AV.
...
### <a name="dns-records-required-for-single-consolidated-edge-with-public-ip-addresses-example"></a>Registros DNS necesarios para un solo borde consolidado con direcciones IP públicas (ejemplo)
