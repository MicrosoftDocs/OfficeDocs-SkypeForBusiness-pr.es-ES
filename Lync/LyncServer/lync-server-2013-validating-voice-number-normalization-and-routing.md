...
Corregir la normalización de números y el enrutamiento es muy importante para un entorno funcional de telefonía IP empresarial. Especialmente durante las migraciones desde la central de conmutación (PBX) a un entorno independiente de Lync Server, una de las claves para la migración correcta es mostrar y documentar todas las reglas de marcado existentes y crear reglas de normalización apropiadas, directivas de voz usos y rutas de teléfonos.
