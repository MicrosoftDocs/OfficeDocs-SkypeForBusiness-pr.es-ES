...
# <a name="lync-phone-edition-configuration-settings-in-lync-server-2013"></a>Opciones de configuración de Lync Phone Edition en Lync Server 2013
...
Las opciones de configuración para dispositivos que ejecutan Lync Phone Edition son de aplicación global, pero también se pueden crear nuevas colecciones de configuraciones que se apliquen a un sitio concreto. Las colecciones incluyen opciones sobre seguridad SIP, bloqueo de dispositivos, etc.

<div>

## <a name="in-this-section"></a>En esta sección

  - [Ver información de opciones de configuración de Lync Phone Edition en Lync Server 2013](lync-server-2013-view-lync-phone-edition-configuration-settings-information.md)
