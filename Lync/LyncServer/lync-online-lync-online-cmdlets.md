...
Esta página muestra todos los cmdlets de Windows PowerShell disponibles para los administradores de inquilinos de Microsoft Lync Online.
...
Los siguientes cmdlets solo se pueden usar con Lync Online:
...
Para obtener más información sobre cómo configurar el equipo para usar Windows PowerShell para administrarlo con Lync Online, vea el tema de ayuda [usar Windows PowerShell para administrar Lync Online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15)).
