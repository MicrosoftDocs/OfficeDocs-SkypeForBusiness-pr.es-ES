...
Puede usar el [visor de eventos de Windows](http://go.microsoft.com/fwlink/p/?linkid=314067) para ver los registros de eventos y obtener información sobre errores de servicio, errores de replicación en AD DS y advertencias sobre los recursos del sistema, como la memoria virtual y el espacio en disco. El visor de eventos se incluye con Windows Server 2008 y 2012.
