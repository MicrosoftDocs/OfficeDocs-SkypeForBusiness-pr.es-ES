...
En algunos casos, la comunicación, por ejemplo, la mensajería instantánea (mi) y la presencia entre un contacto de Microsoft Lync Server 2013 y el protocolo extensible de mensajería y presencia (XMPP), es solo de punto a punto y solo admite usted y el contacto en el federado SIA. En otros casos, como un Lync Server, Lync Server 2010 a Lync Server 2013 Federation, se puede invitar a varios participantes a unirse a la conversación.
