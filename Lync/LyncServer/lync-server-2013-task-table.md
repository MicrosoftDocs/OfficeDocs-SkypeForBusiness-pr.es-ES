...
# <a name="task-table-in-lync-server-2013"></a>Tabla de tareas de Lync Server 2013
...
La tabla de tareas es solo para uso interno. Esta tabla se introdujo en Microsoft Lync Server 2013.
