...
En los temas de esta sección se describe cómo usar el panel de control de Lync Server 2013 para configurar la Conferencia de acceso telefónico local para usar el entorno de Lync Server 2013.
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Números de acceso a conferencias de acceso telefónico local en Lync Server 2013](lync-server-2013-dial-in-conferencing-access-numbers.md)
