...
4.  En el archivo de registro, busque **\<Success\>** resultado de ejecución al final de cada tarea para comprobar que se establecieron los permisos y, a continuación, cierre la ventana de registro. También puede ejecutar el comando siguiente para determinar si se establecieron los permisos:
...
4.  En el archivo de registro de ejemplo C: \\ registra \\OUPermissions.xml, debería buscar **\<Success\>** el resultado de la ejecución al final de cada tarea y comprobar que no hay errores y, a continuación, cierra el registro. Para probar los permisos, puede ejecutar el siguiente cmdlet:
