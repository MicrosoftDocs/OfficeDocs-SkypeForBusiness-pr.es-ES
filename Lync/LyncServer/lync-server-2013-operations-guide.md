...
Se incluyen las siguientes secciones:
  ...
  - [Solución de problemas y indicadores de estado clave en Lync Server 2013](lync-server-2013-troubleshooting-and-key-health-indicators.md)

Se supone que se ha completado la implementación de Microsoft Lync Server 2013. Si no es así, consulte el contenido de planeación e implementación de Microsoft Lync Server 2013 antes de continuar.
