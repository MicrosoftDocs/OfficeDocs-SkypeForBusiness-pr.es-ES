...
El nuevo escritorio de Office 365 **informes** muestra la información general de la actividad a través de los productos de Office 365 de su organización. Le permite explorar informes de nivel de cada producto que le proporcione información más detallada sobre las actividades dentro de cada producto. Por ejemplo, puede usar el informe de **Skype para la actividad de punto a punto** para ver cuánto los usuarios utilizan mensajería instantánea, aplicaciones de audio, vídeo y uso compartido y la transferencia de archivos. Consulte[Informes de actividades en el Centro de administración de Office 365](http://technet.microsoft.com/library/0d6dfb17-8582-4172-a9a9-aed798150263%28Office.14%29.aspx)
...
2. En la página de **uso**, haga clic en **Skype para la actividad de punto a punto** en **Seleccionar una lista de informe** de la izquierda. O bien, haga clic en el widget de **Skype para la actividad de la empresa** y, a continuación, haga clic en **Skype para la actividad de punto a punto** en la lista de **Skype para la actividad de la empresa**.
...
|**3** <br/> |Usar los datos de gráfico interactivo en el diagrama de **actividad** para comprender las tendencias de uso y para ver el número total de sesiones por tipo de sesión en su organización. Se mostrará el número total y tipos de sesiones de **mensajería instantánea**, **Audio**, **vídeo**, **uso compartido de aplicaciones** y **transferencia de archivos** en toda la organización. <br/> |
|**4** <br/> |Usar los datos de gráfico interactivo en el gráfico de **los usuarios** a comprender las tendencias de uso y para ver el número de usuarios únicos que participan en actividades de punto a punto que se mantienen en su organización. Mostrará el número total de usuarios junto con los tipos de **mensajería instantánea**, **Audio**, **vídeo**, **uso compartido de aplicaciones** y **transferencia de archivos** de sesiones de punto a punto. <br/> |
...
|**6** <br/> | Cada gráfico tiene un eje X (horizontal) y un eje Y (vertical). <br/>  En el gráfico de actividad **Actividad**, el eje Y es el número total de sesiones de MI, audio, vídeo, uso compartido de aplicaciones y transferencia de archivos que han realizado sus usuarios en su organización.  <br/>  En el diagrama de actividad de **los usuarios**, el eje Y es el número total de usuarios que llevan a cabo mensajería instantánea, aplicaciones de audio, vídeo y uso compartido y la transferencia de sesiones de archivos.  <br/>  En el gráfico de actividad **Minutos**, el eje Y es el número total de minutos que han pasado los usuarios de su organización en sesiones de punto a punto de audio y vídeo.  <br/>  En ambos gráficos, el eje X es el intervalo de fechas seleccionado para este informe específico. <br/> |
|**7** <br/> |Puede filtrar la serie que ve en el gráfico haciendo clic en un elemento de la leyenda. Por ejemplo, en el diagrama de **actividad**, haga clic o puntee en **mensajería instantánea**, **Audio**, **vídeo**, **uso compartido de aplicaciones** y **transferencia de archivos** para ver solo la información relacionada con cada uno de ellos. Cambiar esta selección, no cambia la información de la tabla de la cuadrícula. <br/> |
...
|**10** <br/> |![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)Haga clic o puntee en el icono de **columnas** en cualquiera de las columnas para agregar o quitar columnas del informe.           <br/> |
