...
- Update the firmware on your phones (See supported firmware [in this topic](getting-phones-for-skype-for-business-online.md)).  You can check the firmware on you phone by doing this:
  ...
  - **Teléfonos AudioCodes**: vaya a **menú menu**  >  **Device Status**  >  **versión de firmware** de estado de dispositivo desde la pantalla de inicio.
  - **Teléfonos Lync Phone Edition (LPE)**: vaya a **Menu**  >  **información del sistema** de menús desde la pantalla Inicio.
...
1. En el centro de administración, vaya a servicios de compra de **facturación**  >  **Purchase services**y agregue **otros planes**.
...
![Un icono que muestra el logotipo de Skype empresarial ](../../images/sfb-logo-30x30.png) asignar un número de teléfono al usuario con el **centro de administración de Skype empresarial**
...
Si se lo está preguntando, también puede tomar su número de teléfono con otro operador y "*Puerto*" o transferirlo a Microsoft 365 u Office 365. Consulte [transferir números de teléfono a teams](/microsoftteams/phone-number-calling-plans/transfer-phone-numbers-to-teams).
