...
---
## <a name="common-area-phones"></a>Teléfonos de área común
...
Su teléfono seleccionado debe tener el modo de teléfono de área común. 

***Teléfono Polycom VVX de ejemplo***

Habilitar el modo de teléfono de área común en Polycom VVX siguiendo estos pasos:
...
3. Haga clic en **Guardar** para guardar las opciones de configuración.

Ahora que está habilitado el modo de teléfono de capital, configurar el teléfono mediante la pantalla del teléfono.

1. En la configuración, seleccione **Opciones avanzadas**.
2. Escriba la contraseña.
3. En la configuración de administración, seleccione **Configuración de teléfono de área común**.
4. Habilitar el teléfono de área común y administración de capital
5. Seleccione **Guardar Config**.

El teléfono está listo para aprovisionarse, que hará al iniciar sesión en la pantalla principal.

1. Iniciar sesión mediante la selección de **Configuración > funciones > Skype para la empresa.**
2. Seleccione las credenciales de usuario y seleccione Seleccionar **Inicio de sesión de web (CAP)** para generar un código..
3. Vaya al portal de aprovisionamiento http://aka.ms/skypecape iniciar sesión como **Administrador**.
...
WHT este último paso, el teléfono debe iniciar sesión automáticamente.
