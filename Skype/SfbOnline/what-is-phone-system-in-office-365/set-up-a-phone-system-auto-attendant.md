...
*    **Persona de la empresa** con una licencia de **Sistema de teléfono** que está habilitada para Enterprise Voice o asignada al llamar a los planes en Office 365. <br/>

        > [!Note] 
        > **Persona de la empresa** puede ser un usuario en línea o un usuario hospedado local mediante Skype para Business Server 2015 o Lync Server 2013. Lync Server 2010 no es compatible. <br/> 
...
***
![Número 2](../images/sfbcallout2.png)<br/>Para cambiar el horario laboral, resalte el horario que desea establecer con el calendario. El calendario le permite seleccionar horario en intervalos de 30 minutos, y el horario que seleccione aquí se basará en la zona horaria que ha configurado en la página **información General** . Para configurar un salto (almuerzo, por ejemplo), anule la selección o arrastre para anular la selección de la hora en el calendario. Puede establecer varios saltos dentro de horario comercial. 
   
### <a name="select-business-hours-call-handling-page"></a>Página de administración de las llamadas seleccione horario laboral
...
***
![Número 1](../images/sfbcallout1.png)<br/>**Saludo de la compañía** Saludo de horario comercial es opcional y puede establecerse en **None**. En este caso, el autor de la llamada no escuchará ningún mensaje o un saludo antes de la llamada se controla mediante una de las opciones que seleccione. También puede cargar un archivo de audio (en formatos WAV, mp3 o .wma), o crear un saludo personalizado usando texto a voz.
*    **Ninguno** Ningún saludo se reproducirá cuando llama personas el número de teléfono de operador automático.
*    **Crear un personalizado de saludo** Si elige esta opción, escriba el texto que desea que el sistema para leer (hasta 1000 caracteres). Por ejemplo, es posible que escriba "Bienvenidos a Contoso. La llamada es importante para nosotros." en el cuadro **escucharán los autores de llamadas** .
...
***
![Número 2](../images/sfbcallout2.png)<br/>Puede seleccionar lo que ocurre con las llamadas que se reciben durante la jornada laboral. Puede elegir entre las siguientes opciones:
*    **Desconectar** Si se selecciona, la persona que llama se desconectarán tras escuchar un saludo de horario comercial.
*    **Redirigir llamada** Esto puede usarse para enviar automáticamente la llamada al:
     *    **Persona de la empresa** con una licencia de **Sistema de teléfono** que está habilitada para Enterprise Voice o asignada al llamar a los planes en Office 365. Puede establecer que el autor de la llamada se derive a un correo de voz. Para ello, seleccione la **persona de la empresa** y establezca esta persona para que sus llamadas se desvían directamente al correo de voz. <br/><br/>   
        > [!Note]
        > **Persona de la empresa** puede ser un usuario en línea o un usuario hospedado local mediante Skype para Business Server 2015 o Lync Server 2013. Lync Server 2010 no se admite. <br/><br/>

     *    Una **Cola de llamadas** mediante una cola de llamadas permite la llamada se transfieran a una cola de llamadas existente que haya configurado.
     *    Operador para crear un segundo nivel de opciones de menú que contiene un submenú automático otro **operador automático** , puede utilizar una existente. Estos se denominan a automáticos anidados.
*    **Reproducir el mensaje de opciones de menú** Estos también pueden utilizarse para que le permite configurar un símbolo del sistema que desea reproducir.
***
...
- El siguiente paso es seleccionar donde la llamada es que se envíen si se presiona la tecla correspondiente, o está seleccionada la opción Usar reconocimiento de voz. La llamada se puede enviar al: 
    - **Operador** Si el operador ya está configurado, se asignan automáticamente a clave 0, pero también se puede eliminar o volver a asignar a una clave diferente. Si el operador no está establecida en cualquier clave, a continuación, el comando de voz "Operador" se deshabilitará demasiado. 
    - Una **persona de la empresa** con una licencia de **Sistema de teléfono** que está habilitada para Enterprise Voice o asignada un Plan de llamada en Office 365. Puede establecer que el autor de la llamada se derive a un correo de voz. Para ello, seleccione la **persona de la empresa** y establezca esta persona para que sus llamadas se desvían directamente al correo de voz.<br/><br/> 
    
        > [!Note] 
        > **Persona de la empresa** puede ser un usuario en línea o un usuario hospedado local mediante Skype para Business Server 2015 o Lync Server 2013. Lync Server 2010 no se admite. <br/><br/>

    - **Cola de llamadas** El uso de una opción de cola llamada permite la llamada se transfieran a una cola existente de llamada que ha configurado. 
    - **Operador automático** Puede usar a un operador automático existente para crear un segundo nivel de opciones de menú que contiene un submenú. Estos se denominan a automáticos anidados.<br/><br/>
...
![Configuración de días no laborables en el operador automático](../images/50a5ce88-7f39-4210-808a-da7ced969854.png)
  
***
![Número 1](../images/sfbcallout1.png)<br/>**Agregar un día festivo** Escriba un nombre para su nuevo de días festivos en el campo **nombre del día festivo** .<br/><br/> Los nombres de días festivos pueden constar de hasta 64 caracteres y deben ser únicos para el mismo operador automático. Por ejemplo, no puede tener dos días festivos denominados "Navidad" en el mismo operador automático.  
***
![Número 2](../images/sfbcallout2.png)<br/>**Saludo de días festivos** El saludo de días festivos es opcional y puede establecerse en **None**. En este caso, el autor de la llamada no escuchará ningún mensaje o un saludo antes de la llamada se controla mediante una de las opciones que seleccione. También puede cargar un archivo de audio (en formatos WAV, mp3 o .wma), o crear un saludo personalizado usando texto a voz.
*    **Ninguno** Ningún saludo se reproducirá cuando llama personas el número de teléfono de operador automático.
*    **Crear un personalizado de saludo** Si elige esta opción, escriba el texto que desea que el sistema para leer (hasta 1000 caracteres). ¡Por ejemplo, es posible que escriba "feliz año nuevo! Nuestras oficinas actualmente se cierran." en el cuadro **escucharán los autores de llamadas** .
...
***
![Número 3](../images/sfbcallout3.png)<br/>**¿Qué sucede a las llamadas después el saludo?** Puede seleccionar lo que ocurre con las llamadas que se reciben durante este día festivo. Puede elegir entre las siguientes opciones:
*    **Desconectar** La persona que llama se desconectarán tras escuchar el saludo de días festivos.
*    **Redirigir llamada** Esto puede usarse para enviar automáticamente la llamada al:
     *    Una **persona de la empresa** con una licencia de **Sistema de teléfono** que está habilitada para Enterprise Voice o asignada al llamar a los planes en Office 365. Puede establecer que el autor de la llamada se derive a un correo de voz. Para ello, seleccione la **persona de la empresa**y establezca esta persona para que sus llamadas se desvían directamente al correo de voz. <br/><br/> 
     ...
     *    Otro **operador automático**, para crear un segundo nivel de opciones de menú que contiene un submenú. Estos se denominan a automáticos anidados. <br/><br/>
...
***
![Número 4](../images/sfbcallout4.png)<br/>**¿Cuándo desea que el día festivo para iniciar y finalizar?** Escriba la fecha de comienzo del día festivo en formato dd/mm/aaaa y, a continuación, seleccione una hora de inicio, la fecha de finalización y la hora de finalización, tal y como se le solicite en la tabla de intervalo de fecha.<br/><br/>Puede especificar hasta 10 diferentes rangos de fecha en un día festivo. Por ejemplo, puede agregar intervalos de fechas de los días festivos de fin de año hasta un máximo de 10 años. Un día festivo puede abarcar varios días.<br/><br/>Para agregar más días festivos fecha intervalos (por ejemplo, para el próximo año), haga clic en **Agregar otro**y, a continuación, escriba un nuevo conjunto de las fechas de inicio y finalización para el día festivo.<br/><br/>También se admiten las vacaciones anidadas. Por ejemplo, puede anidar varios festivos dentro de un marco de tiempo "salto de días festivos": 
*    **El 24 de diciembre a través 3 de enero,:** "Felices vacaciones! Nuestras oficinas actualmente estén cerradas. Se va a volver a abrir 4 de enero."
*    **25 de diciembre:** "Feliz Navidad! Nuestras oficinas actualmente estén cerradas. Se va a volver a abrir 4 de enero."
*    **El 1 de enero:** "Feliz año nuevo! Nuestras oficinas actualmente estén cerradas. Se va a volver a abrir 4 de enero."
   
Después de guardar al operador automático, los días festivos aparecen en la ficha de **días festivos** , donde puede editar, agregar o modificar la configuración de días festivos.
...
*    **Total de usuarios en línea**: esta opción le permite incluir a todas las personas de su organización en la búsqueda en directorios. Todos los usuarios en línea con una licencia de **Sistema de teléfono** , así como los usuarios hospedan local utilizando Skype para Business Server 2015 o Lync Server 2013 que tienen planes de llamada en Office 365, se enumerarán. 
*    **Personalizado** Si utiliza esta opción, puede buscar un grupo de Office 365, lista de distribución o grupo de seguridad que se ha creado en la organización y las personas que agregan a este grupo de Office 365, lista de distribución o grupo de seguridad que están bien **usuarios en línea con un Licencia de sistema de teléfono** u hospedado local mediante Skype para Business Server 2015 o Lync Server 2013. Puede agregar varios grupos de Office 365, listas de distribución y grupos de seguridad. <br/><br/> 
...
||| 
|---|---|
[Nueva CsOrganizationalAutoAttendant](https://technet.microsoft.com/library/mt796493.aspx)                                                                      | [Nueva CsOrganizationalAutoAttendantPrompt](https://technet.microsoft.com/library/mt796484.aspx)                                                              |
| [Set-CsOrganizationalAutoAttendant](https://technet.microsoft.com/library/mt796486.aspx)                                                                      | [Nueva CsOrganizationalAutoAttendantMenuOption](https://technet.microsoft.com/library/mt796485.aspx)                                                           |
...
| [Remove-CsOrganizationalAutoAttendant](https://technet.microsoft.com/library/mt796492.aspx)                                                                   | [Nueva CsOrganizationalAutoAttendantMenu](https://technet.microsoft.com/library/mt796488.aspx)                                                                  |
| [New- CsOnlineAudioFile](https://technet.microsoft.com/library/mt796479.aspx)                                                                                 | [Nueva CsOrganizationalAutoAttendantCallFlow](https://technet.microsoft.com/library/mt796489.aspx)                                                              |
| [Export-CsOrganizationalAutoAttendantHolidays](https://docs.microsoft.com/powershell/module/skype/export-csorganizationalautoattendantholidays?view=skype-ps) | [Nueva CsOnlineTimeRange](https://technet.microsoft.com/library/mt796491.aspx)                                                                                  |
| [Nueva CsOnlineDateTimeRange](https://docs.microsoft.com/powershell/module/skype/new-csonlinedatetimerange?view=skype-ps)                                       | [Nueva CsOnlineSchedule](https://technet.microsoft.com/library/mt796490.aspx)                                                                                   |
| [Get-CsOrganizationalAutoAttendantSupportedTimeZone](https://technet.microsoft.com/library/mt796483.aspx)                                                     | [Nueva CsOrganizationalAutoAttendantCallHandlingAssociation](https://technet.microsoft.com/library/mt796487.aspx)                                               |
| [Get-CsOrganizationalAutoAttendantSupportedLanguage](https://technet.microsoft.com/library/mt796481.aspx)                                                     | [CsOrganizationalAutoAttendantHolidays de importación](https://docs.microsoft.com/powershell/module/skype/import-csorganizationalautoattendantholidays?view=skype-ps) |
| [Nueva CsOrganizationalAutoAttendantCallableEntity](https://technet.microsoft.com/library/mt796480.aspx)                                                      |  |   |
