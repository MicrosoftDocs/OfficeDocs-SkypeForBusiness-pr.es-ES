...
4. Para ver los números de teléfono asignados, vea la columna **número** .
...
5. Puede usar la lista desplegable para filtrar la vista por:
   ...
   - Números de teléfono **asignados al usuario**.
    
   - Números de teléfono **asignados a la Conferencia** para conferencias de acceso telefónico local.
