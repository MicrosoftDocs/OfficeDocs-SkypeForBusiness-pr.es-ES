...
2. Diríjase al **Centro de administración de Office 365** > ** de Skype Empresarial**.
    
3. En el panel de navegación izquierdo, vaya a **Voz** > **Usuarios de voz**.
    
    > [!IMPORTANT]
    > Para poder ver la opción **Voz** en el panel de navegación izquierdo del Centro de administración de Skype Empresarial, primero tiene que adquirir como mínimo una **licencia de Enterprise E5**, una licencia de complemento de **Sistema telefónico** o una licencia de complemento de **Audioconferencia**.
...
8. Seleccione una nueva dirección de emergencia en la lista y, a continuación, haga clic en **Guardar**.
