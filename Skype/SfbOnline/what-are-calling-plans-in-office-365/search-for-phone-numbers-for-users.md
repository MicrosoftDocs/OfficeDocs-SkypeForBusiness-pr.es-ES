...
7. Seleccione los números de teléfono que desee y haga clic en **Adquirir números**.
    ...
    > [!IMPORTANT]
    > Puede comprar una cantidad de números de teléfono superior a las licencias que tenga. Para determinar cuántos números de teléfono puede comprar, sume un 10 % al número de licencias que tenga y, después, sume 10 licencias. Por ejemplo, si tiene 100 licencias de un **Plan de llamadas nacionales** o un **Plan de llamadas internacionales**, puede reservar 120 números de teléfono, suponiendo que aún no ha adquirido algunos números de teléfono para aquellos 100 usuarios. Para obtener más información, consulte [¿Cuántos números de teléfono puedo obtener?](/microsoftteams/how-many-phone-numbers-can-you-get)
