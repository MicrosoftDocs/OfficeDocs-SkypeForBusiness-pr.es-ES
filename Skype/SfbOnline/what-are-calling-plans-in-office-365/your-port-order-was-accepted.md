...
¡Se aprueba el pedido de puerto! Busque sus números de teléfono en el **Skype para el centro de administración de negocios** > **voz** > **números de teléfono**.
...
Ahora que está aprobada y sus números de teléfono están listos, necesitará realizar un par de cosas que todo esté configurado.
  
- Asegúrese de [Skype para negocios y equipos de Microsoft licencias adicionales](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md). Se necesita un **Sistema telefónico** y **Plan de llamadas nacionales** o **Internacionales llamando a planificar**.
    
- Crear [Agregar o quitar una emergencia la dirección de la organización](add-or-remove-an-emergency-address-for-your-organization.md) y, si se desea, el[Agregar, cambiar o quitar una ubicación de emergencia para su organización](add-change-or-remove-an-emergency-location-for-your-organization.md) (en algunos países o regiones, obtendrá una dirección de emergencia con el número de teléfono).
    
- Siga adelante y [asignar, cambiar o quitar un número de teléfono de un usuario](assign-change-or-remove-a-phone-number-for-a-user.md).
