...
ms.locfileid: "23779244"
---
# <a name="port-order-overview"></a>Introducción a las solicitudes de portabilidad

Si actualmente tiene un proveedor de servicio de teléfono o el operador de y ya tienen los números de teléfono para los usuarios, debe crear lo que se denomina una "*orden de puerto*" que transfiere dichos número de teléfono a Skype para profesionales en línea. Una vez que se complete la portabilidad de los números, podrá asignarlos a sus usuarios.
  
Después de realizar la portabilidad de los números de teléfono a Skype Empresarial Online en Office 365, Microsoft se convertirá en su proveedor de servicios y podrá desconectar este servicio de su anterior operador o proveedor de servicios.
