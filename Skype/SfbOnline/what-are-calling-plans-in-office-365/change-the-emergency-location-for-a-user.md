...
8. Seleccione **Buscar por ubicación** en la lista desplegable, escriba un nombre parcial de la ubicación (por ejemplo, escriba **plano inferior**) y, a continuación, haga clic en **Buscar**. 
