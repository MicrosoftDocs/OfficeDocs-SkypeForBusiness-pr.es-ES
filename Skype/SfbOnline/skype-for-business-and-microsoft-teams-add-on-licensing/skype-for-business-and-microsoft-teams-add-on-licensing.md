...
Las licencias de complementos son licencias de características concretas de Skype for Business y Microsoft Teams. Algunas empresas desean tener la flexibilidad de comprar solo características concretas a un precio competitivo. Para agregar una característica, compre una licencia de complementos para cada usuario que lo vaya a utilizar.

Las licencias de Skype for Business y Microsoft Teams están diseñadas para ofrecerle la máxima flexibilidad. Por ejemplo, después de utilizar características básicas de Skype for Business durante un tiempo, puede comprar licencias de complementos cuando esté listo para usar más características, como Audioconferencia o Sistema telefónico en Office 365.

## <a name="how-does-add-on-licensing-affect-cost"></a>¿Cómo afectan las licencias de complementos a los costes?

Para la mayoría de las empresas, comprar un lote de software en un plan Enterprise comportará un coste total menor. Por lo general, si compra varias licencias de complementos individualmente en lugar de como parte de un plan, el coste combinado es superior.
...
|**Sistema telefónico** <br/> |Un sistema PBX es un sistema telefónico en una empresa. El sistema telefónico en Office 365 es un servicio de teléfono hospedado en Office 365. Proporciona capacidades de PBX tradicionales e innovadoras, pero sin el equipamiento costoso y complejo. [Esto es lo que conseguirá con Sistema telefónico de Office 365](/MicrosoftTeams/here-s-what-you-get-with-phone-system).  <br/> Si quiere saber cuánto cuesta, vea [Requisitos del sistema telefónico](https://products.office.com/en-us/skype-for-business/cloud-pbx#requirements).  <br/> |
...
Las opciones de licencia de complemento disponibles depende de su plan de Skype for Business u Office 365. Consulte los siguientes temas para obtener información, características y opciones que son específicas de su plan.
...
Para obtener una lista detallada de características en cada plan de Skype for Business, consulte la [Descripción del servicio Skype for Business Online](https://go.microsoft.com/fwlink/?LinkId=730729).
...
## <a name="how-do-i-use-my-existing-calling-plans-with-skype-for-business"></a>¿Cómo puedo usar mis Planes de llamadas actuales con Skype for Business?
<a name="bkmk_existing"></a>

Si desea utilizar su plan de llamadas existente, compre el complemento de **sistema telefónico** y úselo con el **[conector para la nube gratuito](https://technet.microsoft.com/en-us/library/mt605227.aspx)**.

Si está utilizando la conectividad de RTC local para usuarios híbridos, *solo* asigne licencias de **Sistema telefónico** a los usuarios. **NO** asigne también un plan de llamadas.

Para obtener una extensa documentación acerca de cómo planificar la implementación, incluyendo el sistema telefónico con conectividad RTC local, vea [Planear el sistema telefónico en la solución de Office 365 (nube PBX)](https://technet.microsoft.com/en-us/library/mt612869.aspx).
...
- [Configurar el correo de voz de Sistema telefónico - Ayuda para el administrador](/microsoftteams/set-up-phone-system-voicemail)
