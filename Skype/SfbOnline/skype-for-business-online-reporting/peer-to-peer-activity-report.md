...
ms.locfileid: "54342635"
---
# <a name="peer-to-peer-activity-report"></a>Informe de actividad punto a punto

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

En **el panel** Informes se muestra la información general sobre la actividad en Microsoft 365 o Office 365 productos de su organización. Le permite explorar los informes de nivel de cada producto para obtener datos más pormenorizados sobre las actividades dentro de cada producto. Por ejemplo, puede usar el informe de actividad **de punto Skype Empresarial** punto a punto para ver cuánto usan los usuarios la mensajería instantánea, el audio, el vídeo, el uso compartido de aplicaciones y la transferencia de archivos. 

Consulte información general [sobre informes.](https://support.office.com/article/0d6dfb17-8582-4172-a9a9-aed798150263)
...
2. En la **página Uso,** seleccione **Skype Empresarial** actividad punto a punto en la lista Seleccionar un informe  >   **a** la izquierda. O bien, haga clic **en el widget** Skype Empresarial actividad y, a continuación, haga clic Skype Empresarial actividad punto **a** punto en la lista **Skype Empresarial actividad.**
