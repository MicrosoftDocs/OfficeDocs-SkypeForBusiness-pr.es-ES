...
---
# <a name="peer-to-peer-activity-report"></a>Informe de actividad de Peer-to-peer

[] El nuevo panel **Informes** de Office 365 muestra la información general de actividad en los productos de Office 365 de su organización. Le permite explorar los informes de nivel de cada producto para obtener datos más pormenorizados sobre las actividades dentro de cada producto. Por ejemplo, puede utilizar el informe de **Skype para actividad de igual a igual** para ver cuánto los usuarios utilizan mensajería instantánea, aplicaciones de vídeo, audio, compartir y transferir archivos. 

Consulte la [información general de informes](https://support.office.com/article/0d6dfb17-8582-4172-a9a9-aed798150263)
...
2. En la página de **uso** , haga clic en **Skype para actividad de igual a igual** en el **Seleccione un informe de lista** de la izquierda. O bien, haga clic en el widget de **Skype para la actividad de negocio** y haga **Skype para actividad de punto a punto** en la lista de **Skype para la actividad de negocio** .
...
***
![Número 1](../images/sfbcallout1.png)<br/>El informe de **actividad punto a punto de Skype Empresarial** se puede usar para ver las tendencias de los últimos 7 días, 30 días, 90 días o 180 días.
...
*    En el diagrama de actividad de **los usuarios** , el eje Y es el número total de usuarios que mantienen IM, aplicación de audio, vídeo, uso compartido y transferencia de sesiones de archivos. 
...
***
![Número 7](../images/sfbcallout7.png)<br/>Puede filtrar las series que aparecen en el gráfico haciendo clic en un elemento de la leyenda. Por ejemplo, en el diagrama de **actividad** , haga clic o puntee en **mensajería instantánea**, **Audio**, **vídeo**, **uso compartido de aplicaciones**y **transferencias de archivos** para ver sólo la información relacionada con cada uno de ellos. Si se cambia esta selección, no se cambia la información en la tabla de cuadrícula. 
***
...
***
![Número 10](../images/sfbcallout10.png)<br/>![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)<br/>Haga clic o puntee en el icono de **columnas** en alguna de las columnas para agregar o quitar columnas del informe.         
