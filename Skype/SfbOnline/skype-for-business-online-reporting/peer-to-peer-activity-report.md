...
2. En la página de **uso** , haga clic en **Skype para actividad de punto a punto de negocio** en el **Seleccione una lista de informes** a la izquierda. O bien, haga clic en el widget de **Skype para la actividad de negocio** y, a continuación, haga clic en **Skype para la actividad de punto a punto** en la lista de **Skype para la actividad de negocio** .
...
*    En el gráfico de actividad de **los usuarios** , el eje Y es el número total de usuarios que se conservan la mensajería instantánea, aplicación de audio, vídeo, uso compartido y la transferencia de las sesiones de los archivos. 
...
***
![Número 10](../images/sfbcallout10.png)<br/>![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)<br/>Haga clic o puntee en el icono de **columnas** en cualquiera de las columnas para agregar o quitar columnas del informe.         
