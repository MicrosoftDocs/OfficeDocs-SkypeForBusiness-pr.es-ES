...
[] El nuevo panel **Informes** de Office 365 muestra la información general de actividad en los productos de Office 365 de su organización. Le permite explorar los informes de nivel de cada producto para obtener datos más pormenorizados sobre las actividades dentro de cada producto. Por ejemplo, puede utilizar el informe de **Skype para obtener detalles de la sesión de negocios** para ver detalles sobre experiencias de llamada del usuario individual.
...
***
![Número 4](../images/sfbcallout4.png)<br/>La tabla muestra un desglose de los todos los datos de sesión por usuario. Muestra todos los usuarios con Skype para empresa asignada y la información de sesión. Puede agregar o quitar columnas en la tabla. <br/><br/>La tabla tiene las columnas siguientes para cada sesión:
