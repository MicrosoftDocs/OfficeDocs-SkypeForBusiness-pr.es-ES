...
***
![Número 2](../images/sfbcallout2.png)<br/>Cada informe tiene la fecha del momento en que se generó. Por lo general, los informes reflejan una latencia de 24 a 48 horas de duración de la actividad. 
***
...
*    En el gráfico de actividad **minutos** , el eje Y es el número total de minutos de audio/vídeo, de Microsoft de acceso telefónico local y de llamada saliente de Microsoft para conferencias que los usuarios organizan en su organización.  
...
* **Acceso telefónico o salida-terceros** muestra el número total de conferencias de acceso telefónico local y de salida que se organizó con un proveedor de servicios de audioconferencia de terceros. 
* **Acceso telefónico/saliente Microsoft** muestra el número total de conferencias de acceso telefónico local y de salida que se han organizado. 
