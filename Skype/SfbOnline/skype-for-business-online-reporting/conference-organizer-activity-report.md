...
ms.locfileid: "58727549"
---
# <a name="conference-organizer-activity-report"></a>Informe de actividad del organizador de la conferencia

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

En **el panel** Informes se muestra la información general sobre la actividad en Microsoft 365 o Office 365 productos de su organización. Le permite explorar los informes de nivel de cada producto para obtener datos más pormenorizados sobre las actividades dentro de cada producto. Por ejemplo, puede usar el informe de actividad del organizador de conferencias de **Skype Empresarial** para ver cuánto están organizando los usuarios conferencias que usan mensajería instantánea, audio/vídeo, uso compartido de aplicaciones, Web, acceso telefónico local/externo - terceros y acceso telefónico local / salida - Microsoft. 
...
Este informe, junto con el resto de Skype Empresarial, le proporciona detalles sobre la actividad de conferencias organizadas en toda la organización. Estos detalles son muy útiles para investigar, planificar y tomar otras decisiones empresariales para su organización. 
...
2. En la **página Uso,** seleccione **Skype Empresarial** actividad del organizador de conferencias en la lista Seleccionar un  >  **informe a** la izquierda. O bien, haga clic **en el widget Skype Empresarial actividad** y, a continuación, haga clic Skype Empresarial **actividad** del organizador de conferencias en la **Skype Empresarial actividad.**
...
Puede obtener una vista de las conferencias de Skype Empresarial que se han organizado consultando los gráficos **Actividad,** **Usuarios** y **Minutos.**
  
![Skype de conferencias organizadas para empresas.](../images/0ab0e5e8-cf18-4f8f-a31a-94048e375a0f.PNG)
...
*    En  el gráfico de actividades Minutos, el eje Y es el número total de minutos de audio/vídeo, minutos de acceso telefónico local de Microsoft y minutos de Microsoft de acceso telefónico local para conferencias que los usuarios organizaron en su organización.  
...
* **Acceso telefónico local/externo: tercera** parte muestra el número total de conferencias de audio de acceso telefónico local y de salida que se organizaron que usan un proveedor de audioconferencia de terceros. 
* **Microsoft muestra el** número total de conferencias de audio de acceso telefónico y salida que se han organizado. 
...
* **Los minutos de Acceso telefónico** local de Microsoft muestran el número total de minutos de acceso telefónico local usados en las reuniones organizadas que usan Microsoft como proveedor de audioconferencias. 
* **Los minutos de Acceso** telefónico local de Microsoft muestran el número total de minutos de acceso telefónico local usados en las reuniones que se organizaron y que usan Microsoft como proveedor de audioconferencias. 
...
***
![Número 10.](../images/sfbcallout10.png)<br/>Haga clic o pulse en **el icono** Columnas de cualquiera de las columnas para agregar o quitar columnas del informe.           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
