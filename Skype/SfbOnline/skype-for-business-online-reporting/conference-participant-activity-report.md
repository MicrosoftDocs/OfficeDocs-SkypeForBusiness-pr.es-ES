...
Como administrador de Office 365, el nuevo panel de **informes** muestra datos sobre el uso de los productos de Office 365 dentro de su organización. Puede utilizar el informe de **Skype para actividad de participantes de conferencia** para ver cuántos mensajería instantánea, audio y vídeo, compartir aplicaciones, Web y y conferencias de dial-in/out se se participó en los usuarios de su organización.
...
Este informe, junto con lo otro Skype para los informes de negocios, ofrece detalles sobre actividad de conferencias en toda la organización. Estos detalles son muy útiles para investigar, planificar y tomar otras decisiones empresariales para su organización.
...
2. En la página de **uso** , haga clic en **Skype para actividad de participantes de conferencia** en **Seleccione un informe de lista** de la izquierda. O bien, haga clic en el widget de **Skype para la actividad de negocio** y **Skype para actividad de participantes de conferencia** haga clic en la lista de **Skype para la actividad de negocio** .
...
***
![Número 1](../images/sfbcallout1.png)<br/>El informe de **Actividad de participantes de conferencia de Skype Empresarial** puede visualizarse para las tendencias de los últimos 7 días, 30 días, 90 días o 180 días.
...
***
![Número 5](../images/sfbcallout5.png)<br/>Utilizar los datos de gráfico interactivo en el gráfico de **minutos** para entender las tendencias de uso y ver el número de minutos utilizados por los usuarios cuando organizan una conferencia utilizando audio y vídeo, acceso telefónico y acceso telefónico de salida - Microsoft como las conferencias de audio proveedor de servicios. Muestra el número total de minutos de **Audio/vídeo** que se utilizan durante conferencias en las que se ha participado.
***
