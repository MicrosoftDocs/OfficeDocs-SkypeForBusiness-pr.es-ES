...
El **panel** Informes muestra los datos sobre el uso de los Microsoft 365 o Office 365 de su organización. Puede usar  el informe de actividad Skype Empresarial participantes de conferencias para ver cuántas conferencias de mensajería instantánea, audio/vídeo, uso compartido de aplicaciones, web y de acceso telefónico/salida están participando los usuarios de su organización.
...
2. En la **página Uso,** seleccione **Skype Empresarial** actividad de participantes de conferencia  >   en la lista Seleccionar un **informe a** la izquierda. O bien, haga clic **en el widget Skype Empresarial actividad** y, a continuación, haga clic Skype Empresarial **actividad** de los participantes de la conferencia en la **Skype Empresarial actividad.**
