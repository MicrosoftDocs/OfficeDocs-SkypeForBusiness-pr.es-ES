...
Este informe, junto con los otro Skype para los informes de negocio, proporciona detalles sobre la actividad de conferencia en toda la organización. Estos detalles son muy útiles para investigar, planificar y tomar otras decisiones empresariales para su organización.
...
2. En la página de **uso** , haga clic en **Skype para la actividad de participantes de conferencia** en el **Seleccione una lista de informes** a la izquierda. O bien, haga clic en el widget de **Skype para la actividad de negocio** y, a continuación, haga clic en **Skype para la actividad de participantes de conferencia** en la lista de **Skype para la actividad de negocio** .
...
***
![Número 5](../images/sfbcallout5.png)<br/>Usar los datos de gráfico interactivo en el gráfico de **minutos** para comprender las tendencias de uso y para ver el número de minutos que se usan por los usuarios cuando organizan una conferencia con audio y vídeo y telefónico y acceso telefónico de salida - Microsoft como sus conferencias de audio proveedor. Muestra el número total de minutos de **Audio/vídeo** que se utilizan durante conferencias en las que se ha participado.
***
