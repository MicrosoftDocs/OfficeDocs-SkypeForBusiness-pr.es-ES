...
ms.locfileid: "19933101"
---
# <a name="device-usage-report"></a>Informe de uso del dispositivo

[] El nuevo panel **Informes** de Office 365 muestra la información general de actividad en los productos de Office 365 de su organización. Le permite explorar los informes de nivel de cada producto para obtener datos más pormenorizados sobre las actividades dentro de cada producto. Por ejemplo, puede usar el informe de **Skype para uso empresarial del dispositivo** para ver los dispositivos, incluidos los sistemas operativos basados en Windows y dispositivos móviles, que tienen el Skype para la aplicación empresarial de instalan y están usando para la mensajería instantánea y reuniones. 
...
Este informe, junto con los otro Skype para los informes de negocio, proporciona detalles sobre los tipos de clientes y dispositivos que se usan en toda la organización. Estos detalles son muy útiles para investigar, planificar y tomar otras decisiones empresariales para su organización.
...
2. En la página de **uso** , haga clic en **Skype para uso empresarial del dispositivo** en el **Seleccione una lista de informes** a la izquierda. O bien, haga clic en el widget de **Skype para la actividad de negocio** y, a continuación, haga clic en **Skype para uso empresarial del dispositivo** en la lista de **Skype para la actividad de negocio** .
...
Puede obtener una vista en los dispositivos que están usando el Skype para la aplicación empresarial de mirando en los gráficos de **usuario** y de **distribución** .
...
***
![Número 3](../images/sfbcallout3.png)<br/>Usar los datos de gráfico interactivo en el gráfico de **los usuarios** a comprender las tendencias de uso y para ver el número de usuarios que están conectados mediante el Skype para la aplicación empresarial que se usan en su organización. Se muestra el número total de usuarios y tipos de dispositivos de **Windows**, **Teléfono Android**, **Windows Phone**, **iPhone**y **iPad** que tienen el Skype para la aplicación empresarial de instalado y se usan en toda la organización.
***
...
*    En el gráfico de actividad de **distribución** , el eje Y es el número de usuarios que están conectados con un determinado tipo de dispositivo con el Skype para la aplicación empresarial de instalado. 
...
*    **Windows** se activa cuando el usuario tiene el Skype para la aplicación empresarial de cliente instalado en un sistema operativo basado en Windows y lo está utilizando. 
*    **Windows Phone** se selecciona si el usuario es tiene la Skype para la aplicación empresarial de cliente instalado en un dispositivo de Windows Phone y lo está utilizando.
*    **Teléfono Android** se activa cuando el usuario tiene el Skype para la aplicación empresarial de cliente instalado en un teléfono Android y lo está utilizando.
*    **iPhone** se activa cuando el usuario tiene el Skype para la aplicación empresarial de cliente instalado en un iPhone y lo está utilizando. 
*    **iPad** se activa cuando el usuario tiene el Skype para la aplicación empresarial de cliente instalado en un iPad y lo está utilizando. 
...
***
![Número 8](../images/sfbcallout8.png)<br/>Haga clic o puntee en el icono de **columnas** en cualquiera de las columnas para agregar o quitar columnas del informe.           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
***
![Número 9](../images/sfbcallout9.png)<br/>También puede exportar los datos del informe a un archivo .csv de Excel haciendo clic o pulsando o tocando en **Exportar**.           <br/> ![Skype para el botón Exportar informes de negocio.](../images/de7e2ab7-d70c-422f-a0ec-178b10f7dd51.png)<br/>De esta forma se exportan los datos de todos los usuarios, a los que puede aplicar orden y filtros simples para realizar más análisis. Si tiene menos de 2000 usuarios, puede ordenar y filtrar dentro de la tabla en el mismo informe. Si tiene más de 2000 usuarios, para ordenar y filtrar tendrá que exportar los datos. 
