...
|[Informe de uso de RTC de Skype Empresarial](pstn-usage-report.md) <br/>  | Nombre de usuario <br/>  Fecha y hora de llamada <br/>  Número de teléfono <br/>  ID <br/>  Tipo de llamada <br/>  Ubicación <br/>  Duración de la llamada <br/>  Moneda <br/>  Coste de la llamada <br/> |
...
|[Informe de grupos de minutos RTC de Skype empresarial](pstn-minute-pools-report.md) <br/> | Capacidad es el plan de servicio/licencia usado para la llamada. <br/> Tipo de licencia <br/> Descripción de la función <br/> Grupo de minutos por países  <br/> Minutos usados <br/> Minutos totales <br/> Porcentaje de minutos usado para el mes <br/> |
