...
- Al ver la lista de usuarios habilitados, puede seleccionar un usuario de la lista y usar el panel De acciones para editar la configuración de audioconferencia de ese usuario.
    
- Cuando selecciona un único usuario configurado para usar Microsoft como proveedor de audioconferencias, puede ver el número de teléfono predeterminado y si su organización está habilitada para identificadores de conferencia dinámicos, y puede restablecer el id. de conferencia para las reuniones que organice el usuario.
    
- Cuando selecciona un único usuario configurado para usar un proveedor de audioconferencia de terceros, puede ver el nombre del proveedor de audioconferencias, el número de teléfono de pago y el número de teléfono gratuito (si están configurados).
...
- Puede seleccionar más de un usuario y hacer lo siguiente:
  ...
  - Desactive las audioconferencias para el usuario cambiando el proveedor a **Ninguno.**
    
  - Cambie a Microsoft como el proveedor de audioconferencias si al usuario se le ha asignado una licencia **de audioconferencia.**
