...
> [!Note]
> Para obtener información sobre los identificadores de conferencia de usuario en Microsoft Teams, vea Ver y restablecer un [id.](/MicrosoftTeams/see-change-and-reset-a-conference-id-assigned-to-a-user-in-teams)de conferencia asignado a un usuario en Microsoft Teams .
...
3. En el **Skype Empresarial usuarios de** >  **audioconferencia** del centro de administración , en el panel de acciones en Id. de  >  conferencia, haga clic en **Restablecer**. 
