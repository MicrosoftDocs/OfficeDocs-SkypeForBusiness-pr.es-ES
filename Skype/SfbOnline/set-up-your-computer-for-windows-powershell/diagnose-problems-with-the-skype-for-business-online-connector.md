...
> [!IMPORTANT]
> De forma predeterminada, las sesiones de PowerShell se desalome después de 60 minutos. Para volver a conectar, tiene que cerrar la sesión e iniciar una nueva sesión de PowerShell. Recientemente se ha lanzado una nueva versión de Skype Empresarial [Online, módulo Windows PowerShell (2046.123 - Publicada 10/2/2019),](https://www.microsoft.com/download/details.aspx?id=39366)que incluye un nuevo cmdlet llamado **Enable-CsOnlineSessionForReconnection** que mitiga el problema de tiempo de espera de 60 minutos.
