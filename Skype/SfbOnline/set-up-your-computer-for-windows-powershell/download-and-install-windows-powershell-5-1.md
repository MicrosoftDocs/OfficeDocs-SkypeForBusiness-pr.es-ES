...
Para instalar Windows Management Framework 5,1, complete el procedimiento de [instalación y configuración de WMF 5,1](https://docs.microsoft.com/powershell/scripting/wmf/setup/install-configure).
