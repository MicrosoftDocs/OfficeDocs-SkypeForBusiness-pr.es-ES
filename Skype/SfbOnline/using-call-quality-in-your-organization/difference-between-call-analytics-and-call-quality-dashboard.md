...
![Llame al análisis de datos de usuario.](../images/call-analytics-user-data.png)
...
![Llame al análisis de datos de sesión de usuario.](../images/call-analytics-user-data-session.png)
