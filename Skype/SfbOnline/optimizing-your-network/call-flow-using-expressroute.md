...
1. Una conferencia de Skype empresarial se hospeda en la misma región en la que se ha alojado el organizador de la Conferencia. Se trata de la nube de Office 365 si el organizador es un usuario en línea o de un centro de datos local si el organizador de la reunión es un usuario local.
...
Para obtener más información sobre los detalles de la ruta multimedia que se elige, consulte [ICE: conectividad multimedia perimetral](https://aka.ms/AVEdge). Aunque este vídeo se recierne a Lync Server 2013, los principios y protocolos siguen aplicándose a Skype empresarial.
...
El tráfico no cruzará la conexión de ExpressRoute si los dos puntos de conexión se pueden comunicar directamente a través de Internet o si están situados dentro de su red. Esto incluirá los medios para las llamadas de punto a punto, el tráfico de Internet destinado a una implementación local o el tráfico entre los servidores perimetrales de Internet y Office 365. Un ejemplo sería un usuario que se une a una conferencia en línea desde un hotel.
