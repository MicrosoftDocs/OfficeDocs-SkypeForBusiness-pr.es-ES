...
Para autenticar elementos multimedia, los protocolos ICE y TURN también usan el desafío Digest descrito en la RFC del IETF referente a TURN. Para más obtener más información, consulte [recorrido de elementos multimedia](#external-user-av-traffic-traversal).
