...
**Nota:** Consulte esta documentación [pública para](/mem/intune/protect/device-compliance-get-started) la aplicación de pin de dispositivo disponible en cada una de las plataformas móviles anteriores.
