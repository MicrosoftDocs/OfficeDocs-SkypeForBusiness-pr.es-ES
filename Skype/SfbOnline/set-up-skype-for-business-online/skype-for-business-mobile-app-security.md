...
**Nota:** Consulta esta documentación [pública para la](https://docs.microsoft.com/InTune/deploy-use/introduction-to-device-compliance-policies-in-microsoft-intune) aplicación de pin de dispositivo disponible en cada una de las plataformas móviles anteriores
