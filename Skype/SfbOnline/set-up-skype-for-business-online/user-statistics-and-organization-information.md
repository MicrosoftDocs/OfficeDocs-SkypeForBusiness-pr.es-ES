...
|Usuarios sincronizados y alojados en línea  <br/> |Este es el número de usuarios híbridos que se crean en una implementación local Skype Empresarial Server pero se sincronizan con Microsoft 365 o Office 365.  <br/> Para configurar una conectividad híbrida de Skype Empresarial, consulte [Implementar la conectividad híbrida entre Skype Empresarial Server y Skype Empresarial Online](../../SfbHybrid/hybrid/configure-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json).  <br/> |
