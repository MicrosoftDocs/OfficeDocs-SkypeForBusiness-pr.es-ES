...
3. Para mover directorios de conferencia, ejecute el siguiente comando para cada directorio de conferencia del grupo:
   ...
   ```
    ...
    Por ejemplo, para mover el directorio de conferencia 3, use este comando, especificando un grupo Skype Empresarial Server 2019 como TargetPool:
...
Descargue [Desinstalar los roles heredados de Microsoft](https://go.microsoft.com/fwlink/p/?linkId=246227) y Quitar roles de servidor para obtener instrucciones detalladas y detalladas sobre cómo retirar grupos heredados.
  
Al mover directorios de conferencia, es posible que encuentre el siguiente error:
