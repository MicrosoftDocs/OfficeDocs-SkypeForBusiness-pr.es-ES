...
|:-----|:-----|:-----|
|![Icono de documentación](https://docs.microsoft.com/en-us/office/media/icons/paragraph-writing-blue.svg)|[Requisitos del sistema para Skype para Business Server 2019](../plan/system-requirements.md)  <br/> |Obtenga información sobre el servidor y los requisitos de entorno para Skype para Business Server.  <br/> |
