...
ms.locfileid: "50756226"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="4a9b3-103">Script de autenticación del panel de control de Skype Empresarial Server 2019</span><span class="sxs-lookup"><span data-stu-id="4a9b3-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="4a9b3-104">A continuación se presentan los scripts auxiliares relacionados con la autenticación para el Panel de control de administración moderno (MACP).</span><span class="sxs-lookup"><span data-stu-id="4a9b3-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="4a9b3-105">Configurar la autenticación MACP con Microsoft 365 u Office 365</span><span class="sxs-lookup"><span data-stu-id="4a9b3-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="4a9b3-106">Este script debe ejecutarse después de instalar la actualización acumulativa 1 o posterior de Skype Empresarial Server 2019, como parte de la configuración del nuevo Panel de control.</span><span class="sxs-lookup"><span data-stu-id="4a9b3-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="4a9b3-107">Configurar la aplicación MACP en la granja de servidores de ADFS</span><span class="sxs-lookup"><span data-stu-id="4a9b3-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="4a9b3-108">Este script debe ejecutarse después de instalar la actualización acumulativa más reciente de Skype Empresarial Server 2019, como parte de la configuración del nuevo Panel de control.</span><span class="sxs-lookup"><span data-stu-id="4a9b3-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="4a9b3-109">Configurar OAuth para MACP</span><span class="sxs-lookup"><span data-stu-id="4a9b3-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="4a9b3-110">Este script debe ejecutarse después de instalar la actualización acumulativa más reciente de Skype Empresarial Server 2019, como parte de la configuración del nuevo Panel de control.</span><span class="sxs-lookup"><span data-stu-id="4a9b3-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
