...
> [!IMPORTANT]
> Solo se usa un puerto el PIN para las organizaciones de los Estados Unidos. 
  
Seee [Números de teléfono de transferencia a Office 365](transfer-phone-numbers-to-office-365.md) para obtener más información sobre cómo transferir y trasladar dentro/fuera números de teléfono.
...
5. En la **establecer o cambiar el puerto fuera PIN** del panel, introduzca el PIN y haga clic en **Guardar**.
