...
description: "Cuando se buscan y obtener números de teléfono de su organización, puede obtener más de los números de teléfono que ha asignado licencias. Pero esto depende de los tipos de números de teléfono y tipos de licencias que ha comprado y ha asignado. Puede hacer clic Diferentes tipos de números de teléfono que utiliza para llamar a los planes para obtener información sobre los números de teléfono diferentes que se usan en Skype empresarial Online."
---
...
Cuando se buscan y obtener números de teléfono de su organización, puede obtener más de los números de teléfono que ha asignado licencias. Pero esto depende de los tipos de números de teléfono y tipos de licencias que ha comprado y ha asignado. Puede hacer clic [Diferentes tipos de números de teléfono que utiliza para llamar a los planes](different-kinds-of-phone-numbers-used-for-calling-plans.md) para obtener información sobre los números de teléfono diferentes que se usan en Skype empresarial Online.
  
Puede ver el número de números de teléfono que puede obtener en la página de **números de teléfono** en la Skype centro de administración de empresa, o puede ejecutar el cmdlet[Get-CsOnlineTelephoneNumberAvailableCount](https://technet.microsoft.com/en-us/library/mt634605.aspx) .
