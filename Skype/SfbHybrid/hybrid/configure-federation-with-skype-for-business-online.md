...
- [Habilite el espacio de direcciones SIP compartido en su organización de Office 365](#enable-shared-sip-address-space-in-your-office-365-organization).
...
```
 ...
 ## <a name="enable-shared-sip-address-space-in-your-office-365-organization"></a>Habilitar el espacio de direcciones SIP compartido en su organización de Office 365
  
Además del cambio realizado en la implementación local, tendrá que realizar el cambio correspondiente en la organización de Office 365 para habilitar el espacio de direcciones SIP compartido con su implementación local.  

Para habilitar el espacio de direcciones SIP compartido en su organización de Office 365, establezca una sesión remota de PowerShell con Skype empresarial online y, a continuación, ejecute el siguiente cmdlet:
