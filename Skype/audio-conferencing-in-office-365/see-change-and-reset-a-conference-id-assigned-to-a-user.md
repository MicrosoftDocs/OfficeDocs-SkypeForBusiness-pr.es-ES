...
---
# <a name="see-change-and-reset-a-conference-id-assigned-to-a-user"></a>Ver, cambiar y restablecer un ID de conferencia asignado a un usuario

Un ID de conferencia se asigna automáticamente a un Skype para usuarios de negocios o Teams de Microsoft cuando se configuran para conferencias de Audio en Office 365 y usar Microsoft como proveedor de conferencia de audio. El ID de conferencia puede ser estáticas o dinámicas y se envía la invitación a la reunión cuando se programa la reunión.
