...
#### [Implementar el Sistema de salas de Skype](../deploy/deploy-clients/deploy-skype-room-system.md)
##### [Sala de Skype sistema Exchange y las cuentas de Skype](../deploy/deploy-clients/skype-room-system-exchange-and-skype-accounts.md)
###### [Implementaciones locales de un solo bosque](../deploy/deploy-clients/single-forest-on-premises-deployments.md)
###### [Implementaciones locales de bosques múltiples](../deploy/deploy-clients/multiple-forest-on-premises-deployments.md)
...
##### [Consideraciones acerca de la migración](../deploy/deploy-clients/migration-considerations.md)
##### [Consideraciones de unión a dominio](../deploy/deploy-clients/domain-joining-considerations.md)
##### [Licencia del software de Skype Empresarial](../deploy/deploy-clients/skype-for-business-software-liicense.md)
##### [Administración y herramientas](../deploy/deploy-clients/manageability-and-tools.md)
##### [Scripts de configuración de salas](../deploy/deploy-clients/room-setup-scripts.md)
