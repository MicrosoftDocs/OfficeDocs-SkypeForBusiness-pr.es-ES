...
> [!NOTE]
> Si desea habilitar CAC en su implementación, debe habilitar CAC en exactamente un grupo por sitio central. Recomendamos CAC si está implementando características de voz o conferencias A/V.

Para obtener más información sobre cómo especificar características para un grupo de servidores Enterprise Edition, vea [definir y configurar un grupo de servidores front-end](https://technet.microsoft.com/library/713fc263-23dd-414a-b001-82932e4fe966.aspx) en la documentación de implementación.
