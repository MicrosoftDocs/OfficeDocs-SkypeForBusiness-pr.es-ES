...
Para obtener más información sobre cómo especificar características para un servidor Standard Edition o un grupo de servidores Enterprise Edition, consulte [Define and Configure a Front End Pool or Standard Edition Server](/previous-versions/office/lync-server-2013/lync-server-2013-define-and-configure-a-front-end-pool-or-standard-edition-server) en la documentación sobre implementación.