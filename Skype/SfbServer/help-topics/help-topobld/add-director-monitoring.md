...
- **Almacén de SQL Server de supervisión**: seleccione un nombre de dominio completo (FQDN) de SQL Server (y, opcionalmente, una instancia de SQL Server con nombre) de la lista.
