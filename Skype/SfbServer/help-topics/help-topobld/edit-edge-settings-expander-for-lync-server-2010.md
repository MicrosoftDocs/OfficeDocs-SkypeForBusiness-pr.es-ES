...
- Para editar el servicio perimetral de **acceso, defina** el **FQDN** de grupo para el servicio perimetral de acceso tal como se define en DNS por host (A y AAAA si se usa IPv6) y un valor de puerto
