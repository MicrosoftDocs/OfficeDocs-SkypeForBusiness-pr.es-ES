...
---
# <a name="add-edge-server-external-ipv4"></a><span data-ttu-id="1405b-103">Agregar IPv4 externa de servidor perimetral</span><span class="sxs-lookup"><span data-stu-id="1405b-103">Add Edge Server External IPv4</span></span>
 
<span data-ttu-id="1405b-104">En **IPv4 externa**, escriba la dirección IP externa que apunta al servicio perimetral de acceso, el servicio perimetral de conferencias web y el servicio perimetral a/V.</span><span class="sxs-lookup"><span data-stu-id="1405b-104">In **External IPv4**, enter the external IP address that points to the Access Edge service, Web Conferencing Edge service, and A/V Edge service.</span></span>
