...
Para establecer un servidor de chat persistente o un grupo de servidores de chat persistente implementados en inactivo, seleccione el servidor o grupo de servidores de la lista y haga clic **en Activar**. Al menos un servidor debe estar establecido en activo.
