...
- **Habilitar el Control de admisión de llamada** Seleccione esta opción para habilitar CAC. No la seleccione la opción para deshabilitar el control de admisión de llamadas en toda la red. Para habilitarlo, debe tener la red convenientemente configurada para ello. Para obtener más información, vea [implementar llamada de control de admisión en Skype para el año 2015 de Business Server](../../deploy/deploy-enterprise-voice/deploy-call-admission-control.md) en la documentación de implementación.
    
- **Grupo de servidores Front-End para ejecutar el Control de admisión de llamadas** Si habilita CAC, puede cambiar el grupo que lo ejecuta. Seleccione el grupo en la lista desplegable.
