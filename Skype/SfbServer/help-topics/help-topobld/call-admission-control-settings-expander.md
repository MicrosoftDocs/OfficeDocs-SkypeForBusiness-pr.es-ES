...
- **Habilitar el Control de admisión de llamadas** Seleccione esta opción para habilitar el CAC. No la seleccione la opción para deshabilitar el control de admisión de llamadas en toda la red. Para habilitarlo, debe tener la red convenientemente configurada para ello. Para obtener información detallada, vea [implementar el control de admisión de Skype para Business Server 2015 de llamadas](../../deploy/deploy-enterprise-voice/deploy-call-admission-control.md) en la documentación de implementación.
    
- **Grupo de servidores Front-End para ejecutar el Control de admisión de llamadas** Si se habilita el CAC, puede cambiar el grupo de servidores que lo ejecuta. Seleccione el grupo en la lista desplegable.
