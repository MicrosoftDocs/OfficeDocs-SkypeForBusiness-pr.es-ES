...
No puede invalidar el nombre de dominio completo (FQDN) del grupo de servicios web interno para un servidor Standard Edition web. Si está configurando el equilibrio de carga del Sistema de nombres de dominio (DNS) para un grupo de servidores front-end de Enterprise Edition, puede especificar una dirección URL base interna diferente (que debe ser diferente del FQDN del grupo y podría ser, por ejemplo, interna).\<your base URL\>.
