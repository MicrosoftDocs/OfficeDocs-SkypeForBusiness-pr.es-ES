...
Para obtener más información sobre la configuración del grupo de servidores de mediación o del servidor de mediación, consulte [Deploy a Mediation Server in Topology Builder in Skype Empresarial Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) en la documentación sobre implementación.
