...
- Seleccione el **servidor de mediación** junto habilitado si desea asociar el servidor de mediación con este servidor front-end o grupos de servidores front-end.
