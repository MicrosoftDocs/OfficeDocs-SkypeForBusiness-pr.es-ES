...
- Seleccione el **servidor de mediación** asociado habilitado si desea colocar el servidor de mediación con este servidor front-end o grupos de servidores front-end.
