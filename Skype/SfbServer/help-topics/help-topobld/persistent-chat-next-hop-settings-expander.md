...
Configure el **grupo del próximo salto** del Chat persistente mediante la selección de un grupo de servidores Front-End o de servidor Front-End de la lista.
