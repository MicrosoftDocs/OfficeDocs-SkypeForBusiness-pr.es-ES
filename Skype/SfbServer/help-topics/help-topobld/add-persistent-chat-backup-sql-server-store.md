...
Seleccione en la lista Creación **de SQL Server** almacenar una instancia SQL Server y opcional para que actúe como el reflejo SQL Server de la copia de seguridad de chat persistente SQL Server.
