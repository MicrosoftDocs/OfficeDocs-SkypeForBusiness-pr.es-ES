...
Si decidió no instalar las bases de datos reflejadas de SQL Server durante el proceso de publicación, puede instalarlas con **install Database** desde un derecho en cualquier nodo del generador de topologías. Seleccione el almacén de reflejo que desea instalar. Haga clic en **configuración** para definir cualquier configuración avanzada.
