...
Si optó por no instalar las bases de datos reflejadas SQL Server durante el proceso de publicación, las instalará mediante **Instalar** base de datos desde un clic con el botón derecho en cualquier nodo del Generador de topologías. Seleccione el almacén reflejado que se va a instalar. Haga **clic Configuración** para definir cualquier configuración avanzada.
