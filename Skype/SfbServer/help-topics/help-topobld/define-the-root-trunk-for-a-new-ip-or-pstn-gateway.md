...
Para definir el tronco raíz de la IP o red telefónica conmutada (RTC) debe configurar lo siguiente:

- **Nombre de tronco**: defina el nombre de dominio completo asociada con el tronco

- **Puerto de escucha para la puerta de enlace IP/RTC**: defina el puerto en el que escuchará este tronco
