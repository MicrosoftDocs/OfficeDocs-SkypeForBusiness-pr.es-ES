...
Para obtener más información, vea [Deploy a Mediation Server in Topology Builder in Skype Empresarial Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
