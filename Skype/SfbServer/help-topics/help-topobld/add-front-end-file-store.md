...
> [!IMPORTANT]
> El recurso compartido de archivos no se puede ubicar en el servidor front-end Enterprise Edition, pero puede estar ubicado en un servidor Standard Edition.
