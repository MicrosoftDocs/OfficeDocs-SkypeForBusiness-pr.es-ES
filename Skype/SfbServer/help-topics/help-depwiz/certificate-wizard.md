...
> [!NOTE]
> La opción **Importar certificado** suele usarse para procesar un certificado que se recibe a través de un proceso distinto al de una solicitud del Asistente para certificados. Por ejemplo, el administrador de la PKI crea un certificado y hace que esté disponible para el usuario. Usar **Certificado de importación** para importar el certificado en el certificado del equipo almacenar y ponerla a disposición de Skype para Business Server asignar.
