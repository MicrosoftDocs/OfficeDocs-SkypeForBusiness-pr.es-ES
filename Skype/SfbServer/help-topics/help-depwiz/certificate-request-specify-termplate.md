...
description: La página Especificar la plantilla de certificado alternativo permite definir una plantilla de certificado que no sea la plantilla de certificado de servidor Web que se utiliza de forma predeterminada. Seleccione la casilla de verificación Usar plantilla de certificado alternativo para la entidad emisora de certificados y, a continuación, defina el nombre de la plantilla de certificado alternativo en el nombre de plantilla de certificado del cuadro de texto. Debe usar el mismo nombre de la plantilla que esté definida en la entidad de certificación. Haga clic en Atrás para volver a la página anterior. Haga clic en Cancelar para terminar el proceso de solicitud de certificado.
