...
> [!IMPORTANT]
> Para que los informes de Reporting Services se implemente correctamente y para tener acceso a los informes una vez completada la implementación, debe tener abierto el puerto TCP/IP 80 (y opcionalmente, el puerto TCP 443 para SSL, si asigna un certificado a Reporting Services) en el Firewall de Windows con seguridad avanzada en el SQL Server. Para obtener más información, consulta Configurar el Firewall de [Windows para permitir SQL Server acceso](/sql/sql-server/install/configure-the-windows-firewall-to-allow-sql-server-access) para Microsoft SQL Server 2008 R2.
