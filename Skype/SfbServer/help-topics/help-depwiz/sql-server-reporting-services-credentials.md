...
> [!NOTE]
> Para obtener más información, vea "Especificación de credenciales e información de conexión para orígenes de datos de informe (SSRS)" en [https://go.microsoft.com/fwlink/p/?LinkId=263431](/sql/reporting-services/report-data/specify-credential-and-connection-information-for-report-data-sources). 
  
Para obtener más información sobre cómo implementar los informes de Reporting Services para el servidor que ejecuta la supervisión, [vea Install Monitoring Reports in Skype Empresarial Server 2015](../../deploy/deploy-monitoring/install-monitoring-reports.md).
