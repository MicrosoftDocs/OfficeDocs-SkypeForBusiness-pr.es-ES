...
---
# <a name="deployment-wizard-admin-tools"></a><span data-ttu-id="c01c1-103">Asistente para la implementación: Herramientas administrativas</span><span class="sxs-lookup"><span data-stu-id="c01c1-103">Deployment Wizard: Admin Tools</span></span>
 
<span data-ttu-id="c01c1-104">Para obtener más información sobre cómo usar el Asistente para la implementación para instalar Skype empresarial Server 2015, consulte [instalar Skype empresarial server 2015](../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="c01c1-104">For details about using Deployment Wizard to install Skype for Business Server 2015, see [Install Skype for Business Server 2015](../../deploy/install/install.md).</span></span>
