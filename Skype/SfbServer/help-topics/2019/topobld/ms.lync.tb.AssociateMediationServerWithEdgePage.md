...
Para obtener más información, vea [Deploy a Mediation Server in Topology Builder in Skype Empresarial Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
