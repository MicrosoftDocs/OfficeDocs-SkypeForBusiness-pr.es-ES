...
Para obtener más información, consulte [implementar un servidor de mediación en el generador de topología en Skype empresarial Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
