...
ms.locfileid: "49804230"
---
# <a name="mediation-service-setting-expander"></a><span data-ttu-id="e75c5-103">Expansor de configuración de servidor de mediación</span><span class="sxs-lookup"><span data-stu-id="e75c5-103">Mediation Service Setting Expander</span></span>
 
<span data-ttu-id="e75c5-104">Use esta página para definir los puertos de este servidor de mediación y establecer sus asociaciones con puertas de enlace de red telefónica conmutada (RTC).</span><span class="sxs-lookup"><span data-stu-id="e75c5-104">Use this page to set the listening ports for this Mediation Server, and set its associations with public switched telephone network (PSTN) gateways.</span></span> 
