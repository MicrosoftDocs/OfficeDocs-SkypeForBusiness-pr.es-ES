...
- **SQL Store**, para cambiar la instancia de SQL Server que debe usarse en la supervisión de la base de datos SQL Store. Si se cambia la base de datos de SQL Store de un servidor de supervisión, para que surta efecto el cambio debe reiniciarse dicho servidor.
