...
Para obtener información detallada acerca de la configuración para el grupo de servidores de mediación o el servidor de mediación, vea [implementar un servidor de mediación en el generador de Skype para Business Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) en la documentación de implementación.
