...
Para obtener más información sobre la configuración del grupo de servidores de mediación o el servidor de mediación, consulte [implementar un servidor de mediación en el generador de topología en Skype empresarial Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) en la documentación de implementación.
