...
Para obtener más información sobre la configuración del grupo de servidores de mediación o el servidor de mediación, vea [Deploy a Mediation Server in Topology Builder in Skype Empresarial Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) en la documentación sobre implementación.
