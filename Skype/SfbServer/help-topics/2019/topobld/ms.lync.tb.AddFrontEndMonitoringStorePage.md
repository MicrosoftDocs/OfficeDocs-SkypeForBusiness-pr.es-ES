...
[Asociar un almacén de supervisión a un grupo de servidores Front-End en Skype para Business Server 2015](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md)
