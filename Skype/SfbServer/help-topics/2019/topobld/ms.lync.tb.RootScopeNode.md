...
- **Nueva topología**. Permite empezar a crear una topología nueva para la implementación. Esta opción resulta útil cuando se planea la implementación, antes de instalar lo servidores. No haga clic en esta opción si ya ha usado la topología actual para instalar la implementación.
...
- **Guardar una copia de la topología como**. Guarda la topología actual en un archivo que puede cargar de nuevo más adelante en el Generador de topologías.
