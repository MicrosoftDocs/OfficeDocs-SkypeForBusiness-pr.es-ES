...
Para obtener más información acerca de la planeación para Enterprise Voice, consulte [Plan para Enterprise Voice en Skype para Business Server](../../../plan-your-deployment/enterprise-voice-solution/enterprise-voice.md). Para obtener más detalles sobre la implementación de un servidor de mediación independiente, vea [implementar un servidor de mediación en el generador de Skype para Business Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
