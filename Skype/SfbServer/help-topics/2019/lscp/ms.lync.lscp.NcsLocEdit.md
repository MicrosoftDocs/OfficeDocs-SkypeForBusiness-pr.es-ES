...
ms.locfileid: "49836530"
---
# <a name="location-policy-create-new-or-edit-existing"></a>Directiva de ubicación: Crear nuevos o editar los existentes

Puede configurar directivas de ubicación para determinar si 9-1-1 mejorado (E9-1-1) está habilitado y cómo se usa, así como cómo se usa la información de ubicación para usuarios y contactos.
...
- **Ubicación** Especifica si se solicita a los usuarios información de ubicación:
