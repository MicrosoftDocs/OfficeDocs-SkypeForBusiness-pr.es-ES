...
1. **Ámbito:** Tenga en cuenta el ámbito de esta directiva. Puede ser **Global**, que se aplica a todos los usuarios de esta implementación, o **Site**, que solo son usuarios asignados a servidores locales en el sitio especificado.
...
2. Seleccione qué servicios de notificación de inserción desea habilitar activando la casilla de:
   ...
   - **Habilitar la notificación de** inserción de Apple habilitará la notificación de inserción en el PNCH de Apple para dispositivos que ejecuten iOS de Apple (por ejemplo, iPhone, iPad) y usar la aplicación Skype Empresarial
