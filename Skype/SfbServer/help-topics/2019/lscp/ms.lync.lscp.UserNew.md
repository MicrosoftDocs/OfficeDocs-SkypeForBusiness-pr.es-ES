...
ms.openlocfilehash: 45d59cb92d06fcb3dcae0246586af6f212ec809c
ms.sourcegitcommit: 556fffc96729150efcc04cd5d6069c402012421e
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/26/2021
ms.locfileid: "58620366"
---
# <a name="users-new-user"></a>Usuarios: Nuevo usuario

¿Qué desea hacer? Haga clic en el vínculo de la tarea que desee realizar.

- [Agregar un nuevo usuario](/previous-versions/office/lync-server-2013/lync-server-2013-add-and-enable-user-account-for-lync-server)
