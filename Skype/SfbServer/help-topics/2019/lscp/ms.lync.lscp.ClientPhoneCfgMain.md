...
En la página **Configuración de dispositivo** puede realizar las siguientes tareas:
  
- Agregar una configuración de dispositivo de forma global o para un sitio concreto.
    
- Modificar las opciones de una configuración de dispositivo existente.
...
[Configuración de dispositivo: Crear nuevos o editar los existentes](device-configuration-create-new-or-edit-existing.md)
#### 
