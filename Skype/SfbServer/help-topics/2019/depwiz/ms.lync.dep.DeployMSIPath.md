...
ms.locfileid: "19975956"
---
# <a name="deployment-wizard-path-to-msi-installer"></a><span data-ttu-id="48c9b-103">Asistente para la implementación: Ruta de acceso al instalador MSI</span><span class="sxs-lookup"><span data-stu-id="48c9b-103">Deployment Wizard: Path to MSI installer</span></span>
 
<span data-ttu-id="48c9b-104">Para obtener información detallada acerca de cómo utilizar el Asistente para la implementación para instalar Skype para Business Server, vea [Instalar Skype para Business Server](../../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="48c9b-104">For details about using Deployment Wizard to install Skype for Business Server, see [Install Skype for Business Server](../../../deploy/install/install.md).</span></span>
