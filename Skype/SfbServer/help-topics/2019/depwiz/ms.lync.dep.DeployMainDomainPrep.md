...
1. De Skype para medio o la carpeta de instalación de Business Server, ejecute Setup.exe para iniciar la Skype para el Asistente para la implementación de servidor de negocio.
