...
La página Nombre y seguridad **Configuración** proporciona un cuadro de texto para definir un nombre **descriptivo, una** lista desplegable para la longitud de bits  del par de claves públicas y privadas y una casilla que permite marcar la clave privada del certificado como **exportable**.
