...
ms.locfileid: "58592804"
---
# <a name="sql-server-reporting-services-invoke"></a>SQL Server Reporting Services (invocar)
 
Después de proporcionar la información necesaria para la implementación de los informes del servidor de supervisión en Microsoft SQL Server Report Services, la página Ejecutar comandos muestra un resumen de los comandos emitidos para instalar los informes en el SQL Server Reporting Services.
