...
2. En la **página Preparar bosque,** haga clic **en Siguiente**.
    ...
    > [!NOTE]
    > La preparación del bosque le permite elegir dónde colocar los grupos universales para Skype Empresarial Server. Elija una ubicación que respete los requisitos de su organización.
