...
2. En la página **Preparar el bosque**, haga clic en **Siguiente**.
    ...
    > [!NOTE]
    > La preparación del bosque le permite elegir dónde ubicar los grupos universales para Skype empresarial Server. Elija una ubicación que respete los requisitos de su organización.
