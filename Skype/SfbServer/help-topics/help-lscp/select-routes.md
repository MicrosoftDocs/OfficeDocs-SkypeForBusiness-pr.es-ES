...
ms.locfileid: "33924503"
---
# <a name="select-routes"></a>Seleccionar rutas
 
Use el cuadro de diálogo **Seleccionar rutas** para buscar rutas de voz existentes que se pueden usar.
  
> [!NOTE]
> Para recuperar todas las rutas de voz disponibles, no escriba nada en el cuadro de búsqueda y, a continuación, haga clic en el icono de búsqueda. 
