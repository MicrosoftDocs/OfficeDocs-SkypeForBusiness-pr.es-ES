...
- [Establecer el PIN de conferencia de acceso telefónico local de un usuario en Skype Empresarial Server 2015](../../manage/authentication/set-a-user-s-dial-in-conferencing-pin.md)
