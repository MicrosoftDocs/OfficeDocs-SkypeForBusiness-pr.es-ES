...
> [!NOTE]
> Las directivas de archivado solo se aplican a los usuarios que se Skype Empresarial Server. Si usa la integración Exchange para almacenar datos de archivado en Microsoft Exchange, Exchange directivas de 2013 controlan el archivado para los usuarios que se hospedaron en Exchange 2013. Para habilitar el archivado para esos usuarios, el buzón del usuario debe colocarse en In-Place retención. 
