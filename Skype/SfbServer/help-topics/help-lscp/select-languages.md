...
Seleccione los idiomas que quiera usar para el número de acceso para conferencia de acceso telefónico local. Para obtener información detallada, consulte [Create or Modify a Dial-in Conferencing Access Number](https://technet.microsoft.com/library/06f55c28-57f8-4d4e-8313-9740846796d9.aspx).
