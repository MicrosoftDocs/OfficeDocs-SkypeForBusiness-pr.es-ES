...
- **Habilitar usuarios** Haga clic para abrir el cuadro de diálogo [usuarios: nuevo Lync Server](users-new-lync-server-user.md) , donde puede Agregar un nuevo usuario a Skype empresarial Server.

    Para agregar un nuevo contacto, haga clic en la flecha abajo y, luego, seleccione **Habilitar contactos** para abrir el cuadro de diálogo [Users: New Contact Objects](users-new-contact-objects.md).
...
- **Acción** Haga clic en **acción**y, a continuación, seleccione la acción que desea realizar para los usuarios seleccionados en los resultados de la búsqueda. Están disponibles las siguientes acciones:
  ...
  - **Ver estado del PIN** Abre el cuadro de diálogo [usuarios: estado de vista PIN](users-view-pin-status.md) , que muestra los datos del PIN del usuario seleccionado.
  ...
  - **Mover los usuarios seleccionados al grupo** Abre el cuadro de diálogo [mover usuario](move-user.md) , donde puede seleccionar un grupo al que mover el usuario seleccionado.

  - **Mover todos los usuarios al grupo** Abre el cuadro de diálogo [mover usuario](move-user.md) , donde puede seleccionar un grupo para mover a todos los usuarios seleccionados.
