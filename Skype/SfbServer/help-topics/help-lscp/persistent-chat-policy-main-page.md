...
Si un usuario se ha habilitado para Skype Empresarial, puede aplicar directivas adecuadas a usuarios específicos para habilitarlas o deshabilitarlas para el servidor de chat persistente.
...
5. En **Editar usuario de Lync Server en** Directiva de chat **persistente,** seleccione la directiva de usuario de chat persistente que desee aplicar.
