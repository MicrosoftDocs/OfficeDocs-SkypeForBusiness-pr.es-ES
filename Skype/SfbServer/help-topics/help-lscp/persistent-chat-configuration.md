...
Los administradores de chat persistentes también pueden usar el panel de control o los cmdlets de Windows PowerShell para crear y administrar salas.
...
Puede realizar las siguientes tareas en la página **configuración de chat persistente** : Configure las opciones del servidor de chat persistentes de forma global o para un grupo específico.
