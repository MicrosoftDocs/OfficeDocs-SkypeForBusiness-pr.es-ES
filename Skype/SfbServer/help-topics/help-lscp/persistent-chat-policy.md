...
Puede usar la página **Directiva de chat persistente** del grupo **Chat persistente** para administrar directivas en un nivel global, de grupo, de sitio o de usuario, además de configurar la directiva global predeterminada y crear una o varias directivas de sitio y usuario adicionales para su implementación. Si el servidor de charla persistente está habilitada para un usuario por la directiva, el entorno de servidor de charla persistente aparece en su cliente.
...
Si un usuario se ha habilitado para Skype para Business Server, puede aplicar las políticas apropiadas a usuarios específicos para habilitarlos o deshabilitarlos para servidor de Chat persistente.
