...
ms.locfileid: "58595774"
---
# <a name="select-a-service"></a>Seleccionar un servicio

Use el **cuadro de diálogo Seleccionar un servicio** para buscar servicios disponibles en su entorno. Para usar un servicio existente, haga clic en un servicio de la lista y, a continuación, haga clic en **Aceptar**.
...
Puede realizar las siguientes tareas en la **página Seleccionar un** servicio:

- [Configurar categorías](/previous-versions/office/lync-server-2013/lync-server-2013-configure-categories)

- [Configurar complementos para salones](/previous-versions/office/lync-server-2013/lync-server-2013-configure-add-ins-for-rooms)

- [Configurar opciones de servidor de chat persistentes a nivel global o para grupos de servidores de chat persistentes](/previous-versions/office/lync-server-2013/lync-server-2013-configure-persistent-chat-server-options-globally-or-for-persistent-chat-server-pool)
...
## <a name="to-configure-add-ins-for-chat-rooms"></a>Para configurar complementos para salas de chat

En **Seleccionar un servicio,** seleccione el servicio correspondiente al grupo de servidores de chat persistente donde necesita crear el complemento. Los complementos no se pueden mover de un grupo a otro ni compartir entre grupos distintos.
...
En **Seleccionar un servicio,** seleccione el servicio asociado al grupo de servidores de chat persistente que se va a configurar.
