...
- En **Porcentaje de conferencias con voz,** escriba el porcentaje de conferencias que incluirán audio. 
  ...
  - Si el 20 % de las conferencias de voz incluyen cargas de datos, como presentaciones de PowerPoint, active **la** casilla Incluir conferencias web.
    
  **Movilidad**
  
- En **Porcentaje de usuarios habilitados para Movilidad,** escriba el porcentaje de usuarios que se habilitarán para conectarse a Skype Empresarial Server mediante dispositivos móviles. El valor predeterminado es el 40 %. 
    
Cuando haya especificado toda la información necesaria, la calculadora de capacidad calcula sus requisitos. Las celdas amarillas muestran valores calculados para los requisitos de CPU, memoria y ancho de banda en función de las pruebas realizadas en laboratorios de rendimiento de Skype Empresarial Server. Los números se proporcionan como una directriz, no todas las variaciones se prueban y validan. Se calculan los siguientes valores: 
