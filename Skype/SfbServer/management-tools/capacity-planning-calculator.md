...
La Skype Empresarial Server de capacidad [de 2015](https://www.microsoft.com/download/details.aspx?id=51196) y la calculadora de capacidad Skype Empresarial Server [2019](https://www.microsoft.com/download/details.aspx?id=57509) aumentan la herramienta de planeación de [Skype Empresarial](https://www.microsoft.com/download/details.aspx?id=50357) y la documentación de implementación ([Plan for your Skype Empresarial Server implementación de 2015](../plan-your-deployment/plan-your-deployment.md) y [Plan for your Skype Empresarial Server 2019 deployment](../../SfBServer2019/plan/plan-your-deployment-2019.md) respectively). Use la calculadora después de revisar la guía y crear una topología recomendada mediante la Herramienta de planeación.
...
Una vez que haya usado la Herramienta de planeación y la calculadora de planeación de capacidad, debe simular la carga propuesta y planeada para asegurarse de que Skype Empresarial Server se aprovisionará adecuadamente. Para realizar pruebas de esfuerzo bajo una carga simulada, use la Skype Empresarial Server [stress and performance tool](https://www.microsoft.com/download/details.aspx?id=50367) documentada en [Skype Empresarial Server Stress and Performance Tool](./stress-and-performance-tool/stress-and-performance-tool.md).
...
- **El porcentaje de usuarios de** voz implicados en llamadas UC-UC muestra el porcentaje de usuarios que están habilitados para Telefonía IP empresarial que se habilitarán solo para las llamadas UC-UC. Este número se calcula en función del porcentaje de usuarios de voz habilitados **para llamadas RTC UC**. 
...
- En **Porcentaje de conferencias que usan voz**, escriba el porcentaje de conferencias que incluirán audio. 
...
- **CPU front-end**: porcentaje de uso de LA CPU si la carga completa estaba siendo manejada por un servidor front-end con las mismas especificaciones que el servidor que se usó en las pruebas (vea la descripción al final de este artículo).
...
- **Servidor de base de datos back-end requerido (** grupos necesarios):número de servidores de bases de datos back-end necesarios para admitir la carga de trabajo seleccionada.
