...
2. <span data-ttu-id="c1250-138">Escriba lo siguiente en el símbolo de la línea de comandos:</span><span class="sxs-lookup"><span data-stu-id="c1250-138">Type the following at the command-line prompt:</span></span>
