...
Después de crear una topología que incluya la carga de trabajo de conferencia y las conferencias de acceso telefónico local seleccionadas, debe realizar pasos adicionales para configurar las conferencias de acceso telefónico local. Antes de leer este tema, asegúrese de haber leído [Plan for dial-in conferencing in Skype Empresarial Server](../../plan-your-deployment/conferencing/dial-in-conferencing.md), [Hardware and software requirements for conferencing in Skype Empresarial Server](../../plan-your-deployment/conferencing/hardware-and-software-requirements.md), and the [Deployment flowchart and checklist for dial-in conferencing](deploy-conferencing.md#deployment-flowchart-and-checklist-for-dial-in-conferencing). 
...
Además, puede realizar las siguientes tareas opcionales. Para obtener más información acerca de estas tareas opcionales, vea [Manage dial-in conferencing in Skype Empresarial Server](../../manage/conferencing/dial-in-conferencing.md).
...
Para obtener más información sobre cómo crear reglas de normalización, vea [Create or modify a normalization rule in Skype Empresarial](../../deploy/deploy-enterprise-voice/normalization-rules.md).
...
Para comprobar si la región está establecida para todos los planes de marcado de conferencia de acceso telefónico local, use el cmdlet **Get-CsDialPlan** . Si falta la región en los planes de marcado, puede usar el cmdlet **Set-CsDialPlan** para establecerla. También puede usar el Panel Skype Empresarial Server control para actualizar la región en los planes de marcado existentes. Para obtener más información sobre Skype Empresarial Server panel de control, vea [Crear o modificar un plan de marcado en Skype Empresarial Server](../../deploy/deploy-enterprise-voice/dial-plans.md).
...
5. En **Número de pantalla**, escriba el número de teléfono que los usuarios telefónicos de la red telefónica conmutada (RTC) marcan para unirse a una conferencia. Este número se muestra en las invitaciones a reuniones y en la página web de conferencias Configuración acceso telefónico local.
    
6. En **Nombre para mostrar**, escriba una descripción para el número de acceso telefónico. Este es el nombre asociado al número de acceso telefónico en los resultados Skype Empresarial búsqueda. Este nombre se muestra en el cliente cuando un usuario llama al número de acceso. 
...
8. En **URI de SIP**, haga lo siguiente:
   ...
   - En el cuadro de lista desplegable, haga clic en el dominio del aplicación Operador de conferencia que admite este número de acceso telefónico local.
    
9. En **Grupo**, haga clic en el grupo que ejecuta la instancia de Operador de conferencia que admite este número de acceso telefónico.
...
Los usuarios de acceso telefónico escriben su número de teléfono o extensión y un PIN para participar en conferencias como usuarios autenticados. El URI de **línea de** telefonía especificado en Skype Empresarial Server de usuario es necesario para la autenticación.
...
5. Haga doble clic en el nombre de usuario para abrir el **cuadro de diálogo Editar Skype Empresarial Server usuario**.
    
6. En **Telefonía**, en el campo **URI de línea**, escriba un número de teléfono único y normalizado (por ejemplo, tel:+14255550200).
    
    > [!NOTE]
    > Solo puede especificar **uri** de línea si **telefonía** está establecida en **solo pc a pc****, Telefonía IP empresarial**, **control** remoto de llamadas o **control remoto de llamadas**. 
