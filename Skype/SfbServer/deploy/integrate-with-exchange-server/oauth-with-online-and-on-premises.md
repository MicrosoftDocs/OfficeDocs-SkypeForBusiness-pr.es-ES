...
La configuración de la integración entre Exchange servidor y Skype Empresarial Online permite Skype Empresarial y Exchange de integración descritas en [Compatibilidad con características](../../plan-your-deployment/integrate-with-exchange/integrate-with-exchange.md#feature_support).
...
-  Deberá tener asignados permisos antes de poder llevar a cabo este procedimiento o procedimientos. Para ver qué permisos necesita, consulte el [tema Exchange y permisos](/exchange/exchange-and-shell-infrastructure-permissions-exchange-2013-help) de infraestructura del Shell.
...
- Para obtener información sobre la compatibilidad, [consulta Skype Empresarial compatibilidad con Office aplicaciones](../../plan-your-deployment/clients-and-devices/compatibility-with-office.md).
...
Si quieres asegurarte de que estás usando OAuth correctamente, asegúrate de saber qué esperar y saber cómo debe ser el tráfico. Por lo [tanto, esto](https://tools.ietf.org/html/draft-ietf-oauth-v2-23#page-34) es lo que puede esperar, este es un ejemplo bastante estándar del tráfico [de OAuth](https://download.microsoft.com/download/8/5/8/858F2155-D48D-4C68-9205-29460FD7698F/[MS-SPS2SAUTH].pdf)  en una aplicación microsoft (realmente útil para leer, aunque no usa tokens refresh), y hay extensiones de Fiddler que le permitirán ver su JWT de OAuth (token web JSON).
