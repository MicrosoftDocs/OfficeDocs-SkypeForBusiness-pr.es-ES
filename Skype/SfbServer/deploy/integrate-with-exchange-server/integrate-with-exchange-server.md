...
Si va a integrar Skype Empresarial Online con Exchange Server local, vea [Configure OAuth between Skype Empresarial Online and Exchange on premises](oauth-with-online-and-on-premises.md).

## <a name="in-this-section"></a>En esta sección

[Configurar aplicaciones de partners en Skype Empresarial Server y Exchange Server](configure-partner-applications.md)

[Configurar Skype Empresarial Server para usar el Exchange Server archivado](use-exchange-archiving.md)

[Configurar SharePoint server para buscar datos Skype Empresarial archivados](sharepoint-to-search-for-archived-data.md)

[Configurar Skype Empresarial Server usar el almacén de contactos unificado](use-the-unified-contact-store.md)

[Configurar el uso de fotos de alta resolución en Skype Empresarial Server](high-resolution-photos.md)

[Configurar Exchange Server mensajería unificada para Skype Empresarial Server de voz](exchangeunified-messaging-for-voice-mail.md)

[Integración Skype Empresarial Server y Microsoft Outlook Web App 2013](/previous-versions/office/communications/jj688055(v=ocs.16))
