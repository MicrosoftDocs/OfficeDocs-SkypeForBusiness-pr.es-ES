...
ms.locfileid: "60755773"
---
# <a name="create-or-modify-a-voice-route-in-skype-for-business"></a>Crear o modificar una ruta de voz en Skype Empresarial
 
**Resumen:** Obtenga información sobre cómo crear o modificar una ruta de voz en Skype Empresarial Server mediante el Panel de control Skype Empresarial Server voz.
  
### <a name="to-create-a-voice-route-by-using-the-skype-for-business-server-control-panel"></a>Para crear una ruta de voz mediante el Panel Skype Empresarial Server control
