...
- [Proceso de implementación de estacionamiento de llamadas en Skype para la empresa](deployment-process-for-call-park.md)
    
- [Proceso de implementación de grupo de llamada recogida en Skype para la empresa](deployment-process-for-group-call-pickup.md)
    
- [Proceso de implementación de grupo de respuesta en Skype para la empresa](deployment-process-for-response-group.md)
    
- [Proceso de implementación de la aplicación de anuncio en Skype para Business Server](deployment-process-for-the-announcement-application.md)
