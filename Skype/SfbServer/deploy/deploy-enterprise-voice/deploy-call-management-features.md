...
- **Estacionamiento de** llamadas: permite a los usuarios de voz estacionar temporalmente una llamada y, a continuación, recogerla desde el mismo teléfono u otro teléfono.
...
En esta sección se describe cómo configurar estas características de administración de llamadas durante una Telefonía IP empresarial implementación.
  
## <a name="in-this-section"></a>En esta sección

- [Proceso de implementación para estacionamiento de llamadas en Skype Empresarial](deployment-process-for-call-park.md)
    
- [Proceso de implementación para la recogida de llamadas de grupo en Skype Empresarial](deployment-process-for-group-call-pickup.md)
    
- [Proceso de implementación para grupo de respuesta en Skype Empresarial](deployment-process-for-response-group.md)
