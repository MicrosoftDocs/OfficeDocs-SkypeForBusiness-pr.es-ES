...
**Resumen:** Obtenga información sobre cómo configurar directivas de voz, registros de uso de RTC y rutas de voz en Skype Empresarial Server.
...
> [!NOTE]
> También puede crear directivas de voz con ámbito  *de*  usuario y asignarlas a usuarios o grupos individuales.
...
- [Exportar o importar un archivo de configuración de ruta de voz en Skype Empresarial](voice-route-configuration-import-export.md)
