...
- [Requisitos previos de seguridad y configuración para Telefonía IP empresarial en Skype Empresarial Server](enterprise-voice-security.md)

- [Implementar un servidor de mediación en el Generador de topologías en Skype Empresarial Server](deploy-a-mediation-server.md)

- [Definir una puerta de enlace en el Generador de topologías en Skype Empresarial Server](define-a-gateway.md)

- [Definir troncos adicionales en el Generador de topologías en Skype Empresarial Server](define-additional-trunks.md)

- [Instalar los archivos del servidor de mediación en Skype Empresarial Server](install-mediation-server.md)
...
- [Implementar características Telefonía IP empresarial avanzadas en Skype Empresarial Server](deploy-advanced-enterprise-voice-features.md)
