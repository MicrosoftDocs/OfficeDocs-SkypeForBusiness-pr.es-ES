...
1. Si va a usar el Panel Skype Empresarial Server control en este servidor, también debe instalar Silverlight. Para instalar Silverlight, consulte [Microsoft Silverlight](https://www.microsoft.com/silverlight/).
