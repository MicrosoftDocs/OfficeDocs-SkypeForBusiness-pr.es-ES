...
5. Los Skype Empresarial Server componentes principales se instalarán en el servidor. 
   ...
   - **Skype Empresarial Server de implementación** Un programa de implementación que proporciona un panel de inicio para instalar los distintos componentes de Skype Empresarial Server.
