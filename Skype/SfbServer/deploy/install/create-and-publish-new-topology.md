...
### <a name="define-a-front-end-pool-or-standard-edition-server"></a>Definir un grupo de servidores front-end o un Standard Edition cliente
...
7. A continuación, definirá el SQL Server que se usará con la topología. En este ejemplo, se usa la instancia Default. Para obtener más información SQL Server características, como alta disponibilidad, vea [Plan for high availability and disaster recovery in Skype Empresarial Server](../../plan-your-deployment/high-availability-and-disaster-recovery/high-availability-and-disaster-recovery.md).
