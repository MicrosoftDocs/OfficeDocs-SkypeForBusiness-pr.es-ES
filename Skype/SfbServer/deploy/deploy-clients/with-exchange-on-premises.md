...
Lea este tema para obtener información acerca de cómo implementar Microsoft salones de los equipos en un entorno híbrido con Exchange local y Skype para profesionales en línea.
...
Antes de implementar Microsoft salones de los equipos con Exchange local, debe asegurarse de que cumplen los requisitos. Para obtener más información, vea [requisitos de salas de equipos de Microsoft](../../plan-your-deployment/clients-and-devices/requirements.md).
...
1. En la herramienta de **usuarios de Active Directory y AD de equipos** , haga clic en la carpeta o unidad organizativa que sus salones de los equipos de Microsoft se crearán cuentas en, haga clic en **nuevo**y, a continuación, haga clic en **usuario**.
...
### <a name="assign-a-skype-for-business-license-to-your-microsoft-teams-rooms-account"></a>Asignar un Skype para licencia empresarial a su cuenta de salas de equipos de Microsoft
