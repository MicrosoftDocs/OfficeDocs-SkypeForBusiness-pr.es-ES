...
Sólo debe realizar estos pasos si el Skype es necesario para las cuentas empresariales y Exchange ya se han creado y probado como se describe en [implementar sistemas de salas de Skype v2](room-systems-v2.md). Se necesita el hardware y el software descrito en los [requisitos de los sistemas de salas de Skype v2](../../plan-your-deployment/clients-and-devices/requirements.md). Este tema incluye las secciones siguientes:
  
- [Preparación de la imagen de instalación](console.md#Prep_Image)
    
- [Instalar un certificado de entidad emisora privado en el dispositivo de tableta gráfica](console.md#Certs)
    
- [Instalar Windows 10 y la aplicación de consola de sistemas de salas de Skype v2](console.md#Reimage)
   
- [Configuración inicial de la consola](console.md#Initial)
    
- [Lista de comprobación de implementación de sala de Skype sistemas v2](console.md#Checklist)
    
> [!NOTE]
> Sistemas de salas de Skype v2 sólo funcionará en un Skype configurado correctamente para el entorno empresarial donde las cuentas de dispositivos configuradas correctamente, como se describe en [implementar sistemas de salas de Skype v2](room-systems-v2.md). 
  
## <a name="prepare-the-installation-image"></a>Preparación de la imagen de instalación
<a name="Prep_Image"> </a>

Instalación de la aplicación sistemas de salas de Skype v2 en un Surface Pro 4 o Surface Pro requiere un dispositivo de almacenamiento USB con al menos 32GB de memoria con formato de un disco FAT32. No debe haber ningún otro archivo en el dispositivo, se perderán los archivos existentes en el almacenamiento USB. 
  
> [!NOTE]
> Si no se lograr crear la imagen de consola de acuerdo con estas instrucciones, el resultado probablemente será un comportamiento inesperado. Aniversario de Windows 10 Enterprise Update (versión 1607) ya no se admite para la creación de imágenes de sistemas de salas de Skype v2. 
  
> [!NOTE]
> Funcionará un v2 de Skype sala sistemas existentes con Windows 10 Enterprise aniversario Update moviendo a sistemas de salas de Skype v2 update 3 mediante el almacén de Windows, pero debe realizarse una instalación nueva como se describe a continuación. 
...
3. Coloque la MSU para KB4056892 en el mismo directorio que la secuencia de comandos CreateSrsMedia.ps1.
4. Ejecute la secuencia de comandos CreateSrsMedia.ps1 desde un símbolo del sistema con privilegios elevados en un equipo Windows 10.


Siga las instrucciones de la secuencia de comandos para crear un disco de instalación de sistemas de salas de Skype v2 USB. Cuando termine, quitar el disco USB de su equipo y proceda a [instalar 10 de Windows y la aplicación de consola de sistemas de salas de Skype v2 ](console.md#Reimage).
...
En este momento, deberá aplicar la imagen que ha creado. La tableta se ejecutará como un dispositivo y el usuario predeterminado se establecerá para que se ejecute sólo la aplicación de sistemas de salas de Skype v2. 
  
1. Tablet PC debe estar conectado a una fuente de alimentación. Iníciela cuando esté completamente apagada. Si es necesario, presione y mantenga presionada el botón de encendido hasta que se desactiva la tableta.
    
2. Enchufe el disco de instalación de USB en la tableta.
    
3. Presione y mantenga el volumen hacia abajo (-) situado sobre la tableta. 
    
4. Presione y suelte el botón de encendido de la tableta.
...
3. Seleccione el icono de engranaje para iniciar la **configuración** de la aplicación.
    
4. Seleccione **tiempo &amp; lenguaje**.
    
5. Seleccione **región &amp; lenguaje**.
...
9. Seleccione **establecer como predeterminada**.
...
El idioma deseado se aplica ahora al dispositivo v2 sistemas de salas de Skype.
## <a name="initial-set-up-of-the-console"></a>Configuración inicial de la consola 
<a name="Initial"> </a>

Después de instalar Windows, la aplicación de sistemas de salas de Skype v2 entra en su proceso de instalación inicial cuando se inicia el siguiente o si se ha elegido la opción Reboot.
...
3. En "Configurar dominio" configurar el FQDN para el Skype para Business Server. Si el Skype para el dominio SIP de negocios es diferente del dominio de Exchange del usuario, escriba el dominio de Exchange en este campo.
    
4. Haga clic en **Siguiente**.
    
5. Seleccione los dispositivos indicados en la pantalla funciones y haga clic en **siguiente**. De manera predeterminada, la opción Pantalla compartida automática está activada y Ocultar nombres de las reuniones está desactivada. Los dispositivos que se deben seleccionar son:
...
2. Colocar la superficie 4 en modo de administrador (consulte [administración de modo y el dispositivo de administración](../../manage/skype-room-systems-v2/skype-room-systems-v2.md#AdminMode)).
...
Puede combinar dispositivos de sistemas de salas de Skype v2 en su dominio. Dispositivos de sistemas de salas de Skype v2 deben colocarse en una OU independiente de las estaciones de trabajo de PC porque muchas directivas de estación de trabajo no son compatibles con sistemas de salas de Skype v2. Un ejemplo común son las directivas de aplicación de contraseñas que le impiden que se inicie automáticamente sistemas de salas de Skype v2. Para obtener información acerca de la administración de configuraciones de GPO, consulte [administrar sistemas de salas de Skype v2](../../manage/skype-room-systems-v2/skype-room-systems-v2.md). 
  
### <a name="to-join-skype-room-system-v2-to-a-domain"></a>Para unir Sistemas de salas de Skype v2 a un dominio

1. Inicie una sesión en la consola de administración de la cuenta (consulte [administración de modo y dispositivos de administración](../../manage/skype-room-systems-v2/skype-room-systems-v2.md#AdminMode)).
...
Por ejemplo, si su nombre de dominio completo es redmond.corp.microsoft.com y desea que los dispositivos de sistemas de salas de Skype v2 en una "sala de Skype sistemas v2" unidad organizativa que es un elemento secundario de una unidad organizativa "recursos", el comando será:
  
```
Add-Computer -DomainName redmond.corp.microsoft.com -OUPath "OU=Skype_Room_System,OU=Resources,DC=redmond,DC=corp,DC=microsoft,DC=com"
```

 Si desea cambiar el nombre del equipo cuando se une a un dominio, utilice el indicador - NewName seguido por el nombre del equipo nuevo.
...
|☐  <br/> |Se han aplicado todos los Surface Pro 4 o actualizaciones del sistema Surface Pro  <br/> |
...
|☐  <br/> |Cámara colocado de forma óptima y funcional  <br/> |
