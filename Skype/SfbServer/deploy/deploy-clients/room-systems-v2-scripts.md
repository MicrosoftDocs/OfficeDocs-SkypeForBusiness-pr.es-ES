...
Copie cada una de las secciones de este artículo en un archivo de texto denominado en el encabezado de sección. Estos archivos se utilizan en la implementación de sistemas de salón de Skype v2: 
* [CreateSrsMedia.ps1](#createsrsmediaps1) es un script de Powershell para crear una imagen de software para el dispositivo de consola.  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) es un Powershell que se va a usar la secuencia de comandos utilizada para configurar Skype para las cuentas empresariales y de Exchange de los dispositivos.  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) se usa al configurar la administración de sistemas de salón de Skype v2 con OMS.
