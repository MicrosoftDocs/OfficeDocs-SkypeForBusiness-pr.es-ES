...
Antes de implementar Microsoft salones de los equipos con Exchange Online, debe asegurarse de que cumplen los requisitos. Para obtener más información, vea [requisitos de salas de equipos de Microsoft](../../plan-your-deployment/clients-and-devices/requirements.md).
...
1. Herramienta de **usuarios de Active Directory y AD de equipos** , haga clic en la carpeta o unidad organizativa que sus salones de los equipos de Microsoft se crearán cuentas en, haga clic en **nuevo**y, a continuación, haga clic en **usuario**.
