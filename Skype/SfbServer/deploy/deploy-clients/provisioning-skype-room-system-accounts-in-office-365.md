...
- El plan de Office 365 debe incluir Skype para Business Online Plan 2, 3 Plan, o Office 365 E1, E3 o E5.
...
- Para dar derecho a la sala con la capacidad de Enterprise Voice, por lo que se puede habilitar la sala con un número de teléfono, un Skype para profesionales Online Plan 2 con el complemento de PBX de la nube o E5 de Office 365 es necesaria (1).
...
Después de una sala de recurso se ha creado y habilitado tal y como se ha mostrado anteriormente cuenta de buzón de correo, y se ha obtenido una licencia de la cuenta para este Skype para profesionales de que la cuenta se sincronizará desde el bosque de Exchange Online a Skype para el bosque en línea de negocio mediante el uso de las ventanas Bosque de Active Directory de Azure. Los siguientes pasos son necesarios para aprovisionar la cuenta del sistema de salas de Skype en el Skype para un grupo de servidores en línea de negocio. Estos pasos son los mismos para una cuenta de buzón de recursos existente o una cuenta recién creada (confrm1 o confrm2), porque una vez que están habilitados en Exchange Online, ambas cuentas se sincronizarán con Skype para profesionales en línea de la misma manera:
...
Para obtener más información, vea [Using Windows PowerShell para administrar Lync Online](http://technet.microsoft.com/library/9ef2d853-10fb-4e02-a552-dcf6818d7153.aspx).
