...
### <a name="configure-operations-management-suite-to-collect-skype-room-systems-v2-event-logs"></a>Configurar el conjunto de aplicaciones de administración de operaciones para recopilar los registros de eventos de sistemas de salón de Skype v2
...
> [!IMPORTANT]
> Seleccione el registro de eventos **Del sistema de sala de Skype** y, a continuación, seleccione las casillas de verificación **Error**, **Advertencia**e **información** .
...
| Campo JSON                   | Campo personalizado OMS           | Nivel del        |
|:-----------------------------|:---------------------------|:----------------|
...
<a name="Alerts"></a> Dispositivo v2 de sistemas de salón de Skype un cuando detecta un problema, conjunto de aplicaciones de administración de operaciones de Microsoft pueden generar alertas para notificar a los administradores con los detalles del problema.
...
5.  Configuración de las alertas mediante el uso de la información siguiente:<br>
    ...
    **Asunto de correo electrónico:** Alerta de error de Hardware de salón de Skype sistemas v2<br>
...
Configurar una regla de alerta, que comprueba para sistemas de salón de Skype v2 dispositivos que han tenido problemas de aplicaciones dentro de la última hora.
...
4.  Configuración de las alertas mediante el uso de la información siguiente:<br>
    **Nombre de la regla:** Alerta de error de aplicación de salón de Skype sistemas v2<br>
    ...
    **Frecuencia de alerta:** 1 hora<br>
    **Número de resultados:** Mayor que 0<br>
    **Asunto de correo electrónico:** Alerta de error de aplicación de salón de Skype sistemas v2<br>
...
<a name="configure_all_devices"></a> Una vez configuradas los paneles y las alertas, puede instalar y configurar los agentes del conjunto de aplicaciones de administración de las operaciones en todos los dispositivos de v2 de sistemas de salón de Skype para completar la implementación de supervisión.
...
Si ya ha implementado los dispositivos de sistemas de salón de Skype v2 antes de implementar el conjunto de aplicaciones de administración de operaciones, puede utilizar la secuencia de comandos para instalar y configurar a los agentes mediante el uso de directivas de grupo de Active Directory.
