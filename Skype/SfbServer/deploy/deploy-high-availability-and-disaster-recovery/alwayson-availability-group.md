...
2. Validar la configuración del clúster.
   ...
   - En **Acciones** del lado derecho de la pantalla, haga clic **en Validar configuración.**
...
6. Use el Generador de topologías para crear el grupo de servidores front-end, como se explica en Crear y publicar nueva [topología en Skype Empresarial Server](../../deploy/install/create-and-publish-new-topology.md). Cuando lo haga, especifique el AG como el SQL almacén para el grupo.
...
7. Cree el grupo de disponibilidad.
   ...
   - En la **página Especificar réplicas,** haga clic en **la pestaña Réplicas.** A continuación, haga clic en el botón Agregar **réplicas** y conéctese a las demás instancias de SQL que ha unido como nodos del clúster de conmutación por error Windows servidor.
   ...
   - En  la página Seleccionar sincronización inicial de datos, seleccione Completo y especifique una carpeta accesible para las réplicas y que la cuenta de servicio de SQL Server usada por ambas réplicas tenga permisos de escritura para. A continuación, haga clic en **Siguiente**.
...
11. Cree un nuevo almacén que especifique el agente de escucha de AG y especifique la entidad de seguridad del reflejo antiguo como nodo principal del grupo de disponibilidad.
    ...
    - Abra el Generador de topologías. En la topología, expanda **Componentes compartidos,** haga clic con el botón secundario **en SQL Server Almacenes** y haga clic en Nuevo SQL Server **store**.
...
14. Realice algunos pasos finales para asegurarse de que los inicios de sesión SQL están en cada una de las réplicas del grupo de disponibilidad AlwaysOn.
    ...
    - Expanda Skype Empresarial Server, expanda la topología y expanda **SQL Server Stores**. Haga clic con el botón secundario en SQL almacén del nuevo AG y haga clic **en Editar propiedades**.
