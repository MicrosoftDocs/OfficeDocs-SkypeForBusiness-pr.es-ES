...
### <a name="create-an-external-dns-cname-record"></a><span data-ttu-id="f0767-147">Crear un registro CNAME de DNS externo</span><span class="sxs-lookup"><span data-stu-id="f0767-147">Create an external DNS CNAME record</span></span>
...
### <a name="create-an-internal-dns-a-record"></a><span data-ttu-id="f0767-158">Crear un registro A de DNS interno</span><span class="sxs-lookup"><span data-stu-id="f0767-158">Create an internal DNS A record</span></span>
...
9. <span data-ttu-id="f0767-169">Debe crear un nuevo registros de Autodiscover A o AAAA en la zona de búsqueda directa para cada dominio SIP compatibles con su Skype para el entorno de servidor empresarial.</span><span class="sxs-lookup"><span data-stu-id="f0767-169">You'll need to create a new Autodiscover A or AAAA records in the forward lookup zone for each SIP domain supported in your Skype for Business Server environment.</span></span> <span data-ttu-id="f0767-170">Para ello, repita los pasos 6 a 8 tantas veces como sea necesario.</span><span class="sxs-lookup"><span data-stu-id="f0767-170">To do this, repeat steps 6-8 as many times as needed.</span></span>
...
7. <span data-ttu-id="f0767-p123">También necesitará comprobar las entradas de **Nombres alternativos de firmante**. Encontrará uno o varios de lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="f0767-p123">You'll also need to check the **Subject Alternate Name** entries. You'll find one or more of the following:</span></span>
...
1. <span data-ttu-id="f0767-283">Abra la interfaz de proxy inverso.</span><span class="sxs-lookup"><span data-stu-id="f0767-283">Open your Reverse proxy interface.</span></span>
...
3. <span data-ttu-id="f0767-286">Generalmente necesitará especificar la información siguiente:</span><span class="sxs-lookup"><span data-stu-id="f0767-286">Typically, you will need to enter the following information:</span></span>
   ...
   - <span data-ttu-id="f0767-299">Habrá una opción de **ruta de acceso** y necesita escribir \*\* / \*\*\* aquí.</span><span class="sxs-lookup"><span data-stu-id="f0767-299">There will be a **Path** option, and you'll need to enter **/\\**\* here.</span></span>
...
3. <span data-ttu-id="f0767-313">Generalmente necesitará especificar la información siguiente:</span><span class="sxs-lookup"><span data-stu-id="f0767-313">Typically, you will need to enter the following information:</span></span>
...
1. <span data-ttu-id="f0767-340">Abra Skype para Shell de administración de servidor empresarial.</span><span class="sxs-lookup"><span data-stu-id="f0767-340">Open Skype for Business Server Management Shell.</span></span>
...
### <a name="test-conferencing-for-lync-2010-mobile-clients"></a><span data-ttu-id="f0767-361">Probar las conferencias para clientes móviles de Lync 2010</span><span class="sxs-lookup"><span data-stu-id="f0767-361">Test conferencing for Lync 2010 mobile clients</span></span>
...
### <a name="enable-push-notifications"></a><span data-ttu-id="f0767-391">Habilitar notificaciones de inserción</span><span class="sxs-lookup"><span data-stu-id="f0767-391">Enable push notifications</span></span>
...
<span data-ttu-id="f0767-410">Movilidad, llamada vía trabajo y VoIP y las características de vídeo están habilitadas de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="f0767-410">Mobility, Call via Work, and the VoIP and video features are all enabled by default.</span></span> <span data-ttu-id="f0767-411">Esta opción de requerir WiFi para VoIP y vídeo están deshabilitadas.</span><span class="sxs-lookup"><span data-stu-id="f0767-411">The setting to require WiFi for VoIP and video are disabled.</span></span> <span data-ttu-id="f0767-412">Un administrador tiene la capacidad para cambiar esto, globalmente, por sitio, o por usuario.</span><span class="sxs-lookup"><span data-stu-id="f0767-412">An Admin has the ability to change this, either globally, by site, or by user.</span></span>
  
<span data-ttu-id="f0767-413">Para poder usar las características de movilidad y llamada vía trabajo, los usuarios deben ser:</span><span class="sxs-lookup"><span data-stu-id="f0767-413">To be able to use Mobility features and Call via Work, users need to be:</span></span>
  
- <span data-ttu-id="f0767-414">Habilitado para Skype para Business Server</span><span class="sxs-lookup"><span data-stu-id="f0767-414">Enabled for Skype for Business Server</span></span>
    
- <span data-ttu-id="f0767-415">estar habilitados para telefonía IP empresarial;</span><span class="sxs-lookup"><span data-stu-id="f0767-415">Enabled for Enterprise Voice.</span></span>
    
- <span data-ttu-id="f0767-416">Asigna una directiva de movilidad que tiene la opción **enablemobility configurada** en **True**.</span><span class="sxs-lookup"><span data-stu-id="f0767-416">Assigned a Mobility policy that has the **EnableMobility** option set to **True**.</span></span>
    
<span data-ttu-id="f0767-417">Para que los usuarios puedan usar Vía trabajo, también deben:</span><span class="sxs-lookup"><span data-stu-id="f0767-417">For users to be able to use Call via Work, they'll also need to be:</span></span>
  
- <span data-ttu-id="f0767-418">tener asignada una directiva de voz que tenga la opción **Habilitar llamadas simultáneas** seleccionada;</span><span class="sxs-lookup"><span data-stu-id="f0767-418">Assigned a voice policy that has the **Enable simultaneous ringing of phones** option selected.</span></span>
    
- <span data-ttu-id="f0767-419">Asigna una directiva de movilidad que tiene la **enableoutsidevoice configurada** establecida en **True**.</span><span class="sxs-lookup"><span data-stu-id="f0767-419">Assigned a Mobility policy that has the **EnableOutsideVoice** set to **True**.</span></span>
    
> [!NOTE]
> <span data-ttu-id="f0767-p150">Los usuarios que no están habilitados para la telefonía IP empresarial pueden usar sus dispositivos móviles para realizar llamadas VoIP entre usuarios de Skype o pueden unirse a conferencias mediante el uso del vínculo Hacer clic para unirse mientras estén en sus dispositivos móviles, siempre y cuando estén configuradas las opciones apropiadas para la directiva de voz con la que están asociados. En el tema PLANIFICACIÓN encontrará más detalles.</span><span class="sxs-lookup"><span data-stu-id="f0767-p150">Users who aren't enabled for Enterprise Voice can use their mobile devices to make Skype to Skype VoIP calls or can join conferences by using the Click to Join link while on their mobile devices, if the appropriate options are set for the Voice policy they're associated with. There's more detail in the PLANNING topic.</span></span> 
  
### <a name="modify-global-mobility-policy"></a><span data-ttu-id="f0767-422">Modificar la directiva de movilidad global</span><span class="sxs-lookup"><span data-stu-id="f0767-422">Modify global Mobility policy</span></span>

1. <span data-ttu-id="f0767-423">Inicie sesión con una cuenta que sea miembro del rol **CsAdministrator** , en un equipo que tenga instalado **Skype para Shell de administración de servidor empresarial** y **Ocscore** .</span><span class="sxs-lookup"><span data-stu-id="f0767-423">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="f0767-424">Inicie el **Skype para Shell de administración de servidor empresarial**.</span><span class="sxs-lookup"><span data-stu-id="f0767-424">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="f0767-425">Desactivar el acceso a la movilidad y vía trabajo globalmente escribiendo:</span><span class="sxs-lookup"><span data-stu-id="f0767-425">Turn off access to Mobility and Call via Work globally by typing:</span></span>
   ...
   ```
    ...
    > [!NOTE]
    > <span data-ttu-id="f0767-426">Puede desactivar llamada vía trabajo sin desactivar el acceso a la movilidad.</span><span class="sxs-lookup"><span data-stu-id="f0767-426">You can turn off Call via Work without turning off access to Mobility.</span></span> <span data-ttu-id="f0767-427">Pero no se puede desactivar la movilidad sin desactivar también llamada vía trabajo.</span><span class="sxs-lookup"><span data-stu-id="f0767-427">But you can't turn off Mobility without also turning off Call via Work.</span></span> 
  
    <span data-ttu-id="f0767-428">Para obtener más información, consulte [Set-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/set-csmobilitypolicy?view=skype-ps).</span><span class="sxs-lookup"><span data-stu-id="f0767-428">For more info, check out [Set-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/set-csmobilitypolicy?view=skype-ps).</span></span>
    
### <a name="modify-mobility-policy-by-site"></a><span data-ttu-id="f0767-429">Modificar la directiva de movilidad por sitio</span><span class="sxs-lookup"><span data-stu-id="f0767-429">Modify Mobility policy by site</span></span>

1. <span data-ttu-id="f0767-430">Inicie sesión con una cuenta que sea miembro del rol **CsAdministrator** , en un equipo que tenga instalado **Skype para Shell de administración de servidor empresarial** y **Ocscore** .</span><span class="sxs-lookup"><span data-stu-id="f0767-430">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="f0767-431">Inicie el **Skype para Shell de administración de servidor empresarial**.</span><span class="sxs-lookup"><span data-stu-id="f0767-431">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="f0767-p152">Puede crear una directiva de nivel de sitio, desactivar VoIP y vídeo, habilitar Requerir WiFi para audio IP, y Requerir WiFi para vídeo IP por sitio. Escriba:</span><span class="sxs-lookup"><span data-stu-id="f0767-p152">You can create a site-level policy, turn off VoIP and video, enable Require WiFi for IP Audio, and Require WiFi for IP Video by site. Type:</span></span>
    
   ```
   New-CsMobilityPolicy -Identity site:<site identifier> -EnableIPAudioVideo $false -RequireWiFiForIPAudio $True -RequireWiFiforIPVideo $True
   ```

    <span data-ttu-id="f0767-434">Más información en [New-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/new-csmobilitypolicy?view=skype-ps).</span><span class="sxs-lookup"><span data-stu-id="f0767-434">Learn more at [New-CsMobilityPolicy](https://docs.microsoft.com/powershell/module/skype/new-csmobilitypolicy?view=skype-ps).</span></span>
    
### <a name="modify-mobility-policy-by-user"></a><span data-ttu-id="f0767-435">Modificar la directiva de movilidad por usuario</span><span class="sxs-lookup"><span data-stu-id="f0767-435">Modify Mobility policy by user</span></span>

1. <span data-ttu-id="f0767-436">Inicie sesión con una cuenta que sea miembro del rol **CsAdministrator** , en un equipo que tenga instalado **Skype para Shell de administración de servidor empresarial** y **Ocscore** .</span><span class="sxs-lookup"><span data-stu-id="f0767-436">Log on, with an account that's a member of the **CsAdministrator** role, to a computer where **Skype for Business Server Management Shell** and **Ocscore** are installed.</span></span>
    
2. <span data-ttu-id="f0767-437">Inicie el **Skype para Shell de administración de servidor empresarial**.</span><span class="sxs-lookup"><span data-stu-id="f0767-437">Start the **Skype for Business Server Management Shell**.</span></span>
    
3. <span data-ttu-id="f0767-438">Crear directivas de movilidad de nivel de usuario y desactivar la movilidad y llamada vía trabajo por usuario.</span><span class="sxs-lookup"><span data-stu-id="f0767-438">Create user level Mobility policies and turn off Mobility and Call via Work by user.</span></span> <span data-ttu-id="f0767-439">Escriba:</span><span class="sxs-lookup"><span data-stu-id="f0767-439">Type:</span></span>
   ...
   ```
    ...
    <span data-ttu-id="f0767-440">Otro ejemplo con datos de muestra:</span><span class="sxs-lookup"><span data-stu-id="f0767-440">A further example with sample data:</span></span>
   ...
   ```
    ...
    > [!NOTE]
    > <span data-ttu-id="f0767-441">Puede desactivar llamada vía trabajo sin desactivar el acceso a la movilidad.</span><span class="sxs-lookup"><span data-stu-id="f0767-441">You can turn off Call via Work without turning off access to Mobility.</span></span> <span data-ttu-id="f0767-442">Pero no se puede desactivar la movilidad sin desactivar también llamada vía trabajo.</span><span class="sxs-lookup"><span data-stu-id="f0767-442">But you can't turn off Mobility without also turning off Call via Work.</span></span> 
