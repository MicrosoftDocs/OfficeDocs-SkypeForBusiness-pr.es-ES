...
Antes de comenzar la migración de los usuarios a Skype para profesionales en línea, debe hacer la copia de seguridad los datos de usuario asociados con las cuentas que se va a mover. No todos los datos de usuario se mueve con la cuenta de usuario. Para obtener información, vea [requisitos de restauración y copia de seguridad: datos](http://technet.microsoft.com/library/ecfb8e4d-cb4f-476d-9772-4486bd683c04.aspx).
