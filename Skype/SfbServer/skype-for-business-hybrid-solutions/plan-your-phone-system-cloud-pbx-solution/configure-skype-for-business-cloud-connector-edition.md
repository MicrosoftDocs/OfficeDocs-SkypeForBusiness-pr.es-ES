...
|[Configurar la integración de Cloud Connector con la organización de Microsoft 365 u Office 365](configure-cloud-connector-integration-with-your-office-365-tenant.md) <br/> |Agregue registros DNS, configure una implementación híbrida, configure puertas de enlace RTC y habilite a los usuarios para el correo de voz del sistema telefónico.  <br/> |
...
|[Modificar la configuración de una implementación de Cloud Connector existente](modify-the-configuration-of-an-existing-cloud-connector-deployment.md) <br/> |Cambie la configuración en Cloud Connector después de que ya se haya implementado.  <br/> |
...
|[Referencia de cmdlets de Cloud Connector](cloud-connector-cmdlet-reference.md) <br/> |Obtenga información sobre los cmdlets de PowerShell que se usan en Cloud Connector.  <br/> |
