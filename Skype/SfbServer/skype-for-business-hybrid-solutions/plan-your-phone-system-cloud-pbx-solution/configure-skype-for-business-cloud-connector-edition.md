...
|[Modify the configuration of an existing Cloud Connector deployment](modify-the-configuration-of-an-existing-cloud-connector-deployment.md) <br/> |Cambiar la configuración en la nube Connector después de que ya está implementado.  <br/> |
