...
- [El tráfico de medios: intervalos de direcciones IP y puerto](#media-traffic-ip-addresses-and-port-ranges)
- [SBCs compatibles](#supported-session-border-controllers-sbcs)

Para obtener información detallada acerca de cómo configurar el enrutamiento directo, vea [Configurar el enrutamiento directo](configure-direct-routing.md).
...
|contoso.onmicrosoft.com|No|**Nombre no válido:**<br/>sbc1.Europe.contoso.com (requiere registrar europe.contoso.com de nombre de dominio en "Dominios" en primer lugar)
|
...
[Configurar el enrutamiento directo](configure-direct-routing.md)
