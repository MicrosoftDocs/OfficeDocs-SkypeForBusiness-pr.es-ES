...
Si está buscando requisitos de entorno, como Active Directory, DNS o certificados, puede consultar los requisitos de entorno para Skype Empresarial Server [2015](environmental-requirements.md).
...
|:-----|:-----|
|CPU   |Procesador dual de 64 bits, hex-core, 2,26 gigahercios (GHz) o superior.  <br/> Los procesadores Intel Itanium no son compatibles Skype Empresarial Server roles de 2015.   |
...
|Componente de hardware|Recomendado|
|:-----|:-----|
|CPU   |Procesador dual de 64 bits, cuatro núcleos, 2,26 gigahercios (GHz) o superior.  <br/> Los procesadores Intel Itanium no son compatibles Skype Empresarial Server roles de 2015.   |
...
|&nbsp;|&nbsp;|
|:-----|:-----|
|Windows Server 2019 (necesita una Skype Empresarial acumulativa 9 o posterior).  |Windows Server 2016 (necesita una Skype Empresarial acumulativa 5 o posterior. Para obtener más información, [consulte KB4015888](https://support.microsoft.com/help/4015888/how-to-install-skype-for-business-server-2015-on-windows-server-2016))   |
|Windows Server 2012 sistema operativo de centro de datos R2 con todas las actualizaciones necesarias instaladas.   |Windows Server 2012 sistema operativo estándar R2 con todas las actualizaciones necesarias instaladas.   |
|Windows Server 2012 Datacenter sistema operativo con todas las actualizaciones necesarias instaladas.   |Windows Server 2012 Standard sistema operativo con todas las actualizaciones necesarias instaladas.   |
...
- Por Windows Server 2012, el artículo de KB 2858668 debe instalarse antes de una actualización. [Consébalo aquí](https://support.microsoft.com/kb/2858668/).
...
|&nbsp;|&nbsp;|&nbsp;|&nbsp;|&nbsp;|
|:-----|:-----|:-----|:-----|:-----|
|Microsoft SQL Server 2019 Enterprise (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.  |Microsoft SQL Server 2017 Enterprise (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.  |Microsoft SQL Server 2016 Enterprise (edición de 64 bits) con Service Pack 1 o posterior, y debe ejecutar con una actualización acumulativa 7 o posterior de Skype Empresarial (descarga Skype Empresarial [actualización](https://support.microsoft.com/help/3061064) acumulativa).   |Microsoft SQL Server 2014 Enterprise (edición de 64 bits) y debe ejecutar con la actualización acumulativa 6 o posterior (descargar la actualización acumulativa [6](https://support.microsoft.com/kb/3031047/)).   |Microsoft SQL Server 2012 Enterprise (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.   |
|Microsoft SQL Server 2019 Standard (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.  |Microsoft SQL Server 2017 Standard (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.  |Microsoft SQL Server 2016 Standard (edición de 64 bits) con Service Pack 1 o posterior Skype Empresarial, y debe ejecutar con una actualización acumulativa 7 o posterior (descarga [Skype Empresarial actualización](https://support.microsoft.com/help/3061064) acumulativa).   |Microsoft SQL Server 2014 Standard (edición de 64 bits) y debe ejecutar con la actualización acumulativa 6 o posterior (descargar la actualización acumulativa [6](https://support.microsoft.com/kb/3031047/)).   |Microsoft SQL Server 2012 Standard (edición de 64 bits) y se recomienda ejecutar con el service pack más reciente.   |
...
Deberá configurar la infraestructura para el almacenamiento de archivado. Esto incluye elegir entre el almacenamiento Exchange o el almacenamiento de archivado mediante SQL Server.   Skype Empresarial Server de infraestructura de archivado son los mismos que para la implementación de Skype Empresarial Server. Para obtener más información, consulte [Requisitos para el Skype Empresarial de usuario](../../plan-your-deployment/requirements-for-your-environment/requirements-for-your-environment.md). 
...
Puede usar la creación SQL creación SQL creación de SQL con Skype Empresarial Server 2015, que es compatible. SQL creación de reflejos se configura a través del Generador Skype Empresarial Server topología. Si tiene la intención de configurar SQL clustering, se realiza en SQL Server.
