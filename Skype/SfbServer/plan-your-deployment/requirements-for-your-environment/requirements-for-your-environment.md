...
[Los requisitos del servidor Skype Empresarial Server 2015](server-requirements.md) son las cosas que necesita para prepararse en los servidores individuales que desea usar en la implementación.
