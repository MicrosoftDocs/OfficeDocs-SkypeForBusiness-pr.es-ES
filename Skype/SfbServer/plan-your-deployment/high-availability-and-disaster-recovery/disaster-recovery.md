...
El almacén de administración central contiene datos de configuración sobre los servidores y servicios de la implementación. Cada implementación de Skype Empresarial Server incluye un almacén de administración central, hospedado por el servidor back-end de un grupo de servidores front-end.
