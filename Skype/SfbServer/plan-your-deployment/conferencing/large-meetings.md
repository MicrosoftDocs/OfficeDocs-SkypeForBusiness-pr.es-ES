...
> [!NOTE]
> Este tema se centra en los procedimientos recomendados para reuniones grandes compatibles con Skype Empresarial Server. Si su organización necesita capacidades de reunión más grandes, considere la posibilidad de implementar un entorno híbrido que aproveche las ventajas de Difusión de reunión de Skype, un nuevo servicio en línea que forma parte de Microsoft 365 y Office 365. 

> [!NOTE]
> Difusión de reunión de Skype permite a los usuarios hospedar y difundir reuniones a grandes audiencias en línea de hasta 10 000 participantes. El uso de Difusión de reunión de Skype requiere que Skype Empresarial Server ya esté configurado en una configuración híbrida con una organización de producción de Microsoft 365 u Office 365. Todos los usuarios deben tener un inquilino en línea establecido como requisito previo. If you are interested in deploying a hybrid solution that can take advantage of Skype Meeting Broadcast, see [What is a Skype Meeting Broadcast?](https://go.microsoft.com/fwlink/?LinkId=617071) and Configure your [on-premises deployment for Skype Meeting Broadcast](../../deploy/configure-skype-meeting-broadcast.md). 
...
Si su organización necesita reuniones con más de 250 participantes, debe planear un grupo dedicado para admitir la carga. 
  
Para tener suficientes recursos de CPU y memoria para reuniones de hasta 1000 usuarios, los servidores front-end de hospedaje no deben hospedar ninguna otra carga de trabajo de mensajería instantánea (MI) y presencia o Telefonía IP empresarial de trabajo. Los servidores tampoco deben hospedar otras reuniones, independientemente del tamaño de las otras reuniones. Para hospedar reuniones de hasta 1000 usuarios, debe configurar un grupo independiente de Skype Empresarial Server dedicado a hospedar reuniones grandes.
  
Un grupo de Skype Empresarial Server dedicado a hospedar reuniones grandes debe hospedar una sola reunión de hasta 1000 usuarios al mismo tiempo, por lo que las horas de reunión deben reservarse por adelantado a través de un proceso de programación fuera de banda para garantizar la compatibilidad dedicada de los servidores front-end. Para admitir más de una reunión grande al mismo tiempo, debe configurar varios grupos de reuniones grandes dedicados.
  
Para obtener más información sobre los requisitos de hardware y software, y la planeación de una topología compatible con reuniones grandes, consulte Requisitos de hardware y software para conferencias en Skype Empresarial [Server](hardware-and-software-requirements.md) y Planear la topología de conferencia para Skype [Empresarial Server.](conferencing-topology.md)
...
Para minimizar el tráfico de comunicaciones en tiempo real en el grupo de reuniones grandes, Microsoft no recomienda hospedar usuarios que inician sesión con regularidad con clientes de Skype Empresarial y participan en sesiones de mensajería instantánea (MI), presencia, conferencias y voz. En su lugar, realice una de las siguientes acciones:
...
Con varios cientos o miles de usuarios en una reunión, es una buena práctica que una persona dedicada modere la sesión en línea de una reunión grande. Esta persona dedicada puede ser un delegado del organizador de la reunión o un miembro del personal de soporte técnico para reuniones grandes de la organización. Es importante que, en el momento de programar la reunión, agregue como moderador al encargado dedicado a moderar la reunión, aunque puede promocionar a un asistente a la reunión en línea al rol de moderador mientras la reunión se está celebrando.
  
El moderador de la reunión puede usar todas las funcionalidades de moderador de los clientes de Skype Empresarial para administrar la reunión grande. Estas funcionalidades incluyen:
...
Dado que solo se admite una reunión grande a la vez en el grupo de reuniones grande dedicado, debe implementar un proceso de programación de reuniones grandes para facilitar la configuración de reuniones grandes y ayudar a evitar conflictos. Esta funcionalidad no la proporcionan directamente los clientes de Skype Empresarial Server o Skype Empresarial. Una forma de implementar este proceso es usar el sistema de vales del equipo de soporte técnico de su organización, si está disponible.
...
- El organizador o delegado de la reunión usa Outlook para programar la próxima reunión, agregando la dirección URL para unirse a la reunión a la invitación a la reunión. Después, el organizador de la reunión o el delegado especificará los usuarios que desea invitar y les enviará la invitación.
...
- Compruebe la **configuración de vídeo bloquear a los asistentes** para asegurarse de que solo los presentadores pueden difundir vídeo en la reunión.
...
> [!NOTE]
> La compatibilidad con reuniones grandes en Skype Empresarial Server requiere que la configuración **AllowLargeMeetings** esté establecida en true. Cuando esta configuración se establece en true, la experiencia de Skype Empresarial se optimizará para reuniones de gran tamaño cuando los usuarios se unan a la reunión. Específicamente, en una reunión grande, Skype Empresarial no mostrará la inicial o la actualización de la lista completa de participantes de la reunión, que es un cuello de botella de rendimiento tanto para el cliente como para Skype Empresarial Server. En su lugar, Skype Empresarial solo mostrará información sobre el usuario y la lista de presentadores de la reunión. Skype Empresarial seguirá muestrando el número total de participantes disponibles en las reuniones grandes.
...
- Deshabilita el vídeo de varios usuarios.
...
- Deshabilita la capacidad de desenmudizar asistentes individuales.

- Deshabilita la capacidad de aplicar la característica Bloquear contenido destacado de vídeo a los asistentes.

- Los usuarios de marcado RTC no podrán desenmudarse usando 6 porque falta asistencia virtual personal responsable de los comandos DTMF en reuniones grandes activas.

- Si el moderador o el organizador programa una reunión en la que todos los usuarios deben silenciarse primero ("Silenciar todo"), los usuarios de RTC se silenciarán durante toda la llamada y no podrán desactivar el audio por sí mismos.
...
Además, debe configurar el grupo de reuniones grandes dedicado para que cada usuario de Skype Empresarial Server que se encuentra en el grupo de servidores y responsable de administrar la programación de la reunión tenga los permisos adecuados. Para ello, siga estos pasos:
...
Para obtener más información acerca de la creación de una directiva de conferencia, vea Administrar directivas de conferencia [en Skype Empresarial Server.](../../manage/conferencing/conferencing-policies.md)
