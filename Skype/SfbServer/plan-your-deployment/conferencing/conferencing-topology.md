...
- El equilibrio de carga de los servidores front-end requiere equilibrio de carga de hardware para el tráfico HTTP (como la descarga de contenido de reuniones). El equilibrio de carga de DNS se recomienda para el tráfico SIP. Para obtener más información, vea [Requisitos de equilibrio de carga Skype Empresarial](../../plan-your-deployment/network-requirements/load-balancing.md). 
