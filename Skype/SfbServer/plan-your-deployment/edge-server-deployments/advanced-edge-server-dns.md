...
- [Tutorial de Skype Empresarial clientes que localizan servicios](../../plan-your-deployment/network-requirements/advanced-edge-server-dns.md#WalkthroughOfSkype)
...
- [Equilibrio de carga DNS](../../plan-your-deployment/network-requirements/advanced-edge-server-dns.md#DNSLB)
