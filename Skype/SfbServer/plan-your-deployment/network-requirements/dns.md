...
En este artículo sólo direcciones DNS planeación de Skype para las implementaciones de Business Server en la red de la organización local. Para Skype para profesionales Online consulte "IP y URL de Office 365 intervalos de direcciones" en [http://aka.ms/o365ips](http://aka.ms/o365ips). 
...
|A O AAAA  <br/> |lyncdiscoverinternal. _\<sipdomain\>_ <br/> lyncdiscoverinternal. * <span> </span>contoso<span></span>.com*  <br/> |Grupo de servidores Front-End de HLB VIP o IP de Director  <br/>  192.168.21.121 <br/> |AutoDiscover Service1 interno, necesario para la movilidad. Si se utiliza DNS interno para resolver para dispositivos móviles, deben apuntar a la dirección IP externa o DMZ VIP.  <br/> Para los servicios Web necesitamos HLB en el grupo de servidores Front-End como HTTPS no puede sacar provecho de DNS. Para el grupo de servidores Front-End o grupo de servidores de Director que esto debe se resuelve en un HLB VIP o una IP regular para un servidor Standard edition o un servidor Director independiente.  <br/> |Y  <br/> |
|CNAME  <br/> |lyncdiscoverinternal. _\<sipdomain\>_ <br/> lyncdiscoverinternal. *<span></span>Contoso<span></span>.com*  <br/> |FQDN del grupo HLB FE o el FQDN del Director  <br/> Web-int.<span></span>contoso<span></span>.com  <br/> |Service1 de detección automática interna <br/> Puede implementar como un CNAME en lugar de un registro si así lo desea.  <br/> ||
|A O AAAA  <br/> |sip. _\<sipdomain\>_ <br/> sip. _<span></span>Contoso<span></span>.com_ <br/> |Servidor front-end de dirección IP del servidor (dirección o a un cada IP de Director direcciones)  <br/>  Libras de DNS para *192.168.21.122 192.168.21.123 192.168.21.124*  <br/> |Es necesario para la configuración automática, vea el [Tutorial de Skype para los clientes empresariales de ubicación de servicios](../../plan-your-deployment/edge-server-deployments/advanced-edge-server-dns.md#WalkthroughOfSkype) <br/> Un registro o registros que señala a los servidores del grupo de servidores Front-End o servidores de Director en la red interna o el servicio de servidor perimetral de acceso cuando el cliente es externo  <br/> |2 <br/> |
|A O AAAA  <br/> |UCUpdates-r2. _\<sipdomain\>_ <br/> UCUpdates-r2. _<span></span>Contoso<span></span>.com_ <br/> |IP de servidor SE/Director o grupo de servidores de FE de HLB VIP o Director del grupo HLB VIP  <br/>  192.168.21.121 <br/> |Implementación de este registro es opcional 3 <br/> ||
|SRV  <br/> |_sipinternaltls._tcp. _ \<sipdomain\> _ Puerto 5061 <br/> _sipinternaltls._tcp. _ <span> </span>contoso<span></span>.com_ Puerto 5061 <br/> |Servidor front-end FQDN  <br/>  _FE-Pool. <span> </span>contoso<span></span>.com_ <br/> |Permite el usuario interno de sesión automático 1 para el servidor o grupo de servidores Front-End o ingeniero o grupo de servidores que se autentica y redirige las solicitudes de inicio de sesión de clientes. <br/> |2 <br/> |
|SRV  <br/> |_sipinternal. _\<sipdomain\>_ <br/> _sipinternal. _<span></span>Contoso<span></span>.com_ <br/> |Servidor front-end FQDN  <br/>  _FE-Pool. <span> </span>contoso<span></span>.com_ <br/> |Acceso de usuarios internos 1 <br/> |2 <br/> |
|SRV  <br/> |_ntp._udp. _\<sipdomain\>_ <br/> _ntp._udp. _<span></span>Contoso<span></span>.com_ <br/> |Servidores horarios FQDN  <br/> america.pool.ntp.org del Norte  <br/> |Origen NTP requerido para dispositivos de Lync Phone Edition  <br/> |Este proceso es necesario para admitir los auriculares de escritorio.  <br/> |
|SRV  <br/> |_sipfederationtls._tcp.  _\<sipdomain\>_ <br/> _sipfederationtls._tcp.  _<span></span>Contoso<span></span>.com_ <br/> | Servicio perimetral de acceso FQDN <br/> EdgePool-int. _ <span> </span>contoso<span></span>.com_ <br/> |Crear un registro SRV para cada dominio SIP que tiene IOS o Windows phone clientes móviles.  <br/> |Para compatibilidad con clientes móviles  <br/> |
|A O AAAA  <br/> |dirección URL de administración  <br/>  _Web-int.<span></span>contoso<span></span>.com_ <br/> |Grupo de servidores de FE de HLB VIP  <br/> 192.168.21.121  <br/> |Skype para el Panel de Control de servidor empresarial, vea [Direcciones URL sencillas](dns.md#BK_Simple) <br/> ||
|A O AAAA  <br/> |cumple con la dirección URL  <br/>  _Web-int.<span></span>contoso<span></span>.com_ <br/> |Grupo de servidores de FE de HLB VIP  <br/> 192.168.21.121  <br/> |Reuniones en línea, vea [Direcciones URL sencillas](dns.md#BK_Simple) <br/> ||
|A O AAAA  <br/> |dirección URL de acceso telefónico  <br/>  _Web-int.<span></span>contoso<span></span>.com_ <br/> |Grupo de servidores de FE de HLB VIP  <br/> 192.168.21.121  <br/> |Conferencia de acceso telefónico, vea [Direcciones URL sencillas](dns.md#BK_Simple) <br/> ||
|A O AAAA  <br/> |FQDN de servicios Web interno  <br/>  _Web-int.<span></span>contoso<span></span>.com_ <br/> |Grupo de servidores de FE de HLB VIP  <br/> 192.168.21.121  <br/> |Skype para servicio Web de negocio utilizados por Skype para la aplicación empresarial de Web  <br/> ||
|A O AAAA  <br/> |FQDN del grupo de Office Web Apps Server  <br/> OWA. <span> </span>contoso<span></span>.com  <br/> | Grupo de servidores de Office Web Apps Server dirección VIP <br/> 192.168.1.5  <br/> |Define el FQDN del grupo de Office Web Apps Server  <br/> ||
|A O AAAA  <br/> | El FQDN Web interno <br/> Web-int.<span></span>contoso<span></span>.com  <br/> | Servidor front-end dirección VIP <br/> 192.168.21.121  <br/> |Define el FQDN Web interno utilizado por Skype para la aplicación empresarial de Web  <br/> Si se usa en este grupo de servidores de equilibrio de carga DNS, su grupo de servidores Front-End y de la granja de servidores web interno no pueden tener el mismo FQDN.  <br/> ||
...
Si planea tener unos usuarios hospedados en línea y algunos entornos hospedados en, consulte la conectividad híbrida artículos sobre la planeación de [Skype para Business Server 2015](../../skype-for-business-hybrid-solutions/plan-hybrid-connectivity.md#BKMK_DNS) y [Skype para Business server 2019](../../../SfBServer2019/hybrid/hybrid-solutions.md). Debe configurar DNS como normal de Skype para Business Server 2015 y también agregar registros DNS adicionales. 
...
|:-----|:-----|
|Un servidor:  <br/> Persistent Chat, Director, servidor de mediación, servidor front-end  <br/> |Un registro A interno que resuelve el nombre de dominio completo (FQDN) del servidor en su dirección IP.  <br/> ServerRole. <span> </span>contoso<span></span>.com 10.10.10.0  <br/> |
