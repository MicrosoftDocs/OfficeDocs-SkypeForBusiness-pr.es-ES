...
|&nbsp;|&nbsp;|&nbsp;|
|:-----|:-----|:-----|
|Director o grupo de directores   |Servidor de mediación independiente o grupo de servidores de mediación   |Servidor Office Web Apps   |
|Servidor perimetral o grupo perimetral   |Servidor de chat persistente o grupo de servidores de chat persistente   |Supervisión   |
...
|&nbsp;|&nbsp;|
|:-----|:-----|
|Servidor de mediación independiente o grupo de servidores de mediación   |Servidor perimetral o grupo perimetral   |
|Servidor de chat persistente o grupo de servidores de chat persistente   |Supervisión   |
...
|&nbsp;|&nbsp;|&nbsp;|&nbsp;|
|:-----|:-----|:-----|:-----|
|Firewalls   |Puertas de enlace RTC (si implementa Telefonía IP empresarial   |Servidor de mensajería unificada de Exchange (si desea integrarse con la mensajería unificada de Exchange)   |Equilibrio de carga de DNS   |
