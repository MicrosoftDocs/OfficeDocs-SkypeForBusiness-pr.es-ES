...
ms.locfileid: "34277597"
---
# <a name="user-models-in-skype-for-business-server"></a>Modelos de usuario en Skype empresarial Server
 
Los modelos de usuario descritos aquí proporcionan la base de las medidas de planeación de capacidad y las recomendaciones descritas en [planear la capacidad de uso del modelo de usuario para Skype empresarial Server](user-model.md).
  
## <a name="skype-for-business-server-user-models"></a>Modelos de usuario de Skype empresarial Server

En la siguiente tabla se describe el modelo de usuario para registro, contactos, mensajería instantánea (mi) y presencia de Skype empresarial Server.
...
|Porcentaje de usuarios de Active Directory  <br/> |Damos por hecho que el 70% de todos los usuarios de Active Directory de la organización está habilitado para Skype empresarial Server. 80% de los usuarios habilitados han iniciado sesión en Skype empresarial Server cada día (80% de simultaneidad). Los usuarios simultáneos constituyen la base de los cálculos para el resto de esta sección.  <br/> |
|Cambios de Active Directory  <br/> |Por semana, damos por hecho que el 0,5% del total de usuarios se ha creado y habilitado para Skype empresarial en Active Directory, y que el 0,5% del total de usuarios está deshabilitado de Active Directory y de Skype para empresas cada semana. el 5% de los usuarios tiene al menos un atributo de Active Directory cambiado cada semana.  <br/> |
|Grupos de distribución de Active Directory  <br/> |Damos por hecho que el número de grupos de distribución de Active Directory en la organización es igual a tres veces el número de todos los usuarios de Active Directory. Los grupos de distribución tienen los tamaños siguientes:  <br/> • 64% tiene 2-30 usuarios  <br/> • el 13% tiene 31-50 usuarios  <br/> • el 10% tiene 51-100 usuarios  <br/> • el 13% tiene 101-500 usuarios  <br/> |
|Usuarios de voz sobre IP (VoIP)  <br/> |60% de los usuarios de Skype empresarial Server están habilitados para las comunicaciones unificadas (es decir, los números de teléfono son propiedad de Skype empresarial Server).  <br/> |
|Distribución de clientes registrados  <br/> |65% de los clientes ejecutan el software de Skype para empresas, incluidos Skype empresarial y Lync Phone Edition.  <br/> 30% de los clientes que ejecutan software cliente de una versión anterior de Lync.  <br/> 5% de clientes que usan la aplicación Web de Skype empresarial.  <br/> Si la movilidad está habilitada, se supone que el 40 % de los usuarios está usando la movilidad al mismo tiempo que las otras opciones de cliente registradas mencionadas anteriormente. En este caso, la relación de varios puntos de presencia (MPOP) del cliente es de 1:1,9. Si la movilidad está deshabilitada, la relación de MPOP será de 1:1,5.  <br/> |
|Distribución de usuarios remotos  <br/> |El 70 % de los usuarios se conecta internamente.  <br/> el 30% de los usuarios se conectan a través de un servidor perimetral (también puede tener un director aquí, pero no es obligatorio).  <br/> |
|Distribución de contactos  <br/> |El número máximo de contactos que tiene un usuario es de 1.000. Menos del 1 % de los usuarios tiene 1.000 contactos. Menos del 25 % de los usuarios tiene 100 o más contactos.  <br/> Una media de 80 contactos para los usuarios con conectividad en la nube pública. De estos usuarios:  <br/> • el 50% de los contactos está dentro de la organización. El 10 % de estos usuarios corresponde a usuarios remotos que se conectan desde fuera del firewall.  <br/> • 40% de los contactos son usuarios de Skype.  <br/> • el 10% de los contactos es de socios federados.  <br/> Una media de 50 contactos para los usuarios sin conectividad en la nube pública. De estos usuarios:  <br/> • el 80% de los contactos está dentro de la organización. El 10 % de estos usuarios corresponde a usuarios remotos que se conectan desde fuera del firewall.  <br/> • el 20% de los contactos es de socios federados.  <br/> Cada usuario tiene un grupo de distribución en su lista de contactos. Para las pruebas de rendimiento, se supone que los grupos de distribución son siempre expandidos.  <br/> |
...
|Distribución de clientes de conferencia  <br/> |Para reuniones programadas:  <br/> • 65% de los usuarios de la Conferencia usan Skype empresarial 2016.  <br/> • el 5% de los usuarios de la Conferencia usan la aplicación Web de Skype empresarial.  <br/> • el 30% de los usuarios de las conferencias usa clientes anteriores, entre los que se incluyen Lync 2013 y Microsoft Lync 2010.  <br/> Para reuniones no programadas:  <br/> • 70% de los usuarios de la Conferencia usan Skype empresarial.  <br/> • el 30% de los usuarios de las conferencias usa clientes anteriores, entre los que se incluyen Lync 2013 y Microsoft Lync 2010.  <br/> |
...
En los grupos de aplicaciones frontales normales, Skype empresarial Server tiene un tamaño máximo de reunión admitido para los usuarios de 250. Cada grupo puede hospedar una reunión de 250 usuarios de forma simultánea. Mientras se produce una reunión de gran tamaño, el grupo también puede hospedar otras conferencias más pequeñas. Además, se admiten reuniones de hasta 1000 usuarios si se configura un grupo dedicado para hospedar estas reuniones. Para obtener más información, vea [planear reuniones grandes en Skype empresarial Server](../../plan-your-deployment/conferencing/large-meetings.md).
...
- el 60% de los usuarios están habilitados para telefonía IP empresarial y 60% de estos usuarios están habilitados para las llamadas RTC.
