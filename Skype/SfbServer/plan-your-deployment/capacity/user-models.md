...
Los modelos de usuario que se describen aquí proporcionan la base para las medidas y recomendaciones de planeación de capacidad descritas en Planeación de capacidad de uso del modelo de usuario [para Skype Empresarial Server.](user-model.md)
