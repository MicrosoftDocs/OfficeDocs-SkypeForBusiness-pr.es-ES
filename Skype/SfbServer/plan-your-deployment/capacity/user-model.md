...
|:-----|:-----|
|CPU  <br/> |Procesador dual de 64 bits, hex-core, 2,26 gigahercios (GHz) o superior.  <br/> Los procesadores Intel Itanium no son compatibles con Skype Empresarial Server de servidor.  <br/> |
