...
> [!NOTE]
> Skype Empresarial dispositivos analógicos conectados no pueden recibir información de ubicación del servicio de información de ubicación ni transmitir la ubicación al proveedor de servicios E9-1-1.
...
Desde una Skype Empresarial Server, el proceso E9-1-1 se puede separar en dos fases:
...
En el siguiente diagrama se muestra cómo se enruta una llamada de emergencia Skype Empresarial Server al PSAP cuando se usa una puerta de enlace ELIN.
