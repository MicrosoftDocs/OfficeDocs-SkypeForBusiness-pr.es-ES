...
Obtenga más información sobre el control de admisión de llamadas, que puede impedir que se realicen llamadas si tienen una mala calidad de los medios en Skype empresarial Server Enterprise Voice.
...
Los administradores definen las directivas de CAC, que se aplican mediante el servicio de directivas de ancho de banda instalado con cada grupo de servidores front-end. La configuración de CAC se propaga automáticamente a todos los servidores front-end de Skype empresarial Server de su red.
...
El control de admisión de llamadas es obligatorio en el servidor de mediación, independientemente de si está conectado a un IP/PBX, una puerta de enlace RTC o un tronco de SIP. Debido a que el servidor de mediación es un agente de usuario inverso (B2BUA), finaliza los medios. Tiene dos lados de conexión: un lado que está conectado a Skype empresarial Server y una puerta de enlace, que está conectada a puertas de enlace RTC, IP/PBX o a troncos de SIP. Para obtener más información acerca de las conexiones RTC, consulte [planear la conectividad RTC en Skype empresarial Server](pstn-connectivity-0.md).

Se puede aplicar CAC a ambos lados del servidor de mediación, a menos que se habilite la omisión de medios. Si la opción de omisión de medios está habilitada, el tráfico multimedia no atraviesa el servidor de mediación, sino que fluye directamente entre el cliente de Skype empresarial y la puerta de enlace. En este caso, el CAC no es necesario. Para obtener más información, consulte [planear la omisión de medios en Skype empresarial](media-bypass.md).
...
4. Determina los límites de ancho de banda para cada vínculo WAN.
    ...
    > [!NOTE]
    > Los límites de ancho de banda hacen referencia a la parte del ancho de banda de un vínculo WAN que se asigna a la telefonía IP empresarial y al tráfico de audio y vídeo. Cuando un vínculo WAN se describe como "con limitaciones de ancho de banda", el vínculo WAN tiene un límite de ancho de banda menor que el tráfico pico esperado sobre el vínculo.

5. Identifica las subredes IP asignadas a cada sitio de red.

Para explicar estos conceptos, usaremos la topología de red de ejemplo que se muestra en la siguiente ilustración.
...
- Las llamadas de audio de punto a punto entre puntos de conexión de Skype empresarial usarán RTAudio (8kHz) o RTAudio (16kHz) cuando tenga en el ancho de banda y la prioridad de los códecs.

- Las llamadas en conferencia entre los puntos de conexión de Skype empresarial y el servicio de conferencia A/V usarán G. 722 o Siren.

- Las llamadas a la red de telefonía pública conmutada (RTC) a o desde puntos de conexión de Skype empresarial usarán G. 711 o RTAudio (8kHz).
...
|Llamadas RTC (entre Skype empresarial y la puerta de enlace RTC, con omisión de medios)  <br/> |97 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Llamadas RTC (entre Skype empresarial y el servidor de mediación, sin omisión de medios)  <br/> |45 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Llamadas RTC (entre el servidor de mediación y la puerta de enlace RTC, sin omisión de medios)  <br/> |97 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Skype para empresas: llamadas en Polycom  <br/> |101 kbps  <br/> |101 kbps  <br/> |101 kbps  <br/> |
