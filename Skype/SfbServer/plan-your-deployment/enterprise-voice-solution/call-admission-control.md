...
Obtenga información acerca de control de admisión de llamada, lo que puede impedir llamadas desde teniendo lugar si poseen la calidad deficiente de los medios de comunicación, en Skype para Telefonía IP empresarial de Business Server.
...
Los administradores definir directivas CAC, que son ejecutadas por el servicio de directivas de ancho de banda que se instala con cada grupo de servidores Front-End. Configuración de CAC se propaga automáticamente a todos Skype para Business Server servidores frontales en la red.
...
Llame al control no se aplica más allá de los límites de la Skype para Business Server 2015 organización de admisión. CAC no se puede aplicar al tráfico multimedia atravesar Internet, que no está gestionado por Skype para Business Server 2015. CAC comprobaciones se realizarán en la parte de la llamada que fluye a través de la red empresarial, si el extremo llamado pertenece a la organización y se ha agregado el servidor perimetral a la configuración de red, como se describe en el control de admisión de llamada [ implementación: lista de comprobación final para Skype para Business Server 2015](../../deploy/deploy-enterprise-voice/final-checklist.md). Si el extremo destinatario de la llamada no pertenece a la organización, como un usuario federado o un usuario PIC, no se realizan comprobaciones de la directiva de ancho de banda y la llamada saliente ignorará cualquier restricción de CAC.
  
### <a name="call-admission-control-of-pstn-connections"></a>Servicio de control de admisión de llamadas de conexiones RTC

Control de admisión de llamada es ejecutable en el servidor de mediación independientemente de si está conectada a una IP/PBX, una puerta de enlace PSTN o a un troncal SIP. Dado que el servidor de mediación es un agente de usuario de tipo sándwich (B2BUA), termina el medio. Tiene dos lados de la conexión: un lado conectado a Skype para Business Server y un lado de la puerta de enlace, que está conectado a puertas de enlace PSTN, IP/PBX o los troncos SIP. Para obtener más información acerca de las conexiones PSTN, consulte [Plan de conectividad PSTN en Skype para Business Server 2015](pstn-connectivity-0.md).
  
CAC se puede aplicar en ambos lados del servidor de mediación a menos que la omisión de medios está habilitado. Si está habilitada la omisión de medios, el tráfico de medios no atravesar el servidor de mediación, pero en su lugar fluye directamente entre el Skype para cliente de empresa y la puerta de enlace. En este caso, el CAC no es necesario. Para obtener información detallada, consulte [Plan para medios de derivación en Skype para negocios 2015](media-bypass.md).
...
**Llama a la aplicación del control de admisión en conexiones a la RTC**
...
1. Identificar las concentradores/redes troncales (denominadas regiones de red) dentro de su red empresarial.
    
2. Identifique las oficinas o ubicaciones (llamadas sitios de red) dentro de cada región de la red.
...
4. Determina los límites de ancho de banda para cada vínculo WAN.
    ...
    > [!NOTE]
    > Límites de ancho de banda se refieren a la cantidad del ancho de banda en un vínculo WAN está asignado a la Telefonía IP empresarial y el tráfico de audio y vídeo. Cuando un vínculo WAN se describe como "con restricciones de ancho de banda", el vínculo WAN tiene un límite de ancho de banda es menor que el tráfico máximo esperado sobre el vínculo. 
  
5. Identifica las subredes IP asignadas a cada sitio de red.
    
Para explicar estos conceptos, vamos a utilizar la topología de red de ejemplo que se muestra en la figura siguiente.
  
**Ejemplo de topología para el control de admisión de llamada**
...
Los componentes de esta topología de ejemplo se explican en las siguientes secciones. Para obtener información acerca de cómo se planificó esta topología, incluyendo los límites de ancho de banda, consulte [ejemplo: recopilación de requisitos para el control de admisión de llamada en Skype para Business Server 2015](example-gathering-requirements.md).
...
|**Región de la red**|**Sitio central**|**Sitios de red**|
|:-----|:-----|:-----|
...
Las directivas de ancho de banda CAC definen el ancho de banda máximo que se puede reservar para las modalidades de vídeo y audio en tiempo real. Ya que CAC no limita el ancho de banda de otro tráfico, no puede evitar que el tráfico de otros datos, como una transferencia de archivos grande o un streaming de música, use todo el ancho de banda de la red.
...
- Llamadas de audio de Peer-to-peer entre Skype para extremos de negocio utilizará RTAudio (8kHz) o RTAudio (16kHz) cuando se tiene en cuenta el ancho de banda y la priorización de códecs.
    
- Llamadas de conferencia entre Skype para extremos de negocio y la A / servicio de conferencias audiovisuales utilizará G.722 o Siren.
    
- Llamadas a la red telefónica pública conmutada (PSTN) hacia o desde Skype para extremos de negocio utilizará G.711 o RTAudio (8kHz).
    
Usa la tabla que aparece a continuación para optimizar la configuración del ancho de banda máximo por sesión.
  
**Uso de ancho de banda códecs**

|**Códec**|**Requerimiento de ancho de banda con ninguna corrección de errores de reenvío (FEC)**|**Requerimiento de ancho de banda con corrección de errores de reenvío (FEC)**|
|:-----|:-----|:-----|
...
G.722, el códec predeterminado de Skype para conferencia de Business Server, es totalmente diferente de los códecs G.722.1 y Siren.
  
El códec Siren se utiliza en Skype para Business Server en las siguientes situaciones:
  
- Si la directiva de ancho de banda tiene un valor demasiado bajo para el uso de G.722.
    
- Si un cliente de Communications Server 2007 o de Communications Server 2007 R2 se conecta a un Skype para el servicio de conferencia de Business Server (porque los clientes no admiten el códec G.722).
    
**Utilización del ancho de banda en un escenario**

|**Escenario**|**Requisito de ancho de banda optimizado para cantidad (kbps)**|**Requisito de ancho de banda para el modo de equilibrado (kbps)**|**Requisito de ancho de banda optimizado para la calidad (kbps)**|
|:-----|:-----|:-----|:-----|
...
|Llamadas PSTN (entre Skype para puerta de enlace PSTN y del negocio con la omisión de medios)  <br/> |97 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Llamadas PSTN entre (Skype para el negocio) y servidor de mediación, sin omisión de medios  <br/> |45 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Llamadas PSTN (entre el servidor de mediación y la puerta de enlace PSTN, sin omisión de medios)  <br/> |97 kbps  <br/> |97 kbps  <br/> |161 kbps  <br/> |
|Skype for Business - Polycom llama  <br/> |101 kbps  <br/> |101 kbps  <br/> |101 kbps  <br/> |
...
- Si deseas volver a redirigir llamadas bloqueadas a la RTC, comprueba la capacidad y las funciones de la RTC. Para obtener más información, consulte [Planificación de salida del enrutamiento de llamadas](http://technet.microsoft.com/library/37c55fa4-175a-4190-b9e4-c2e5ac7b9261.aspx).
