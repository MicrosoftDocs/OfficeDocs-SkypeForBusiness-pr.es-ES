...
La aplicación Estacionamiento de llamadas permite a Telefonía IP empresarial usuarios hacer lo siguiente:
...
- Teléfonos que no son IP que están conectados a la infraestructura Skype Empresarial Server, incluidos los teléfonos de área común y los teléfonos de central de conmutación (PBX) privados
    
## <a name="call-park-capacity-planning"></a>Planeación de capacidad de estacionamiento de llamadas
...
> [!IMPORTANT]
> Tenga en cuenta que, para planear la capacidad de recuperación ante desastres, cada grupo de servidores de un grupo emparejado debe poder controlar las cargas de trabajo de los servicios de estacionamiento de llamadas en ambos grupos. 
