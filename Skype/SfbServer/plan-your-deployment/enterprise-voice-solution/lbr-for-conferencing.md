...
New-CsServerApplication-identidad Service: Registrar:<Pool FQDN>/LBRouting-prioridad <Application Priority> -habilitado $true-crítico $true - Uri http://www.microsoft.com/LCS/LBRoutingFor ejemplo:
  
New-CsServerApplication-Service:Registrar:LS2013CU2LBRPool.contoso.com/LBRouting Identity-prioridad 3 - $true habilitado-crítico $true - Uri http://www.microsoft.com/LCS/LBRoutingAfter con este cmdlet, reinicie todos los servidores Front-End en los servidores Standard Edition o el grupo de servidores donde el Se ha habilitado el enrutamiento basado en la ubicación para la aplicación de conferencia.
