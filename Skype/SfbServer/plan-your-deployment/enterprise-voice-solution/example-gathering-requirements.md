...
Ofrece un ejemplo detallado de planificación para el control de admisión de llamada en Skype para Business Server Telefonía IP empresarial, como recopilar información sobre el ancho de banda, regiones y sitios de la red.
...
1. Identificar todos los concentradores de red y redes troncales (conocidos como regiones de red).
    
2. Identificar el Skype para el sitio central de Business Server que administrará CAC para cada región de la red.
    
3. Identificar y definir los sitios de red que están conectados a cada red de la región.
    
4. Para cada sitio de la red cuya conexión a la red WAN está delimitada por el ancho de banda, describir la capacidad de ancho de banda de la conexión WAN y los límites de ancho de banda que estableció para Skype para el tráfico de media Business Server, el Administrador de red si es aplicable. No necesitas incluir sitios cuya conexión a la red WAN no tiene ancho de banda restringido.
    
5. Asocia cada subred de la red a un sitio de red.
    
6. Asigna los vínculos entre las regiones de red. Para cada vínculo, describir su capacidad de ancho de banda y cualquier limitación que el Administrador de red ha colocado en Skype para tráfico de media Business Server.
...
2. Identificar el sitio central de cada región red asociado. Un sitio central contiene al menos un servidor de Front-End y el Skype para la implementación de servidor empresarial que administrará CAC para todo el tráfico de medios que pasa a través de la conexión WAN de la región de la red.
    
   **Una red de empresa en el ejemplo se divide en tres regiones de red**

     ![Ejemplo de topología de red con 3 regiones de red](../../media/Plan_CS_VoiceCAC_example3networkregions.jpg)
  
    > [!NOTE]
    > Una red de conmutación de etiquetas multiprotocolo (MPLS) necesita representarse como una región de red en la que cada ubicación geográfica tiene un sitio de red correspondiente. Para obtener información detallada, vea el tema "[componentes y topologías para llamar al control de admisión en Skype para el año 2015 de negocio](components-and-topologies.md)" en la documentación de planificación. 
  
    En el anterior ejemplo de topología de red, hay tres regiones de red, cada uno con un Skype para el sitio central de Business Server que administra CAC. El sitio central adecuado para una región de red se elige por la proximidad geográfica. Como el tráfico de medios será mayor dentro de las regiones de red, la propiedad por proximidad geográfica lo hace independiente y seguirá siendo funcional aunque otros sitios centrales dejen de estar disponibles. 
    
    En este ejemplo, un Skype para la implementación de empresa denominada a Chicago es el sitio central de la región de América del Norte.
    
    Todos los Skype para usuarios de negocios en América del Norte están alojados en servidores de la implementación de Chicago. En la tabla siguiente se muestran los sitios centrales de las tres regiones de red.
    
    **Las regiones de la red y sus sitios asociados Central**

    |**Región de la red**|**Sitio central**|
    |:-----|:-----|
    ...
    > [!NOTE]
    > Dependiendo de su Skype para la topología de servidores de negocios, puede asignarse el mismo sitio central para varias regiones de la red. 
...
3. En cada región de red, identifica todos los sitios de red (oficinas o ubicaciones) cuyas conexiones WAN no tienen ancho de banda restringido. Como estos sitios no tienen ancho de banda restringido, no necesitas aplicarles directivas de ancho de banda de CAC.
   ...
   **Sitios de red no está limitados por el ancho de banda WAN**

   |**Sitio de red**|**Región de la red**|
   |:-----|:-----|
...
4. En cada región de red, identifica todos los sitios de red que se conectan a la región de red a través de vínculos WAN de ancho de banda restringido.
   ...
   **Sitios de red restringidos por el ancho de banda WAN**
   ...
   **CAC red región Norteamérica con tres sitios de red que no tienen restricciones de ancho de banda (Chicago, Nueva York y Detroit) y tres sitios de red que están limitados por el ancho de banda WAN (Portland, Reno y Albuquerque)**
...
5. Para cada vínculo WAN de ancho de banda restringido, determina lo siguiente:
  ...
  - Límite general de ancho de banda que deseas establecer para todas las sesiones simultáneas de audio. Si una nueva sesión de audio hará que se supere este límite, Skype para Business Server no permite iniciar la sesión.
  ...
  - Límite general de ancho de banda que deseas establecer para todas las sesiones simultáneas de vídeo. Si una nueva sesión de vídeo hará que se supere este límite, Skype para Business Server no permite iniciar la sesión.
  ...
  - Límite de ancho de banda que deseas establecer para cada sesión individual de vídeo. El límite predeterminado de ancho de banda para CAC es de 700 kbps, pero el administrador puede modificarlo.
    ...
    **Sitios de red con información de restricciones de ancho de banda WAN (ancho de banda en kbps)**
    ...
    |**Sitio de red**|**Región de la red**|**Límite de BW**|**Límite de audio**|**Límite de sesión audio**|**Límite de vídeo**|**Límite de sesión de video**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
6. Para cada subred de la red, especifica el sitio de red asociado.
   ...
   **Sitios de red y subredes asociadas (ancho de banda en kbps)**
   ...
   |**Sitio de red**|**Región de la red**|**Límite de BW**|**Límite de audio**|**Límite de sesión audio**|**Límite de vídeo**|**Límite de sesión de video**|**Subredes**|
   |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
7. En Skype Business Server llamada de control de admisión, las conexiones entre las regiones de red se denominan vínculos de la región. Para cada vínculo de región, determina lo siguiente, tal como has hecho para los sitios de red:
   ...
   **Vínculos de red de área con límites de ancho de banda asociado**
   ...
   **Información de ancho de banda del vínculo de región (ancho de banda en kbps)**
   ...
   |**Nombre del vínculo de área**|**Primera región**|**Segunda región**|**Límite de BW**|**Límite de audio**|**Límite de sesión audio**|**Límite de vídeo**|**Límite de sesión de video**|
   |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
8. Define una ruta entre cada par de regiones de red.
   ...
   **Rutas de región**
   ...
   |**Nombre de ruta de la región**|**Primera región**|**Segunda región**|**Vínculos de la región**|
   |:-----|:-----|:-----|:-----|
...
9. Por cada par de sitios de red que están conectados directamente por un solo vínculo (llamado un vínculo entre sitio), determine lo siguiente:
   ...
   **Región de red CAC Norteamérica mostrando las capacidades de ancho de banda y límites de ancho de banda del vínculo entre sitios entre Reno y Albuquerque**
   ...
   **Información de ancho de banda para un vínculo entre sitio entre dos sitios de red (ancho de banda en kbps)**

   |**Nombre del vínculo entre sitios**|**Primer sitio**|**Segundo sitio**|**Límite de BW**|**Límite de audio**|**Límite de sesión audio**|**Límite de vídeo**|**Límite de sesión de video**|
   |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
   |Reno-Albu-Intersite-Link  <br/> |Reno  <br/> |Albuquerque  <br/> |20.000  <br/> |12.000  <br/> |175  <br/> |5.000  <br/> |700  <br/> |
   
### <a name="next-steps"></a>Pasos siguientes

Una vez que haya recopilado la información necesaria, puede realizar mediante el Skype para el Shell de administración de servidor de negocios o Skype para Panel de Control de servidor de negocios de implementación de CAC.
  
> [!NOTE]
> Aunque puede realizar la mayoría de las tareas de configuración de red mediante Skype para Panel de Control de servidor de negocios, para crear subredes y vínculos entre sitios, debe utilizar Skype para el Shell de administración de servidor empresarial. Para obtener más información, consulte [New-CsNetworkSubnet](https://docs.microsoft.com/powershell/module/skype/new-csnetworksubnet?view=skype-ps) y [CsNetworkInterSitePolicy de nuevo](https://docs.microsoft.com/powershell/module/skype/new-csnetworkintersitepolicy?view=skype-ps). 
