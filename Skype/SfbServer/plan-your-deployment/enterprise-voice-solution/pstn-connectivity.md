...
Para obtener más información sobre los partners que ofrecen Telefonía IP empresarial soluciones, consulte el sitio web de [Microsoft Unified Communications Partners](https://go.microsoft.com/fwlink/p/?linkId=202836).
  
Para obtener más información sobre los partners que ofrecen Telefonía IP empresarial de hardware, incluidas las puertas de enlace RTC, consulte el sitio web de [Microsoft Unified Communications Partners](https://go.microsoft.com/fwlink/p/?linkId=202836).
