...
Esta sección contiene información general sobre los pasos necesarios para preparar su Skype para el entorno empresarial para que pueda usar todas las características de salones de los equipos de Microsoft.
  
1. Prepare una cuenta de dispositivo para cada consola salones de los equipos de Microsoft. Para obtener información detallada, vea [Implementar salones de los equipos de Microsoft](../../deploy/deploy-clients/room-systems-v2.md) .
    
2. Asegúrese de que las conexiones de red y de Internet funcionen correctamente en el dispositivo que se va a utilizar.  
    
   - Debe ser capaz de recibir una dirección IP mediante DHCP (Nota: salones de los equipos de Microsoft no se pueden configurar con una dirección IP estática en el primer inicio de unidad)
