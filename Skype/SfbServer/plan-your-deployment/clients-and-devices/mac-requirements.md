...
El cliente de Skype Empresarial en Mac requiere Mac OS X El Capitan y superior, y usa al menos 100 MB de espacio en disco. Se admite el uso de todos los dispositivos de audio y vídeo integrados. Los dispositivos externos deben aparecer en [dispositivos de Microsoft Teams](https://www.microsoft.com/microsoft-teams/across-devices/devices). 
