...
En este artículo se resume los requisitos para admitir un v2 de sistemas de salón de Skype. 
...
|**Tipo de salón**|**Número de personas**|**Dispositivo por el tamaño de la sala óptimo**|**Comentarios**|
|:-----|:-----|:-----|:-----|
...
|**Grande** <br/> 15' x 20'  <br/> |12-16  <br/> |Logitech PTZ Pro  <br/> MSR de Polycom  <br/> Polycom CX5100   <br/> ||
