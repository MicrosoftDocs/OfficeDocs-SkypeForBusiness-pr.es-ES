...
ms.locfileid: "60863267"
---
# <a name="useragentdef-table-qoe"></a>Tabla UserAgentDef (QoE)
 
La tabla UserAgentDef asigna identificadores de agente de usuario a los nombres descriptivos del agente. Los agentes de usuario son clientes de software que se usan para conectarse a Skype Empresarial Server.
