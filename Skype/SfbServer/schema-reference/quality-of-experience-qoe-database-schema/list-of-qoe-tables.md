...
|[Tabla UserAgentDef (QoE)](useragentdef-qoe.md) <br/> |Mapas identificadores de agente de usuario a los nombres descriptivos del agente.  <br/> |
...
|[Tabla de usuario](user-0.md) <br/> |Almacena los URI de teléfono, usuario y conferencia utilizados en las sesiones de audio y vídeo.  <br/> |
|[Tabla de extremo](endpoint.md) <br/> |Almacena los nombres de equipo FQDN de los extremos que participan en las sesiones de audio y vídeo.  <br/> |
|[Tabla de grupo](pool.md) <br/> |Almacena los nombres de los grupos de servidores a los que pertenecen los datos de métricas.  <br/> |
|[Tabla de dispositivos](device.md) <br/> |Almacena los dispositivos de captura y presentación utilizados en las llamadas de audio/vídeo.  <br/> |
...
|[Tabla de conferencias](conference.md) <br/> |Almacena los URI de conferencia para los escenarios de conferencia o el identificador de diálogo para otros escenarios.  <br/> |
...
|[Tabla de diálogo](dialog.md) <br/> |Almacena el identificador de diálogo de las sesiones de audio y vídeo.  <br/> |
|[Tabla región](region.md) <br/> |Almacena la región de red definida en la configuración NCS.  <br/> |
|[Tabla UserSite](usersite.md) <br/> |Almacena el sitio de red definido en la configuración NCS.  <br/> |
|[Tabla subred](subnet.md) <br/> |Almacena la subred definida en la configuración NCS.  <br/> |
...
|[Tabla de servidor](server.md) <br/> |Almacena el FQDN o la dirección IP del servidor que utilizan los medios.  <br/> |
