...
ms.locfileid: "32212231"
---
# <a name="endpointsubnet-table"></a>Tabla EndpointSubnet
 
En la tabla EndpointSubnet es una tabla de apoyo. Cada registro representa una subred capturada de los extremos. 
  
|**Columna**|**Tipo de datos**|**Clave o índice**|**Detalles**|
|:-----|:-----|:-----|:-----|
|**SubnetIP** <br/> |int  <br/> |Principal, externa  <br/> |Representación de enteros para la subred.  <br/> |
