...
|**SessionIdTime** <br/> |datetime  <br/> |Hora de la solicitud de la sesión que originó el informe de errores. Se usa de forma conjunta con SessionIdseq para identificar de forma exclusiva una sesión. Vea la [tabla Cuadros de diálogo de Skype Empresarial Server 2015](dialogs.md) para obtener más información. <br/> |
|**SessionIdSeq** <br/> |Entero  <br/> |Número para identificar la solicitud de sesión que originó el informe de errores. Se usa de forma conjunta con SessionIdTime para identificar de forma exclusiva una sesión. Vea la [tabla Cuadros de diálogo de Skype Empresarial Server 2015](dialogs.md) para obtener más información. <br/> |
...
|**ClientType** <br/> |Entero  <br/> |Cliente que usa el usuario que originó el error. Consulta la [tabla UserAgentDef](useragentdef.md) para obtener más información. <br/> |
...
|**CallType** <br/> |nvarchar(256)  <br/> |Tipo de sesión. Vea la [tabla CallType en Skype Empresarial Server 2015](calltype.md) para obtener más información. <br/> |
