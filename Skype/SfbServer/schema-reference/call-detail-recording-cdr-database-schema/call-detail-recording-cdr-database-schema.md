...
- [Lista de tablas de CDR de Skype para Business Server 2015](list-of-cdr-tables.md)
    
- [Detalles de la tabla CDR en Skype para Business Server 2015](cdr-table-details.md)
