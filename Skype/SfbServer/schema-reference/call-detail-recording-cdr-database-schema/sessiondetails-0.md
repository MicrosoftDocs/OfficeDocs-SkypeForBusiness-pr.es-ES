...
|:-----|:-----|:-----|
|**SessionIdTime** <br/> |datetime  <br/> |Hora de la solicitud de sesión. Se usa de forma conjunta con SessionIdSeq para identificar de forma exclusiva una sesión. Vea la [tabla Cuadros de diálogo de Skype Empresarial Server tabla de 2015](dialogs.md) para obtener más información. <br/> |
...
|**FromClientType** <br/> |Entero  <br/> |Cliente que usa el usuario que inició la sesión. Consulta la [tabla UserAgentDef](useragentdef.md) para obtener más información. <br/> |
...
|**ToClientType** <br/> |Entero  <br/> |Cliente que usa el usuario que se unió a la sesión. Consulta la [tabla UserAgentDef](useragentdef.md) para obtener más información. <br/> |
...
|**ReplaceDialogIdTime** <br/> |datetime  <br/> |Fecha y hora del diálogo que se sustituyó por la sesión. Se usa en combinación con ReplaceDialogIdSeq para identificar de forma exclusiva un diálogo que se sustituye con la sesión. Vea la [tabla Cuadros de diálogo de Skype Empresarial Server 2015](dialogs.md) para obtener más información. <br/> |
|**ReplaceDialogIdSeq** <br/> |Entero  <br/> |Número de identificador de la sesión. Se usa en combinación con ReplaceDialogIdTime para identificar de forma exclusiva un diálogo que se sustituye con la sesión. Vea la [tabla Cuadros de diálogo de Skype Empresarial Server 2015](dialogs.md) para obtener más información. <br/> |
