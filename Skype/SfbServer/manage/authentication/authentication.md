...
- [Configurar la autenticación de servidor a servidor para un Skype para entorno híbrido de Business Server.](configure-a-hybrid-environment.md)

- [Configurar una aplicación de socio local para Skype para Business Server](configure-an-on-premises-partner-app.md)
