...
Cada servidor front-end que ejecuta Skype Empresarial Server 2015 Cumulative Update 2 (CU2) o posterior admite hasta 375 participantes para compartir pantalla con RDP (aunque solo 250 por reunión). Esta capacidad no cambia después de CU3, cuando se introduce y se usa VbSS.
...
- Todos los usuarios del entorno Skype Empresarial Server tienen resoluciones de pantalla superiores a 1920 x 1080.
...
El uso compartido de pantalla basado en vídeo requiere Skype Empresarial Server 2015 CU3 o posterior, y una versión actual de los clientes compatibles que aparecen en la comparación de características de cliente móvil para la compatibilidad con [Skype Empresarial](../plan-your-deployment/clients-and-devices/mobile-feature-comparison.md) y [reuniones.](../plan-your-deployment/clients-and-devices/desktop-feature-comparison.md#BKMK_Conferencing) 
...
- Si alguien que usa una versión anterior del cliente de Skype Empresarial se une Windows la sesión, por ejemplo, cualquier persona que use una versión de cliente inferior Windows 16.0.6330.1000, dispositivos del sistema de sala de Skype Empresarial o aplicaciones móviles Skype Empresarial. 
- Si un usuario está compartiendo desde el aplicación web de Skype Empresarial.
- Si alguien usa Skype Empresarial en Mac y no se encuentra en Skype Empresarial Online o Skype Empresarial Server 2015 con la actualización acumulativa de julio de 2018 (o posterior).
...
> [!NOTE]
> No se admite bloquear o intentar bloquear la transición de VbSS a RDP en Skype Empresarial pantalla compartida. 
  
## <a name="enabling-disabling-and-configuring-vbss"></a>Habilitar, deshabilitar y configurar VbSS

Lo bueno es que, una vez que haya instalado la actualización acumulativa 3 (CU3) de Skype Empresarial Server 2015 o posterior, todos los usuarios estarán habilitados para VbSS de 1 a 1 y de varias partes de forma predeterminada. Esto puede ser problemático para usted si tiene una razón para no tener esta funcionalidad habilitada para todos los usuarios. En ese caso, puede usar estos pasos para deshabilitar a los usuarios (los pasos de habilitar usuarios seguirán):
