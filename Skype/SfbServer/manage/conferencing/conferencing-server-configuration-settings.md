...
Para administrar las opciones de configuración de conferencia mediante Skype Empresarial Server Shell de administración, use los cmdlets siguientes:
