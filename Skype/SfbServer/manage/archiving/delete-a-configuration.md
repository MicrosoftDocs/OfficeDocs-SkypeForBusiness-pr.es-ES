...
---
# <a name="delete-an-archiving-configuration-in-skype-for-business-server-2015"></a>Eliminar una configuración de archivado en Skype Empresarial Server 2015

**Resumen:** Obtenga información acerca de cómo eliminar una configuración de archiving en Skype para Business Server 2015.
...
También puede eliminar una configuración de archiving mediante el cmdlet **Remove-CsArchivingConfiguration** .
