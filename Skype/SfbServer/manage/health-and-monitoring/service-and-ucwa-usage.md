...
- **ASP.NET v2.0.50727\Requests actual**, lo que indica el número de solicitudes web en el servidor pendientes. Cuando este contador alcanza las 5.000, las solicitudes posteriores provocarán el error “503 - Servicio no disponible”.
