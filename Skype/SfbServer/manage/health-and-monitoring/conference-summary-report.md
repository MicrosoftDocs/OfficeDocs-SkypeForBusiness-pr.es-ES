...
El informe de resumen de conferencia ofrece una vista general de las sesiones de conferencia en línea. Una conferencia suele implicar a más de 2 usuarios y requiere el uso de servicios de conferencia. En comparación, una sesión punto a punto normalmente implica solo 2 usuarios y no requiere el uso de Skype Empresarial Server servicios de conferencia. Las actividades punto a punto se notifican en el Informe de resumen de actividad punto a [punto en Skype Empresarial Server](peer-to-peer-activity-summary-report.md).
  
El Informe de resumen de conferencias no solo le indica cuántas conferencias se realizaron durante un período de tiempo determinado (por horas, diarias, semanales, mensuales), sino que también le indica el número total de personas que participaron en dichas conferencias y el número total de organizadores de conferencias únicos.
