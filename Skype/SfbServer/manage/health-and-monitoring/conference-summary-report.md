---
title: Informe de resumen de conferencia en Skype Empresarial Server 2015
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 3/28/2016
...
description: 'Resumen: Conozca el informe de resumen de conferencia en Skype para Business Server 2015.'
...
---
# <a name="conference-summary-report-in-skype-for-business-server-2015"></a>Informe de resumen de conferencia en Skype Empresarial Server 2015
 
**Resumen:** Obtener información sobre el informe de resumen de conferencia en Skype para Business Server 2015.
  
El informe de resumen de conferencia ofrece una vista general de las sesiones de conferencia en línea. Una conferencia normalmente implica a más de 2 usuarios y requiere el uso de servicios de conferencia. En comparación, una sesión de peer-to-peer normalmente implica a sólo 2 usuarios y no requiere el uso de Skype para servicios de conferencia de Business Server. Actividades de Peer-to-peer se notifican en el [informe de resumen de la actividad de Peer-to-Peer de Skype para Business Server 2015](peer-to-peer-activity-summary-report.md).
...
Total valores para la mayoría de las métricas usadas en el informe de resumen de conferencia pueden encontrarse en la parte inferior del informe; Desplácese hasta que vea valores como el número total de conferencias llevadas a cabo durante el período de tiempo especificado y el número total de personas que participaron en las conferencias. Una métrica que no se suman al final del informe es organizadores Total único. ¿Por qué no? Hay una razón. Supongamos que está examinando el valor de un mes de datos. Día 1 tenía 34 organizadores de conferencia único; día 2 tenía 27 organizadores único. ¿Significa que tenía 61 organizadores único durante esos dos días? No necesariamente. Después de todo, todas las personas de 27 que organizan conferencias en el día 2 podrían ser entre las 34 personas que organizan conferencias el día 1. Por ejemplo, en este informe simple, tenga en cuenta que el Ken Myer y Pilar Ackerman de programar conferencias tanto en 7/7/2015 y en 2/7/2015:
...
**Filtros de informe resumen de la conferencia**
...
**Métricas de informe de resumen de conferencia**
