...
Es posible tener acceso al Informe de uso del grupo de respuesta desde la página de inicio de informes de supervisión. Puede explorar en profundidad el informe de lista de llamadas de grupo de respuesta en [Skype Empresarial Server](call-list-report.md) haciendo clic en cualquiera de las métricas siguientes:
