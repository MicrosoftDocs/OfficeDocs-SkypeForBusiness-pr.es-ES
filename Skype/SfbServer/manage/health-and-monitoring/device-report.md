...
Generalmente, se accede al informe de dispositivos desde la página de inicio de Informes de supervisión. Sin embargo, si está viendo el [Informe de detalle de llamar en Skype para Business Server 2015](call-detail-report.md) puede desglosar el informe de dispositivo para un dispositivo específico haciendo clic en cualquiera de las siguientes métricas:
  
- Dispositivo de captura
    
- Dispositivo de presentación
    
Desde el informe del dispositivo puede desglosar el [Informe de lista de llamar en Skype para Business Server 2015](call-list-report-0.md) haciendo clic en cualquiera de las siguientes métricas:
...
> [!NOTE]
> Tenga en cuenta que los nombres de dispositivo de captura pueden no ser la misma si está ejecutando las versiones localizadas de Skype para Business Server 2015. El dispositivo Aastra 6725ip Microphone (Aastra 6725ip)-V0 en inglés, podría tener otro nombre en francés o en español. 
...
**Filtros de informe del dispositivo**
...
|**Tipo de llamada** <br/> |Indica el tipo de llamada realizada. Seleccione una de las siguientes opciones:  <br/> [All] Llamada del cliente llamada PSTN llamada de conferencia |
...
|**Tipo de dispositivo** <br/> |Indica el tipo de dispositivo. Seleccione una de las siguientes opciones:  <br/> Par de dispositivo de captura y generación de dispositivo Render dispositivo de captura |
...
**Métricas de informe del dispositivo**
