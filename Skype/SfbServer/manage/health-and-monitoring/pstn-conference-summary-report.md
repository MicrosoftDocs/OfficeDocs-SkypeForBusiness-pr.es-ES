...
En Skype Empresarial Server, una conferencia RTC es cualquier conferencia en la que al menos un participante llame a la parte de audio mediante un teléfono RTC (red telefónica conmutada). (Un teléfono RTC es un "teléfono fijo", un teléfono móvil o cualquier otro teléfono que no haga uso de voz sobre IP). Aunque se conoce como conferencias RTC en los informes de supervisión, estas conferencias son quizás más conocidas como conferencias de acceso telefónico local.
...
Los filtros ofrecen el medio para devolver un conjunto de datos más específico o para ver los datos devueltos de diferentes formas. Por ejemplo, el informe de resumen de conferencia RTC permite elegir cómo se deben agrupar los datos. En este caso, las conferencias se agrupan por hora, día, semana o mes.
