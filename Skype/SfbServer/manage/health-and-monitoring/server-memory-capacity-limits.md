...
Si la cantidad de memoria disponible en el servidor front-end es inferior a 1.500 MB al planear el número esperado de usuarios de movilidad, debe agregar más hardware para admitir el servicio de movilidad. Para obtener más información, vea [Monitor mobility for performance in Skype Empresarial Server](monitor-mobility-performance.md) en la documentación sobre operaciones.
