...
Memoria total usada por el servicio de movilidad de MCX (MB) = 164 + (400 + 134)/1024 * **recuento de sesión activo actualmente con suscripciones de presencia activas** + 400/1024 * (recuento de **sesión** - actualmente activo recuento**de sesiones activas con suscripciones de presencia activas**)
