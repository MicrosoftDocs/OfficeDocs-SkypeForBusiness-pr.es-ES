...
Skype empresarial Online califica y admite teléfonos escritorio para los usuarios que deseen tener una experiencia de teléfono tradicional, en lugar de usar el Skype empresarial. Este tema trata sobre los teléfonos y las versiones de firmware compatibles para su uso en Skype empresarial Online y otra información que puede ayudarle a cuando configure teléfonos de su organización.
  
Para obtener las actualizaciones más recientes y la mayoría de la información actualizada en dispositivos compatibles, consulte la [Skype para Business dispositivo catálogo](http://partnersolutions.skypeforbusiness.com/solutionscatalog).
  
## Teléfonos compatibles

Para Skype empresarial los usuarios, puede elegir entre varios modelos de  *certificado para Skype para Business teléfonos*  y teléfonos ejecuta Lync Phone Edition (LPE) que aparece en la Skype para empresarial Online categoría en el[Skype para la empresa Catálogo de dispositivo](http://partnersolutions.skypeforbusiness.com/solutionscatalog).
  
Microsoft está asociada y trabajar estrechamente con Polycom Yealink y AudioCodes para desarrollar y certificar una amplia variedad de dispositivos a través del programa asociado de teléfono IP (puntos) para el sistema telefónico en Office 365 y Skype empresarial Server.
  
Cuando se solicita teléfonos nuevos para Skype empresarial, es importante comprar teléfonos con el  *identificador de producto derecha*  . Estos identificadores de producto se garantizan que los teléfonos que recibe la Skype empresarial Online versión completo ya instalado.
...
Para obtener más detalles en teléfonos Yealink, consulte [Skype para teléfonos IP de empresa](http://www.yealink.com/solution_7.mdl)
  
Para obtener más detalles en teléfonos AudioCodes, vea [Skype para teléfonos IP de empresa](http://www.audiocodes.com/products/skype-for-business-compatible-ip-phone).
  
> [!NOTE]
> Lync Phone Edition es compatible con Skype empresarial Online. Soporte estándar para plataforma LPE finaliza abril/10/2014, con soporte ampliado hasta abril/11/2023 para alinear con el ciclo de vida del soporte técnico de producto de Lync Server 2013. Consulte [Ciclo de vida del producto de Microsoft](https://support.microsoft.com/en-us/lifecycle/search?qid=&amp;alpha=Lync%20Phone%20Edition&amp;Filter=FilterNO) para obtener más información sobre el ciclo de vida LPE. Modelos de capital LPE no son compatibles con Skype empresarial Online.
...
Skype empresarial Online no requiere ninguna licencia adicional de Microsoft que no sea de las licencias de usuario. Para obtener más información sobre las licencias de usuario, vea [Skype para Business y Microsoft Teams licencias de complemento](../../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md).
  
Modelos de licencia del fabricante puede variar entre abrir SIP y Skype para firmware de certificados de empresa. Si la reasignación de un modelo de certificado con un firmware SIP abierto, deberá comprobar los requisitos de licencia de firmware con el fabricante.
  
## Conjunto de características de los teléfonos conectados para Skype Empresarial Online

Para las características de dispositivo completo y capacidades, consulte las guías de usuario del fabricante.
...
|Carga de registros  <br/> > [!NOTE]> Actualmente, todos los registros se cargan al equipo de Microsoft Support acceso de cliente a notas telefónicas aún no están disponibles.           |Sí  <br/> |Sí  <br/> |Sí  <br/> |Sí  <br/> |
