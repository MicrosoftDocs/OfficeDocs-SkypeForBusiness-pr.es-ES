...
-   Permite a los usuarios para conectarse a una amplia variedad de herramientas en su área de trabajo (por ejemplo, el organizador, Power BI, depósito, etcetera).
