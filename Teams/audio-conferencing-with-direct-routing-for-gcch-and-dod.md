...
Se requiere una licencia de espacio empresarial y al menos una licencia de usuario para habilitar el servicio. No puede habilitar el servicio solo con la licencia del inquilino o solo con licencias de usuario. Para obtener licencias de servicio para su inquilino y los usuarios de su organización, póngase en contacto con el equipo de cuentas.
...
Para asignar la nueva ruta de voz a la directiva global de enrutamiento de voz de su organización, use el comando siguiente:
