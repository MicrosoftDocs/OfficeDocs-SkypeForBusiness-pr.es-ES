...
> [!IMPORTANT]
> Si necesita más información sobre cómo proteger a los alumnos durante las reuniones, puede consultar [Mantener a los alumnos a salvo mientras usan reuniones en Teams para wl aprendizaje a distancia](https://support.office.com/article/f00fa399-0473-4d31-ab72-644c137e11c8).
...
1. La configuración de [School Data Sync](https://sds.microsoft.com/) (SDS) puede **hacerla el personal de TI**, lo que permite crear equipos de clase para todas las clases basándose en la información del sistema de información de la escuela. Este proceso aprovisiona grupos para cada sección y mantiene las listas de instructores y estudiantes sincronizadas a medida que las inscripciones cambian. Los profesores pueden convertir estos grupos en equipos de clase [con este proceso](https://support.office.com/article/create-a-class-team-in-microsoft-teams-preview-fae422eb-58b7-4431-9ff2-a4b9b6ae7c5b). Una vez se crea un equipo de clase, los [profesores pueden preparar su equipo](https://support.office.com/article/activate-early-access-class-teams-created-with-school-data-sync-0d154696-66ab-4fcf-b22f-c3d9a82aaf78) antes de admitir alumnos. SDS es compatible con más de 80 sistemas de información académica (sistemas SIS) para la importación de datos y el [equipo de soporte técnico de SDS](https://aka.ms/SDSSupport) está preparado para ayudarle con la planeación y configuración. También puede ver nuestra [Guía de implementación rápida para el aprendizaje remoto](https://docs.microsoft.com/SchoolDataSync/fast-deployment-guidance) para comenzar rápidamente.
