...
| ---- | ---------------- | ---------- |
| Patrocinador <sup>ejecutivo1</sup> | Comunicar visión de alto nivel. Conectar Teams a las principales iniciativas de prioridad y misión de la empresa. | Liderazgo ejecutivo |
| Propietario del <sup>éxito1</sup> | Asegúrese de que los objetivos empresariales se realizan a partir Teams implementación. | Cualquier departamento |
| Administrador de <sup>programas1</sup> | Supervise todo el proceso Teams de ejecución e implementación de inicio. | TI |
| <sup>Champions1</sup> | Ayude a evangelizar Teams, apoyar la creación de aptitudes y proporcionar información sobre el uso. | Varios departamentos |
...
| Especialistas en <sup>IT1</sup> | Supervise todos los aspectos técnicos de la implementación, incluidas las integraciones. | TI |
| Guía de <sup>comunicación2</sup> | Supervisar las comunicaciones de toda la empresa sobre Teams. | Comunicaciones corporativas, IT u otras |
| Community administrador de aplicaciones | Administre la actividad de red Yammer día a día. Proporcionar instrucciones y procedimientos recomendados. | Varios departamentos |
...
Microsoft [Technical Community](https://aka.ms/TechCommunity) ofrece información proporcionada por pares sobre la adopción y los problemas técnicos de muchos Microsoft 365 y Office 365 productos. Le recomendamos que se una a las siguientes comunidades:
