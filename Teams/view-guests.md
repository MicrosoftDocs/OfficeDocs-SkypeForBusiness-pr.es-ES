...
2.  Seleccione **** > **equipos**del centro de administración.
3.  En el centro de administración de Microsoft Teams, seleccione **usuarios**. Verá **Guest** anexado al nombre para mostrar de los usuarios invitados.
