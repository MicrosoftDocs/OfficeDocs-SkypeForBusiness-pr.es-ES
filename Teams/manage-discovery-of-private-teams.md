...
Use el cmdlet **set-Team** para desactivar o activar la configuración de detección de un equipo privado existente. Este es un ejemplo de cómo hacer que un equipo sea reconocible:
...
Como administrador, también puede controlar los usuarios de su organización que pueden detectar equipos privados en los resultados de búsqueda y sugerencias de Teams. Cree una directiva con el cmdlet **New-CsTeamsChannelsPolicy** y, a continuación, asigne la Directiva a los usuarios.
