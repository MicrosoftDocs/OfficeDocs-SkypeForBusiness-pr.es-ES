...
manager: serdars
description: Más información sobre cómo registrarse para las clases gratuitas y en directo dirigidas por un instructor para aprender sobre Microsoft Teams.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bienvenido a Microsoft Teams</h3>
                        <p>¿Qué es Microsoft Teams? Apúntese a esta orientación de 30 minutos para descubrir qué es Teams y verlo en acción.</p>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Desde chats y reuniones hasta equipos y canales, al final de esta sesión, los usuarios podrán usar Teams con confianza.</p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Celebre reuniones efectivas con Teams.</h3>
                        <p>Obtenga información sobre cómo aprovechar Teams antes, durante y después de las reuniones.</p>
                        <p><i>Público: usuarios finales</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Explorar equipos y canales en Teams</h3>
                        <p>Obtenga información acerca de cómo puede mejorar la colaboración en proyectos y grupos de trabajo.</p>
                        <p><i>Público: usuarios finales</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Infórmese sobre cómo usar Teams a fondo</h3>
                        <p>Comprenda las formas creativas de optimizar y organizar Teams en su trabajo diario.</p>
                        <p><i>Público: usuarios finales</i></p>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Aprenda a usar Teams en entorno de la Educación superior.</p>
                        <p><i>Público: empleados, alumnos, profesores, investigadores, profesionales de TI</i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Actualice los talleres que tenga planeados</h3>
                        <p>Planifique e implemente una actualización satisfactoria a Teams</p>
                        <p><i>Público: profesionales de TI, administradores encargados de la adopción del cambio</i></p>
                    </div>
                </div>
            </div>
        </div>
