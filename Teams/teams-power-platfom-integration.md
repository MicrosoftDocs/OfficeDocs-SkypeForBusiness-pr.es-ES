...
Microsoft Power Platform ofrece muchas funcionalidades de integración con Teams donde puede insertar informes de **Power BI** en el área de trabajo de Teams, insertar aplicaciones creadas con **Power Apps** como pestaña o aplicación personal, desencadenar un flujo **de Power Automate** desde cualquier mensaje o usar tarjetas adaptables, y agregar el bot **creado con Power Virtual Agents** que Teams otros miembros de su organización puedan interactuar con ellos.
...
- Cree y comparta aplicaciones diseñadas específicamente con un estudio integrado de Power Apps mediante la conexión a los datos empresariales almacenados en la nueva plataforma de datos subyacente (Microsoft Dataverse para Teams), Microsoft 365 o en otros orígenes de datos **a** través de conectores.
