...
f1.keywords:
- NOCSH
description: Obtenga información sobre cómo configurar un controlador de borde de sesión (SBC) para que sirva a varios inquilinos para Microsoft asociados o operadores RTC.
...
> [!NOTE]
> Este escenario está diseñado para Microsoft asociados y/o operadores RTC, denominados operadores más adelante en este documento. Un operador vende servicios de telefonía entregados a Microsoft Teams a sus clientes. 
...
Microsoft no administra los transportistas. Microsoft ofrece sistema telefónico, una central de intercambio (PBX) y un cliente de Teams. Microsoft también certifica los teléfonos y certifica los SBCs que se pueden usar con el sistema telefónico. Antes de elegir un operador, asegúrese de que su elección tiene un SBC certificado y puede administrar la calidad de voz de un extremo a otro.
...
- **Audiocodes:** Consulte [Notas de configuración de enrutamiento directo](https://www.audiocodes.com/solutions-products/products/products-for-microsoft-365/direct-routing-for-Microsoft-Teams) para obtener información sobre la configuración del escenario de hospedaje de SBC, como se describe en "Conectar AudioCodes SBC a Microsoft nota de configuración del modelo de hospedaje de enrutamiento directo de Teams". 
- **Oracle:** Consulte [Las notas de configuración de enrutamiento directo](https://www.oracle.com/technetwork/indexes/documentation/acme-packet-2228107.html) para la configuración del escenario de hospedaje SBC como se describe en la sección "Microsoft". 
- **Comunicaciones de la cinta de opciones:** Vea [Ribbon Communications SBC Core Microsoft Teams Configuration Guide (Guía de configuración de Teams](https://support.sonus.net/display/ALLDOC/SBC+8.2+-+MS+Teams+Solution+Guide)) para obtener documentación sobre cómo configurar LOSC de Ribbon Core Series. Consulte también [Procedimientos recomendados de la cinta de opciones: Configuración de operadores para Microsoft SBC Edge de enrutamiento directo de Teams](https://support.sonus.net/display/UXDOC81/Connect+SBC+Edge+to+Microsoft+Teams+Direct+Routing+to+Support+Direct+Routing+Carrier)
...
- Woodgrove Bank, Contoso y Adventure Works son tres clientes que tienen dominios Microsoft 365 pero que reciben los servicios de telefonía de Adatum.
...
- Cuenta de usuario con una licencia **de dispositivos compartidos Microsoft Teams**.
...
Para obtener más información sobre cómo agregar usuarios en Microsoft 365 organizaciones, vea [Obtener ayuda con Microsoft 365 dominios](/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider).
...
Con la versión inicial de Enrutamiento directo, Microsoft necesitaba agregar un tronco a cada inquilino servido (inquilino del cliente) mediante el cmdlet de New-CSOnlinePSTNGateway.
...
Basándose en estos comentarios, Microsoft está incorporando una nueva lógica para aprovisionar los troncos para los inquilinos del cliente.
