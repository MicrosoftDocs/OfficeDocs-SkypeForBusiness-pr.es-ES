...
Sólo se pueden agregar nuevos dominios si ha iniciado sesión el centro de administración de Microsoft 365 como un administrador Global. 
...
Después de que se ha registrado un nombre de dominio, es necesario activar mediante la adición de al menos un E1, E3, o con una licencia de E5 usuario y la asignación de una dirección SIP con la parte FQDN del SIP de direcciones que coincida con el dominio base creado. 
...
Al crear el tronco, puede recibir el mensaje de error siguiente:

```
Can not use the "sbc1.customers.adatum.biz" domain as it was not configured for this tenant.
```

Espere algún tiempo de registro de dominios y la activación a replicar e inténtelo de nuevo.
