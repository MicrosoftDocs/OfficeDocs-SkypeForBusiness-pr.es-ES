...
3. En el **panel De** edición, en **Ubicación de** emergencia, realice una de las siguientes acciones:
    ...
    - Para asignar un lugar, busca la ubicación o el lugar y, a continuación, selecciona el lugar en los resultados de búsqueda.
...
4. En función de si desea enviar un correo electrónico al usuario con la información de su número de teléfono, desactive o active el usuario de Correo electrónico con la información del número **de teléfono.** De forma predeterminada, está disponible.
