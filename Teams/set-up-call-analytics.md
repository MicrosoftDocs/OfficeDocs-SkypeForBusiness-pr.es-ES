...
ms.custom:
- Reporting
description: Configure el análisis de llamadas por usuario para identificar y solucionar Microsoft Teams de calidad de llamadas.
ms.openlocfilehash: be93a24f7d18e5b347c6375622ca47c3bdaeae26
ms.sourcegitcommit: cbdc80c302e97d18a923ef57bb5d4b6cf7676d00
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 03/30/2022
ms.locfileid: "64556481"
---
# <a name="set-up-call-analytics-for-microsoft-teams"></a>Configurar análisis de llamadas para Microsoft Teams

Como administrador Microsoft Teams, puede usar el análisis de llamadas por usuario para solucionar Teams de calidad de llamadas y problemas de conexión para **usuarios individuales**. Para aprovechar al máximo el análisis de llamadas, configure lo siguiente:
...
Como administrador Teams, tiene acceso completo a la información de análisis de llamadas para todos los usuarios. Hemos creado algunos roles de Azure Active Directory especializados que puede asignar a personal de soporte técnico y agentes de soporte técnico para que también puedan acceder al análisis de llamadas por usuario (sin tener acceso al resto del centro de administración de Teams usuario). Asigne el **Teams** de soporte técnico de comunicaciones a los usuarios que deben tener una vista limitada del análisis de llamadas por usuario (soporte técnico de nivel 1). Asigne el **Teams** de ingeniería de soporte técnico de comunicaciones a los usuarios que necesiten acceso completo al análisis de llamadas por usuario (soporte técnico de nivel 2). Ninguna de las dos funciones tiene acceso al resto del Teams de administración.

Para obtener información sobre lo que hace cada uno de estos roles, lea [¿Qué Teams rol de soporte técnico?](use-call-analytics-to-troubleshoot-poor-call-quality.md#what-does-each-teams-support-role-do)
...
## <a name="upload-a-tsv-or-csv-file-to-add-building-site-and-tenant-information"></a>Upload archivo .tsv o .csv para agregar información de edificio, sitio e inquilino

Puede agregar información de creación, sitio e inquilino a análisis de llamadas por usuario cargando un archivo .csv o .tsv. Con toda esta información, el análisis de llamadas puede asignar direcciones IP a ubicaciones físicas. Los administradores y agentes del departamento de soporte técnico pueden usar esta información para ayudar a detectar tendencias en problemas de llamadas. Por ejemplo, ¿por qué los usuarios del mismo edificio tienen problemas similares de calidad de llamada? 

Si es administrador de Teams o Skype Empresarial, puede usar un inquilino existente y crear un archivo de datos desde el panel de calidad de llamadas (CQD) de Teams o Skype Empresarial de llamadas ( CQD). En primer lugar, descargue el archivo desde CQD y, a continuación, cargue el archivo en análisis de llamadas. 

- Para descargar un archivo de datos existente, vaya **Microsoft Teams** >  centro de **administraciónAnalytics & informes** >  **Llamar** >  panel de **calidad Upload ahora**. En la **lista Mis cargas** , haga clic **en Descargar** junto al archivo que desee. 
