...
appliesto:
- Microsoft Teams
ms.openlocfilehash: 3c91f1e7110b1756c39f6d8c6439cacdf820c602
ms.sourcegitcommit: b710fc61558a0e031d4e3e4000f234c495e2c4c6
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 12/17/2022
ms.locfileid: "69438298"
---
...
|![un botón de reproducción de vídeo.](/office/media/icons/video-play.png) |[Ver procedimientos recomendados y vídeos paso a paso en el canal Coffee in the Cloud ("Café en la nube") en YouTube](https://www.youtube.com/channel/UCs2IXBqperxWVe2ozrr3Gdg/videos)     |![Persona con una llave inglesa](/office/media/icons/administrator.png) |[Tiza de Teams Charlas: aprenda procedimientos recomendados y orientación práctica sobre escenarios populares de Teams](./chalk-talks-landing-page.yml)         |
...
| Guía de reproducción de implementación de dispositivos de Teams | | [Presentación de diapositivas](https://aka.ms/teams-devices-deployment-playbook) |
| Guía de reproducción de implementación de Teams Phone | | [Presentación de diapositivas](https://aka.ms/teams-phone-deployment-playbook) |
...
<p>La tabla siguiente contiene vínculos a presentaciones de aprendizaje completas de PowerPoint en Microsoft dispositivos Android de Teams que incluyen Pantallas de Teams, Teléfonos de Teams, Salas de Teams en Android y Paneles de Teams.  

| Módulo | Presentación de PowerPoint   |
| ------------| -------------------- |
| Módulo 1: Introducción a Microsoft dispositivos Android de Teams  |[Presentación de diapositivas](https://aka.ms/TeamsAndroidModule1) |
| Módulo 2: Planeamiento Microsoft dispositivos Android de Teams|[Presentación de diapositivas](https://aka.ms/TeamsAndroidModule2) |
| Módulo 3: Administrar Microsoft dispositivos Android de Teams |[Presentación de diapositivas](https://aka.ms/TeamsAndroidModule3)|
| Módulo 4: Microsoft se muestran los teléfonos y Microsoft Teams |[Presentación de diapositivas](https://aka.ms/TeamsAndroidModule4)|
| Módulo 5: paneles de Teams Salas de Microsoft Teams y Microsoft |[Presentación de diapositivas](https://aka.ms/TeamsAndroidModule5)|
...
|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| Protección contra amenazas & la administración de acceso e identidad para Teams                   | Obtenga información sobre cómo usar Microsoft centros de administración y PowerShell para configurar las directivas de acceso e identidad y Habilitar Office 365 Protección contra amenazas avanzada para Teams                                                            | [Guía de seguridad de Teams](https://aka.ms/teamsesecurityinteractiveguide)         |
| Directivas de prevención de pérdida de datos (DLP) de Microsoft Purview para equipos de Microsoft                     | Obtenga información sobre cómo agregar Microsoft Teams a una directiva DLP existente y cómo crear una nueva directiva, ya sea basada en una plantilla o totalmente personalizada según las necesidades de protección de datos de su organización.                        | [Guía de DLP de Teams](https://aka.ms/teamsdlpguide)         |
| Administrar el cumplimiento en Teams                                                | Use los centros de administración de Seguridad de Microsoft 365, Cumplimiento de Microsoft 365 y Microsoft Teams, así como Windows PowerShell para administrar y configurar las directivas y la configuración de Teams Microsoft una organización Office 365. | [Administrar el cumplimiento en la guía de Teams](https://aka.ms/complianceinteamsinteractiveguide)      |
| Asesor de Teams: Implementar chats, equipos, canales y aplicaciones en Microsoft Teams | Aprenda a usar el asesor de Teams para evaluar su entorno y crear un plan para implementar chats, equipos, canales y aplicaciones.                                                                                         |  [Guía del asesor de Teams](https://aka.ms/MicrosoftTeamsAdvisorInteractiveguide)  |
...
| Configurar Teams Phone System: Operador automático & cola de llamadas                   | Siga el proceso de creación e implementación de una cola de llamadas y un operador automático como parte de Microsoft llamadas de Teams mediante el centro de administración de Microsoft Teams.                                                          |  [Configurar la guía del sistema telefónico de Teams](https://aka.ms/TeamsPhoneInteractiveGuide)             |
...
| Configurar el gobierno en Microsoft Teams                                     | Obtenga información sobre cómo crear una directiva de retención de mensajería de Teams para su organización y cómo archivar, eliminar y restaurar equipos individuales                                                                                   |  [Configurar el gobierno en Microsoft guía de Teams](https://aka.ms/TeamsGovernanceInteractiveGuide)        |
| Configuración e implementación Microsoft reuniones de Teams                          | Siga el proceso de implementar la carga de trabajo de reuniones para Microsoft Teams.                                                                                                                                       |  [Configurar e implementar Microsoft guía de reuniones de Teams](https://aka.ms/TeamsMeetingsInteractiveGuide)          |
| Configurar Audioconferencia para Microsoft Teams                            | Descubra las capacidades de Audioconferencia en Teams y aprenda a asignar puentes de conferencia y números de teléfono de acceso telefónico local.                                                                                          |  [Configurar audioconferencias para Microsoft guía de Teams](https://aka.ms/AudioConferencingInteractiveGuide)      |
| Configuración de Microsoft Teams para firstline Workers                           | Obtenga información sobre cómo configurar e implementar el entorno adecuado Microsoft Teams para su personal de primera línea.                                                                                                                  | [Configurar Microsoft guía de Teams para firstline Workers](https://aka.ms/ConfigFLWInteractiveGuide)              |
...
| Implementar Salas de Microsoft Teams                           | Obtenga información sobre cómo crear y configurar una cuenta para usarla con Salas de Microsoft Teams y administrar el dispositivo en Microsoft centro de administración de Teams.                                                                                                                  | [Implementar Salas de Microsoft Teams](https://aka.ms/teamsroomslab)              |
|Trabajar con dispositivos Android certificados para Teams|Obtenga información sobre cómo administrar y actualizar Microsoft teléfonos de Teams, Microsoft pantallas, Salas de Microsoft Teams y Microsoft paneles de Teams.|[Trabajar con Microsoft dispositivos Android certificados para Teams](https://aka.ms/teamsandroiddeviceslab)|
