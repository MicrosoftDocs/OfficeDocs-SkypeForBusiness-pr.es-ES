...
- De forma alternativa, puede decidir dejar el equipo PC de aplicación en el grupo de trabajo. Como con el escritorio Microsoft Teams o Skype para clientes empresariales, esto requiere importar manualmente la cadena de certificados raíz en el dispositivo del sistema de salas de Skype PC. No es necesario para importar la cadena de certificados raíz si la implementación usa un certificado público (por ejemplo, Entrust, VeriSign etc.). 
