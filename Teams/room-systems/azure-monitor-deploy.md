...
1.  [Validar la configuración del análisis de registro](azure-monitor-deploy.md#validate_LogAnalytics)
2.  [Configurar dispositivos de prueba para el programa de instalación de administración de análisis de registro](azure-monitor-deploy.md#configure_test_devices)
3.  [Asignar campos personalizados](azure-monitor-deploy.md#Custom_fields)
4.  [Definir las vistas de salas de equipos de Microsoft en el registro de análisis](azure-monitor-deploy.md#Define_Views)
5.  [Definir alertas](azure-monitor-deploy.md#Alerts)
6.  [Configurar todos los dispositivos de supervisión](azure-monitor-deploy.md#configure_all_devices)
7.  [Configurar las soluciones de Monitor de Azure adicionales](azure-monitor-deploy.md#Solutions)
