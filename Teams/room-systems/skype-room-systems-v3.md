...
Información sobre el estado de la aplicación de Microsoft salones de los equipos y dispositivos periféricos conectados es escrita por la aplicación de salas de equipos de Microsoft para el registro de eventos de Windows y que se documentaron en [comprender las entradas del registro](azure-monitor-manage.md#understand-the-log-entries). 
