...
- **Paso 2** el administrador de Office 365 o el propietario del equipo administra las capacidades de un invitado cuando es necesario: por ejemplo, permitir que un invitado agregue o elimine canales o deshabilite el acceso a los archivos.

- **Paso 3** El invitado recibe un correo electrónico de bienvenida del propietario del grupo, con información sobre el equipo y lo que puede esperar ahora que es miembro. Los usuarios invitados que tienen una dirección de correo electrónico que pertenece a una cuenta profesional o educativa de Azure Active Directory u Office 365 pueden aceptar la invitación directamente. Si el invitado todavía no tiene una cuenta de Microsoft asociada con su dirección de correo electrónico, se le pedirá que cree una de forma gratuita. Tras aceptar la invitación, el invitado puede [participar en los equipos y los canales](https://support.office.com/article/teams-and-channels-df38ae23-8f85-46d3-b071-cb11b9de5499), recibir mensajes del canal y responder a ellos, [acceder a los archivos de los canales](https://support.office.com/article/access-files-in-channels-c593c78a-27c4-4661-a598-682baa30ca7e), participar en el chat, unirse a reuniones, colaborar en documentos, etc. 
