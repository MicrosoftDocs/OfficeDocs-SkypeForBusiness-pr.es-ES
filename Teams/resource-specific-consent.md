...
Al bloquear o permitir una aplicación en la página [Administrar](manage-apps.md#allow-and-block-apps) aplicaciones, esa aplicación se bloquea o se permite para todos los usuarios de la organización. Los propietarios de equipos solo pueden dar su consentimiento a una aplicación si se permite. Para permitir o bloquear una aplicación en el nivel de la organización, haga lo siguiente:
