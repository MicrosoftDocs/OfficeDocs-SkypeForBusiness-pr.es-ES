...
| ![Un icono que muestra los pasos siguientes](../media/audio_conferencing_image9.png)<br/>Siguientes pasos|<ul><li>Comience a planificar la implementación y la configuración de la barra de colaboración.</li></ul>|
...
Si necesita recibir o hacer llamadas a un número de teléfono externo o desde él, también necesitará un sistema telefónico Microsoft 365 o una licencia de voz empresarial de Microsoft 365.
...
| ![Un icono que muestra los pasos siguientes](../media/audio_conferencing_image9.png)<br/>Siguientes pasos|<ul><li>Comience a planificar la implementación del dispositivo.</li></ul>|
...
| ![Un icono que muestra los pasos siguientes](../media/audio_conferencing_image9.png)<br/>Siguientes pasos|<ul><li>Inicie las pruebas del dispositivo.</li></ul>|
