...
ms.locfileid: "63503937"
---
# <a name="manage-microsoft-teams-device-tags"></a>Administrar Microsoft Teams etiquetas de dispositivo

Las etiquetas de dispositivo Microsoft Teams permiten agrupar, organizar y administrar con mayor facilidad los dispositivos que ha implementado en su organización. Con el centro de administración de Microsoft Teams, puede agregar una o más etiquetas a los dispositivos, usar filtros para ver dispositivos que coincidan con la etiqueta que especifique y, después, realizar acciones en los dispositivos que tengan esa etiqueta.

Puede agregar una etiqueta de dispositivo a más de un tipo de dispositivo. Sin embargo, al abrir un panel de dispositivos en el centro de administración, solo se devuelven los dispositivos de ese tipo. Por ejemplo, puede asignar la etiqueta "Corporativo" a teléfonos y Salas de Teams dispositivos. Si busca la etiqueta "Corporativo" mientras está en **dispositivos Teams,** >  solo se devuelven teléfonos. De forma similar, si busca la etiqueta "Corporativo" en **Teams dispositivos** >  **Salas de Teams**, solo se devuelven Salas de Teams dispositivos.

Para administrar etiquetas de dispositivo, debe ser administrador global, administrador Teams servicio o administrador Teams dispositivo. Para obtener más información sobre los roles de administrador, vea [Usar Microsoft Teams de administrador para administrar Teams](../using-admin-roles.md).
...
2. Vaya a **Teams dispositivos** y, a continuación, elija cualquier panel de dispositivo, como **Teléfonos**.
...
5. Para quitar una etiqueta de dispositivo, seleccione los puntos suspensivos **...** junto a la etiqueta de dispositivo que desea quitar y seleccione **Eliminar**.
    > [!NOTE]
    > Si intenta quitar una etiqueta de dispositivo que se ha agregado a los dispositivos, recibirá un mensaje que le preguntará si desea quitarla de todos los dispositivos. Si desea hacer esto y seguir quitando la etiqueta del dispositivo, seleccione **Desatag dispositivos**.
6. Para cambiar el nombre de una etiqueta de dispositivo, seleccione los puntos suspensivos **...** junto a la etiqueta de dispositivo a la que desea cambiar el nombre y seleccione **Editar**. Proporcione un nuevo valor para la etiqueta del dispositivo y seleccione el **icono** Guardar.
...
1. Inicie sesión en Microsoft Teams de administración visitando https://admin.teams.microsoft.com.
2. Vaya a **Teams dispositivos** y, a continuación, elija el panel de dispositivo que contiene el dispositivo en el que desea agregar o quitar etiquetas.
...
4. Si desea agregar una etiqueta:
    ...
    3. Si la etiqueta no existe, seleccione **Agregar "\<tag name>" como una etiqueta nueva**. Las etiquetas pueden tener hasta 25 caracteres.
...
1. Inicie sesión en Microsoft Teams de administración visitando https://admin.teams.microsoft.com.
2. Vaya a **Teams dispositivos** y, a continuación, elija el panel de dispositivos que contiene los dispositivos en los que desea agregar o quitar etiquetas.
...
4. Si desea agregar una etiqueta:
    ...
    2. Si la etiqueta ya existe, selecciónelo en la lista de etiquetas que se devuelven.
    3. Si la etiqueta no existe, seleccione **Agregar "\<tag name>" como una etiqueta nueva**.
5. Si desea quitar una etiqueta:
    1. Expanda **Seleccionar Teams usuarios**.
...
1. Inicie sesión en Microsoft Teams de administración visitando https://admin.teams.microsoft.com.
2. Vaya a **Teams dispositivos** y, a continuación, elija el panel de dispositivos que contiene los dispositivos que desea filtrar.
3. Seleccione el **icono Filtro** .
4. Si solo desea especificar una sola etiqueta o si desea buscar dispositivos que tengan todas las etiquetas que especifique, seleccione Coincidir todas **estas condiciones**.
