...
---
<a name="environmental-discovery-for-a-microsoft-teams-rollout"></a>Detección ambiental para una implementación de Microsoft Teams
===================================================

La detección es uno de los primeros pasos clave que debe seguir al planear su viaje a Microsoft Teams.

Realice una detección detallada de su entorno para comprender mejor su estado actual y para revelar cualquier dificultad o, incluso más, posibles bloqueadores para la ejecución de su implementación de Teams.

## <a name="discovery-questionnaire"></a>Cuestionario de la detección

El cuestionario de ejemplo que se muestra a continuación le guiará por un conjunto de preguntas para confirmar que su organización está lista para la implementación correcta de audioconferencias y sistema telefónico con capacidades de planes de llamadas en Teams.

Todos los asuntos relacionados con su infraestructura de colaboración existente y la organización de Microsoft 365 u Office 365, las redes, los puntos de conexión, las operaciones y la adopción y preparación se incluyen como parte del cuestionario de detección ambiental.

El cuestionario se divide en varias secciones para confirmar la preparación de su organización para la implementación de Teams en varias áreas principales. Trabaje con el equipo del proyecto para proporcionar la información solicitada con la mayor cantidad de detalles posible para facilitar sus actividades de planificación.

> [!TIP]
> Para empezar, copie el cuestionario en un documento de Microsoft Word. Intenta responder a todas las preguntas y capturar todos los detalles a medida que avanzas.

<a name="project-team"></a>Equipo del proyecto
---

Capture información detallada sobre las partes interesadas clave de su proyecto de implementación de Teams. Tenga en cuenta que una persona puede desempeñar varios roles en todo el proyecto.
...
> |---|---|---|
> | Nota de la producción de Microsoft 365<br/>o el nombre e id. de la organización de Office 365<br/>en la columna Responder. Si tienes más<br/>que un inquilino asociado con<br/>su organización, anote todos los IDs. | Nombre del inquilino: <br/>Id. de inquilino:| |
...
> | Si actualmente mantiene un Microsoft 365 activo<br/>o inquilino de Office 365, es el dominio SMTP/SIP de <br/>los usuarios dirigidos asociados con el inquilino? | <input type="checkbox"> N/A: sin Microsoft 365 o<br/>&nbsp;&nbsp; &nbsp; Inquilino de Office 365 en su lugar <br/> <input type="checkbox"> No, SMTP/SIP de los usuarios <br/>&nbsp;&nbsp; &nbsp; dominio no está asociado <br/>&nbsp;&nbsp; &nbsp; con todos los inquilinos en <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 u Office 365<br/> <input type="checkbox"> Sí, SMTP/SIP de los usuarios <br/>&nbsp;&nbsp; &nbsp; dominio está asociado <br/>&nbsp;&nbsp; &nbsp; con un inquilino existente en <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 u Office 365 | |
...
> | ¿OneDrive para la Empresa está implementado? | <input type="checkbox"> Sí <br/> <input type="checkbox"> No | |
...
> | ¿Está planeando mover usuarios de estos terceros? <br/>¿Plataformas a Teams? | <input type="checkbox"> Sí <br/> <input type="checkbox"> No | |
...
Si procede, capture los detalles de su implementación de Skype Empresarial con la tabla de ejemplo siguiente. Si no ha implementado Skype Empresarial local, omita esta sección.

> | Pregunta | Respuesta | Comentarios |
> |---|---|---|
> | Qué versiones de Lync o Skype Empresarial <br/> actualmente están implementados localmente? | <input type="checkbox"> Lync Server 2010 <br/> <input type="checkbox"> Lync Server 2013 <br/> <input type="checkbox"> Skype Empresarial Server 2015 <br/> <input type="checkbox"> Skype Empresarial Server 2019 <br/><input type="checkbox"> Skype Empresarial Cloud Connector <br/>&nbsp;&nbsp; &nbsp; Edición | |
...
Use la tabla siguiente para capturar los detalles de red de su organización y cómo los usuarios están (o estarán) conectados a los servicios de Microsoft 365 y Office 365.

> | Pregunta | Respuesta | Comentarios |
> |---|---|---|
> | Cómo hacerlo (o cómo lo hará) los usuarios en el ámbito de la migración <br/>¿Tiene acceso a Teams cuando están en la oficina? <br/>Seleccione todas las que se apliquen. | <input type="checkbox"> Conexión NAT enrutada <br/> <input type="checkbox"> Servidor proxy <br/> <input type="checkbox"> Información Wi-Fi <br/> <input type="checkbox"> Administración (no pública) Wi-Fi <br/> <input type="checkbox"> ExpressRoute <br/>&nbsp;&nbsp; &nbsp; (emparejamiento de Microsoft) ||
> | Si el acceso a Microsoft 365 u Office 365 es a través de un<br/>servidor proxy, ¿hay alguna forma de omitir el proxy? | <input type="checkbox"> Sí <br/> <input type="checkbox"> No | |
...
> | Pregunta | Respuesta | Comentarios |
> |---|---|---|
> | ¿Cuál es el modelo de operaciones de Lync Server? <br/>Skype Empresarial Server, implementación de Microsoft 365, <br/>o la implementación de Office 365 hoy? | | |
> | ¿Puede esquematear la disposición de soporte técnico actual para <br/>Lync Server, Skype Empresarial Server, Microsoft 365, <br/>u Office 365? | | |
...
> | ¿Cómo supervisa su Lync Server, Skype para <br/>Business Server, implementación de Microsoft 365 o <br/>¿Implementación de Office 365? | | |
...
> | ¿Qué porcentaje de la base de usuarios diría que tiene? <br/>¿Ha adoptado Skype Empresarial? | | |
