...
- **Riverbed,** el estándar del sector en optimización de la red, está ampliando sus soluciones de aceleración a Microsoft Teams y Stream.  Ahora los clientes de Microsoft 365 pueden acelerar el tráfico de 365 con confianza, incluidos Teams y Stream, junto con una amplia variedad de otros servicios SaaS empresariales líderes para aumentar la productividad de los empleados desde cualquier lugar. Teams y aceleración de transmisiones se pueden habilitar con una configuración sencilla que cuenta con toda la garantía del soporte de primera clase de Riverbed y la inversión continua.
