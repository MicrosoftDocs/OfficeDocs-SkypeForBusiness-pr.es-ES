...
ms.locfileid: "34300692"
---
# <a name="toll-free-dialing-restrictions-in-ecuador"></a>Restricciones de marcado de número gratuito en Ecuador
...
|Código ISO de país o región  <br/> |EC  <br/> |
|Isla/territorio cubierta  <br/> |No aplicable  <br/> |
|Isla/territorio no cubierto  <br/> | Sin acceso de Cuenca (Etapa). <br/> |
|Disponibilidad de línea fija/por cable  <br/> | Solo de Pacifictel. <br/> |
|Disponibilidad de red móvil  <br/> |No  <br/> |
|Comentarios, restricciones y problemas de acceso  <br/> | Acceso solo desde la red de Pacifictel. <br/> |
