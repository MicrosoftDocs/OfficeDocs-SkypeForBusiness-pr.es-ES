...
## <a name="data-latency-any-aa--cq-analytics"></a>Latencia de datos de todos los análisis de AA & CQ
...
|AACallFlow                              |tipo                   |Encapsula los distintos Estados de una llamada de operador automático<br> abs_search<br> call_termination<br> call_transfer<br> main_menu<br> user_selection<br> speech_input_confirmation<br> first_level_menu<br> automatic_menu<br>Aviso |
...
|AADirectorySearchMethod                 |tipo                   |Método de búsqueda usado en la llamada:<br> abs_search_dtmf<br> abs_search_extension<br> abs_search_name<br>Hora de llamada de cadena de AAStartTime en UTC      |
|AATransferAction                        |tipo                   |Destinatario de la llamada:<br> desconocido: no se especificó el tipo de entidad<br>usuario de -entidad usuario<br> AA-entidad de operador automático organizacional<br> CQ-entidad de cola de llamadas<br>aplicación : entidad de la aplicación de voz<br> external_pstn-entidad RTC externa<br>shared_voicemail entidad de buzón de voz compartido      |
|PSTNMinutes                             |int                      |Uso total de minutos                          |
|Resultado de la llamada a la cola de llamadas                  |tipo                   |Estado final de llamada de cola de llamadas<br>valores posibles:<br>error de <br> rechazada<br>desbordamiento de <br>error de <br> timed_out<br> transferred_to_agent<br>agent_joined_conference    |
|Identidad de la cola de llamadas                     |tipo                   |Nombre de la cuenta de recursos adjuntada a CQ     |
|Tipo de destino de cola de llamadas                  |tipo                   |Tipo de destino de redirección de llamadas esperado:<br>usuario de <br>Extremo de la aplicación <br> otros     |
|Resultado de la llamada a la cola de llamadas                  |tipo                   |Estado final de llamada de cola de llamadas<br>valores posibles:<br>error de <br> rechazada<br>desbordamiento de <br>error de <br> timed_out<br> transferred_to_agent<br>agent_joined_conference           |
|Acción de estado final de cola de llamadas           |tipo                   |Acción final de cola de llamadas<br>valores posibles:<br>reenviar <br> Disconnect<br>buzón de voz de <br> disconnect_with_busy<br> shared_voicemail<br> failed_to_accept_call<br>otros             |
