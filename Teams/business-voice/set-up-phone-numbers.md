---
title: Configurar Microsoft 365 Teams Teléfono con plan de llamadas con números de teléfono
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: Obtenga información sobre cómo configurar Microsoft 365 Teams Teléfono con números de teléfono del Plan de llamadas para usuarios y servicios de su organización.
appliesto:
- Microsoft Teams
...
---
# <a name="step-2-set-up-teams-phone-phone-numbers"></a>Paso 2: Configurar Teams Teléfono números de teléfono
...
4. En la página Ubicación y cantidad, haga lo siguiente:
    ...
    3. En **Cantidad**, seleccione **1**.
        > [!NOTE]
        > Si recibe el mensaje No tiene licencias **suficientes** para solicitar más números de este tipo, asegúrese de que ha comprado Teams Teléfono con licencias del Plan de llamadas. Para obtener más información, vea ¿Qué necesito comprar para obtener capacidades [de voz para mi pequeña o mediana empresa?](whats-business-voice.md).
