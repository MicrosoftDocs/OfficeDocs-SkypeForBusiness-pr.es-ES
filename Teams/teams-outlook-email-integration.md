...
> [!NOTE]
> Esta característica no es compatible con Outlook para Mac ni con algunas versiones anteriores de Outlook para Windows. Para obtener más información, consulte [mensajes accionables en grupos de Outlook y Office 365](https://docs.microsoft.com/outlook/actionable-messages/).
