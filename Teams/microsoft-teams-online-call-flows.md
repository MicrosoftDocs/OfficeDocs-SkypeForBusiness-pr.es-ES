...
- **Fondo**. Proporciona información básica como redes que los flujos de Office 365 pueden atravesar, tipos de tráfico, guía de conectividad de la red del cliente a Office 365 puntos de conexión de servicio, interoperabilidad con componentes de terceros y principios que se usan por equipos para seleccionar los flujos de medios.
...
- Una conferencia de Microsoft Teams está hospedada en Office 365 en la misma región en la que se unió el primer participante. (Tenga en cuenta que si hay excepciones a esta regla en algunas topologías, se describen en este documento y se muestra un flujo de llamada adecuado).
...
1. El usuario A de Teams a envía una "invitación" con candidatos de hielo usando el flujo 4 a Office 365.
1. Office 365 envía una notificación al usuario de Teams B con Flow 4.
...
1. Los usuarios de Teams envían telemetría a Office 365 con Flow 4.
...
- Los medios directos con usuarios móviles remotos (no retransmitidos a través de Office 365) son opcionales. En otras palabras, el cliente puede bloquear esta ruta de acceso para exigir una ruta de medios a través de la retransmisión de transporte en Office 365.
...
La señalización entre la red privada para la red del cliente está usando el flujo 2. La señalización entre la red del cliente y Office 365 está usando el flujo 4. Sin embargo, los elementos multimedia omiten la red privada virtual y se enrutan mediante los flujos 3 y 4 a teams media Relay en Office 365.
...
La señalización entre la red privada para la red del cliente está usando el flujo 2. La señalización entre la red del cliente y Office 365 está usando el flujo 4. Sin embargo, los elementos multimedia omiten la VPN y se enrutan mediante el flujo 2 desde la red del cliente a Internet.
...
La señalización entre el usuario de VPN y la red del cliente está usando el flujo 2 y usa el flujo 4 a Office 365. Sin embargo, los elementos multimedia omiten VPN y se enrutan mediante el flujo 6.
...
- En este caso, los medios se retransmiten a través de Teams transmisiones en Office 365 a la red del cliente y al cliente de Skype empresarial remoto con Flow 4.
...
La señalización entre equipos y Skype empresarial está unida por una puerta de enlace en Office 365. Sin embargo, los medios se enrutan directamente de punto a punto dentro de la red del cliente usando el flujo 5.
...
1. El usuario de Teams de la red del cliente envía "invitar" con candidatos de hielo usando el flujo 1 a Office 365.
1. Office 365 envía una notificación al usuario de equipos externos que usa el flujo 3.
...
1. Los usuarios de Teams envían telemetría a Office 365 con los flujos 1 y 3.
