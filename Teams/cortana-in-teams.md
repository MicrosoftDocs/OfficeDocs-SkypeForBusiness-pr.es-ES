...
Cortana _Pulsar para hablar_ está habilitado de forma predeterminada si la sala está configurada con cualquiera de los siguientes idiomas: en-au (Australia), en-ca (Canadá), en-gb (Reino Unido), en-in (India), en-us (Estados Unidos). [Aprende más.](/MicrosoftTeams/rooms/console#to-apply-your-desired-language) Cortana icono desplazará el botón _Presentar_ en el menú _Más..._ de la consola de la sala Teams. Para deshabilitar Cortana _Usar Push to talk_ con PowerShell.[ Aprende más.](/powershell/module/skype/new-csteamscortanapolicy?view=skype-ps#example-1)
