...
|Microsoft Edge (basado en Chromium), la versión más reciente y las dos versiones anteriores     | Totalmente compatible con audio y uso compartido <br><br>No es compatible con vídeo entrante ni saliente (próximamente)    |Completamente compatible         |
|La última versión de Google Chrome y las dos versiones anteriores       |Totalmente compatible con audio y uso compartido <br><br>No es compatible con vídeo entrante ni saliente (próximamente) |Completamente compatible <br> <br>Compatible con uso compartido sin complementos ni extensiones a partir de la versión 72 de Chrome.       |
