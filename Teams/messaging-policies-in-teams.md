...
- **Los usuarios pueden editar los mensajes enviados** Use esta opción para permitir a los usuarios editar sus mensajes que se envían en la conversación.
...
- **Clasificación de contenido Giphy** 
    - **Sin restricción** Esto significa que los usuarios podrán insertar todos los Giphys en los chats.
    - **Moderado**  Esto significa que los usuarios será capaz de insertar solo 
    - **Estricto**
