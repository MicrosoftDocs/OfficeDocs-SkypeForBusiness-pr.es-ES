...
ms.locfileid: "33902729"
---
# <a name="adopt-microsoft-teams"></a>Adoptar Microsoft Teams

Si está una empresa pequeña, o si desea desplegar chat a partir de los equipos, los canales de & de los equipos y las reuniones, usan nuestro descriptiva [obtener iniciado instrucciones](get-started-with-teams-quick-start.md), que se ha diseñado para ayudarle a trabajar rápidamente. Si es una organización grande con un híbrido o local Skype para configuración de negocio, o si desea implantar las características de voz (por ejemplo, una llamada a planes o sistema telefónico de Office 365), puede iniciar con nuestra guía de introducción, pero necesita adicionales orientación a continuación, en **más profunda instrucciones de adopción**.
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Le guiará a través de los escenarios más comunes de adopción</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a los equipos y canales</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Planee los equipos de primera</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Permitir que los Campeones</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Certificación de & de recursos de aprendizaje</h3>
                    </div>
                </div>
            </div>
        </div>
...
### <a name="deeper-adoption-guidance"></a>Instrucciones de adopción más profunda
Planes de adopción pueden ser simples a complejos, dependiendo de su entorno. Para las implementaciones a gran escala, paso a través de las instrucciones siguientes para asegurarse de que su organización tiene una transición sin problemas a los equipos.
