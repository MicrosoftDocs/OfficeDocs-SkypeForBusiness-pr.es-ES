...
Estos son los Microsoft 365 y Office 365 para Skype Empresarial y Microsoft Teams disponibles para Austria.
...
|¿Los números de teléfono se asignan automáticamente para la audioconferencia?  <br/> |Sí, para:<br/><ul><li>Viena </ul>Si desea números de teléfono dedicados, vea [Obtener números de teléfono de servicio](../getting-service-phone-numbers.md).  <br/> |
