...
|¿Se asignan números de teléfono automáticamente para las audioconferencias?  <br/> |Sí, para:<br/><ul><li> Karachi</ul>Si desea números de teléfono dedicados, consulte [Obtener números de teléfono de servicio para Skype Empresarial y Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
