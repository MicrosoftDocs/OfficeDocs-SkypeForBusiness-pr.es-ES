...
---
# <a name="availability-in-romania"></a>Disponibilidad en Rumania
...
Estos son los Microsoft 365 y Office 365 para Skype Empresarial y Microsoft Teams disponibles para Rumania.
...
|¿Se asignan números de teléfono automáticamente para las audioconferencias?  <br/> |Los números de teléfono no se vinculan a una ciudad o ubicación específica. Si desea números de teléfono dedicados, consulte [Obtener números de teléfono de servicio para Skype Empresarial y Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
...
|Minutos disponibles para planes de llamadas. |Hay cuatro opciones de planes disponibles por mes del calendario: <ul><li>Plan de llamadas nacionales de 120 minutos </li><li>Plan de llamadas nacionales de 240 minutos</li></li><li>Plan de llamadas nacionales de 1200 minutos </li></li><li>Plan de llamadas nacionales e internacionales: 1200 minutos de llamadas nacionales -O- 600 minutos de llamadas internacionales (lo que se alcance primero en el mes calendario)</li></li></ul>Soporte de accesibilidad para Microsoft Teams [Prezentare generală accesibilitate a Microsoft Teams - Asistență Office](https://support.microsoft.com/ro-ro/office/prezentare-general%C4%83-accesibilitate-a-microsoft-teams-2d4009e7-1300-4766-87e8-7a217496c3d5?ui=ro-RO&rs=ro-RO&ad=RO)<br>[MicrosoftOnlineServicesTerms(WW)(Rumano)(febrero de 2021)](https://www.microsoft.com/licensing/terms/productoffering/AudioServices/EAEAS#GeneralServiceTerms)|
...
|**Característica**|**Detalles**|
|:-----|:-----|
|¿Para qué capitales o principales ciudades se pueden conseguir números de pago?  <br/> | Los números de teléfono no se vinculan a una ciudad o ubicación específica. <br/> |
