...
# [Carteles de soluciones de arquitectura y telefonía](teams-architecture-solutions-posters.md)  
...
<!-- ============================================================ -->
# Introducción
## [Información general](get-started-with-teams-quick-start.md)
...
## [Paso 4: Planear la implementación en toda la organización](get-started-with-teams-resources-for-org-wide-rollout.md)

<!-- ============================================================ -->

# Chat, equipos y canales
...
## [Información general de los canales privados](private-channels.md)
## [Administrar el ciclo de vida de los canales privados](private-channels-life-cycle-management.md)
...
## [Ver análisis en Teams](teams-analytics-and-reports/view-analytics.md)
...
### [Crear una plantilla a partir de una plantilla ya existente](create-template-from-existing-template.md)
### [Plantillas de Teams de la categoría financiera](financial-teams-templates-in-the-admin-console.md)
### [Plantillas de Teams de la categoría general](general-teams-templates-in-the-admin-console.md)
### [Plantillas de Teams de la categoría de fabricación](manufacturing-teams-templates-in-the-admin-console.md)
...
#### [Informe de uso de aplicaciones de Teams](teams-analytics-and-reports/app-usage-report.md)
...
### [Información general](rooms/index.md)
### Plan
#### [Información general sobre la planeación de salas de Microsoft Teams](rooms/rooms-plan.md)
#### [Soporte de versión](rooms/rooms-lifecycle-support.md)
#### [Notas de la versión](rooms/rooms-release-note.md)
#### [Preparar el entorno](rooms/rooms-prep.md)
#### [Requisitos](rooms/requirements.md) 
#### [Licencias en línea](rooms/rooms-licensing.md)
#### [Administración del plan con Azure Monitor](rooms/azure-monitor-plan.md)
#### Servicio de administración de salas de Microsoft Teams
##### [Administración de planes con el servicio administrado de salas de Microsoft Teams](rooms/microsoft-teams-rooms-premium.md)
##### [Control de acceso basado en roles con el servicio de administración de salas de Microsoft Teams](rooms/microsoft-teams-rooms-premium-rbac.md)
### Implementar
...
#### [Con Exchange local (híbrido)](rooms/with-exchange-on-premises.md)
#### [Configurar una consola](rooms/console.md)
#### [Configurar la autenticación](rooms/rooms-authentication.md)
#### [Unirse a reuniones de terceros](rooms/third-party-join.md)
#### [Mediante Microsoft Endpoint Configuration Manager](rooms/rooms-scale.md)
#### [Administración con Azure Monitor](rooms/azure-monitor-deploy.md)
#### [Migrar SRS v1 o LRS](rooms/lrs-migration.md)
#### [Cámaras de contenido](rooms/content-camera.md)
### Manage
#### [Introducción a la administración](rooms/rooms-manage.md)
#### [Mantenimiento y funcionamiento](rooms/rooms-operations.md)
#### [Soporte para Teams en la organización](rooms/known-issues.md)
#### [Dispositivos con Azure Monitor](rooms/azure-monitor-manage.md)
#### [Configuración con un archivo XML](rooms/xml-config-file.md)
#### [Usar la herramienta de recuperación](rooms/recovery-tool.md)
...
## [Obtener un informe de asistencia a reuniones](teams-analytics-and-reports/meeting-attendance-report.md)
...
## Audioconferencia
### [Planear la implementación](deploy-audio-conferencing-teams-landing-page.md)

### [Audioconferencia en Microsoft 365](audio-conferencing-in-office-365.md)
### [Abrir vista previa: Conferencia en red para Audioconferencia](audio-conferencing-on-network.md)
...
### [Probar o comprar Audioconferencia en Microsoft 365](try-or-purchase-audio-conferencing-in-office-365-for-teams.md)
...
#### [Establecer los idiomas del operador automático para Audioconferencia](set-auto-attendant-languages-for-audio-conferencing-in-teams.md)
#### [Configurar la confirmación de acceso telefónico a las reuniones para los usuarios](set-up-meeting-dial-out-confirmation.md)
...
### Administrar la configuración de Audioconferencia para los usuarios

#### [Información general](manage-the-audio-conferencing-settings-for-a-user-in-teams.md)
...
#### [Consultar y restablecer un Id. de conferencia asignado a un usuario](see-change-and-reset-a-conference-id-assigned-to-a-user-in-teams.md)
...
### Administrar la configuración de las reuniones para Audioconferencias
...
### [Disponibilidad de país y región para las audioconferencias](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
...
#### [Zonas de países y regiones para las audioconferencias](audio-conferencing-zones.md)
#### [Videos: Audioconferencia en Microsoft Teams](audio-conferencing-videos.md)
...
### [Configuración del teclado de marcado](dial-pad-configuration.md)
...
### [Minutos extendidos para llamadas en EE. UU. y Canadá](dial-out-minutes-canada-us.md)
### [Configurar planes de llamadas para su organización](set-up-calling-plans.md)
### [Guía de inicio rápido: Configurar Planes de llamadas](configuring-teams-calling-quickstartguide.md)
### [Disponibilidad de país y región para los planes de llamadas](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
...
#### [Información general](direct-routing-configure.md)
#### [Paso 1: conectar SBC](direct-routing-connect-the-sbc.md)
#### [Paso 2: habilitar usuarios](direct-routing-enable-users.md)
#### [Paso 3: configurar el enrutamiento de voz](direct-routing-voice-routing.md)
#### [Paso 4: convertir números de teléfono](direct-routing-translate-numbers.md)
#### [Configurar un SBC para varios espacios empresariales](direct-routing-sbc-multiple-tenants.md)
...
#### Protocolos
##### [Definiciones y estándares RFC](direct-routing-protocols.md)
##### [Protocolo SIP](direct-routing-protocols-SIP.md)
##### [Protocolos multimedia](direct-routing-protocols-media.md)
...
#### [Etiquetas de llamadas de emergencia](emergency-calling-labels.md)
...
## Caso práctico de migración de voz de Contoso
### [Información general](voice-case-study-overview.md)
### [Plan de actualización de Microsoft Teams](voice-case-study-migration-plan.md)
### [Sistema telefónico](voice-case-study-phone-system.md)
### [Enrutamiento basado en la ubicación](voice-case-study-location-based-routing.md)
### [Llamadas de emergencia](voice-case-study-emergency-calling.md)
### [Audioconferencia](voice-case-study-audio-conferencing.md)
### [Operadores automáticos y colas de llamadas](voice-case-study-call-queues.md)
...
### Administrar los Créditos de comunicaciones
...
#### [Planificar la experiencia de mis usuarios](5-envision-plan-my-users-experience.md)
<!-- ============================================================ -->
...
## [Información general](adopt-microsoft-teams-landing-page.md) 
...
### [¿Hasta qué punto está preparada su organización para Microsoft Teams?](teams-adoption-assess-readiness.md)

## Fase 2: experimentación
### [Experimentar](teams-adoption-phase2-experiment.md)
...
### [Definir los resultados y el éxito](teams-adoption-define-outcomes.md)
...
### Planear el proyecto y los requisitos 
#### [Información general](upgrade-plan-journey.md)
...
#### [Comprender las opciones de conectividad RTC y del sistema telefónico](cloud-voice-landing-page.md)
...
#### [Evaluar el entorno](upgrade-plan-journey-evaluate-environment.md) 
#### [Preparar los servicios](upgrade-prepare-environment-prepare-service.md)

### Prepare a su organización para Teams
...
#### [Consideraciones para las organizaciones con Skype Empresarial local](upgrade-to-teams-on-prem-considerations.md)
...
#### [Consideraciones PSTN](upgrade-to-teams-on-prem-pstn-considerations.md)
...
## [Planear conectividad híbrida](https://docs.microsoft.com/SkypeForBusiness/hybrid/plan-hybrid-connectivity?toc=/SkypeForBusiness/sfbhybridtoc/toc.json)

## Configurar conectividad híbrida
### [Información general](https://docs.microsoft.com/SkypeForBusiness/hybrid/configure-hybrid-connectivity)
### [Configurar Azure AD Connect para entornos híbridos](https://docs.microsoft.com/SkypeForBusiness/hybrid/configure-azure-ad-connect)
### [Configurar Skype Empresarial híbrido](https://docs.microsoft.com/SkypeForBusiness/hybrid/configure-federation-with-skype-for-business-online)

## Mover usuarios entre la implementación local y la nube
### [Información general](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-between-on-premises-and-cloud)
...
### [Mover usuarios locales a Skype para empresas Online](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-from-on-premises-to-skype-for-business-online)
### [Mover usuarios de la nube a local](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-from-the-cloud-to-on-premises)
...
## [Deshabilitar híbridos para completar la migración a la nube](https://docs.microsoft.com/SkypeForBusiness/hybrid/cloud-consolidation-disabling-hybrid)

## [Implementación del recurso de topología entre bosques](https://docs.microsoft.com/SkypeForBusiness/hybrid/configure-a-multi-forest-environment-for-hybrid)

## Consolidación de la nube para Teams y Skype Empresarial
### [Información general](https://docs.microsoft.com/SkypeForBusiness/hybrid/cloud-consolidation)
### [Actualizar el certificado de límite](https://docs.microsoft.com/SkypeForBusiness/hybrid/cloud-consolidation-edge-certificates)
### [Actualización de AAD Connect para incluir más de un bosque](https://docs.microsoft.com/SkypeForBusiness/hybrid/cloud-consolidation-aad-connect)

## [Integración con Exchange y SharePoint](https://docs.microsoft.com/SkypeForBusiness/skype-for-business-hybrid-solutions/integration-with-exchange-and-sharepoint)
...
### [Opciones de personalización](business-voice/customize-business-voice.md)
### [Números de teléfono de puertos](business-voice/port-phone-numbers.md)
### [Configurar los operadores automáticos](business-voice/set-up-auto-attendants.md)
### [Configurar directivas de llamadas](business-voice/set-up-policies.md)
### [Administrar los paquetes de directivas ](business-voice/policy-packages.md)
### [Crear usuarios adicionales](business-voice/create-users.md)
### [Configurar la cola de llamadas](business-voice/set-up-call-queues.md)

## Administrar la configuración
### [Crear un usuario o varios](business-voice/create-users.md)
### [Administrar dispositivos](business-voice/manage-devices.md)
### [Comprobar la calidad de la llamada](business-voice/monitor-quality.md)
### [Panel de calidad de llamadas](business-voice/analytics-dashboard.md)

## [Recursos de asociado](business-voice/partner-resources.md)
...
## Teams para sanidad
### [Introducción a Teams para las organizaciones de asistencia sanitaria ](expand-teams-across-your-org/healthcare/teams-in-hc.md)
### Visitas virtuales
#### [ Visitas virtuales con Teams: integración en EHR ](expand-teams-across-your-org/healthcare/ehr-admin.md)
#### [ Visitas virtuales con Reservas y Teams ](bookings-app-admin.md)
### [Ver y asignar paquetes de directivas](policy-packages-healthcare.md)
### Mensajería segura
#### [Mensajería segura](expand-teams-across-your-org/healthcare/messaging-policies-hc.md)
#### [Delegación de mensajes](expand-teams-across-your-org/healthcare/hc-delegates.md)
### Plantillas de Teams
#### [Usar las plantillas de asistencia sanitaria de Teams](expand-teams-across-your-org/healthcare/healthcare-templates-admin-console.md)
#### [Plantillas de asistencia sanitaria de Teams](expand-teams-across-your-org/healthcare/healthcare-templates.md)
### [Administrar la aplicación Listas](manage-lists-app.md)
### [Administrar la aplicación Tareas](manage-tasks-app.md)
### Turnos para Teams
#### [Turnos para Teams](expand-teams-across-your-org/shifts-for-teams-landing-page.md)
...
### [Introducción a Insights](class-insights.md)
...
### [Administrar el acceso de trabajadores de primera línea en función de sus turnos](expand-teams-across-your-org/shifts/manage-shift-based-access-flw.md)
...
### [Soporte técnico para trabajadores remotos (WFH)](expand-teams-across-your-org/GOV-support-remote-work-with-teams.md)
### [Introducción a las plantillas de Teams para Administración Pública](government-teams-templates-in-the-admin-console.md)
...
### [Audioconferencia con enrutamiento directo para GCC High y DoD](audio-conferencing-with-direct-routing-for-gcch-and-dod.md)
...
### [Experiencias conectadas opcionales](teams-privacy-oce-overview.md)
...
## [Problemas al recibir mensajes y llamadas en sistemas heredados](legacy-login-issues.md)
...
### [Plan para los grupos de Microsoft 365 cuando se crean equipos en Teams](plan-office-365-groups.md)
...
### [Obtener Teams para Android en China](get-teams-android-in-china.md)
### [Requisitos de hardware de la aplicación de Teams](hardware-requirements-for-the-teams-app.md)
### [Recomendaciones para el controlador del codificador y descodificador de hardware](hardware-decoders-and-encoders.md)
### [Instalar Teams con MSI](msi-deployment.md)
### [Activar Teams en su organización](Office-365-set-up.md)
### [Cómo usa Microsoft Teams la memoria](teams-memory-usage-perf.md)
### [Intervalos de direcciones IP y URL de Microsoft 365 y Office 365](office-365-urls-ip-address-ranges.md).
...
### [Opciones de licencia de complementos de Teams](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
### [Asignar licencias de complemento de equipo](teams-add-on-licensing/assign-teams-add-on-licenses.md)
...
### [Actualizar Microsoft Teams gratis a la versión de suscripción](upgrade-freemium.md)
### [Comunicaciones avanzadas](teams-add-on-licensing/advanced-communications.md)
...
### [Crear una cuenta de recurso de Microsoft 365 con el centro de administración de Microsoft 365](devices/resource-account-ui.md)
### [Mejorar los grupos de Microsoft 365 existentes con Teams](enhance-office-365-groups.md)
...
#### [Usar las reglas de flujo de correo con Exchange](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365)
...
### [Teams muestra](devices/teams-displays.md)
### [ Actualización de teléfonos de Teams a las muestras de Teams ](devices/upgrade-phones-to-displays.md)
### [Mostrar Teams y teléfonos de la implementación con Intune](devices/phones-displays-deploy.md)
...
### [Instalar PowerShell para Teams](teams-powershell-install.md)
### [Administrar Teams con el PowerShell para Teams](teams-powershell-managing-teams.md)
### [Notas de la versión de PowerShell para Teams](teams-powershell-release-notes.md)
### [Pasar del conector de Skype Empresarial Online al módulo de PowerShell para Teams ](teams-powershell-move-from-sfbo.md)
### [Referencia de cmdlet para Teams](https://docs.microsoft.com/powershell/module/teams/?view=teams-ps)
...
### [Argelia](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-algeria.md)
### [Antigua y Barbuda](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-antigua-and-barbuda.md)
...
### [Benín](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-benin.md)
### [Bermudas](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bermuda.md)
### [Bosnia y Herzegovina](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bosniaherzegovina.md)
...
### [Camboya](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-cambodia.md)
### [Camerún](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-cameroon.md)
### [Canadá](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-canada.md)
### [Islas Caimán](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-the-cayman-islands.md)
...
### [RAE de Hong Kong](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-hong-kong.md)
...
### [Macedonia del Norte](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-macedonia.md)
...
### [Marruecos](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-morocco.md)
...
### [Islas Marianas del Norte](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-northern-mariana-islands.md)
...
### [Rumania](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-romania.md)
### [Rusia](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-russia.md)
### [San Cristóbal y Nieves](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-saint-kitts-and-nevis.md)
### [Santa Lucía](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-saint-lucia.md)
...
### [Túnez](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-tunisia.md)
### [Turquía](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-turkey.md)
### [Islas Turcas y Caicos](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-turks-and-caicos-islands.md)
