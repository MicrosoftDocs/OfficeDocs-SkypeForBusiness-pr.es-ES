...
| El usuario inició una exportación | ExportInitiation | Los datos del paciente se exportaron desde la aplicación Pacientes a Excel archivo. El archivo se guardará en el sitio de sharepoint de grupo. |
