...
Los mensajes de correo electrónico contendrán información sobre tareas de la semana anterior y de la semana que viene, y se enviarán durante el fin de semana. Puede encontrar información sobre el contenido del correo electrónico aquí. Los administradores deben configurar y actualizar los mensajes de correo electrónico mediante [School Data Sync (SDS)](https://docs.microsoft.com/schooldatasync/). Esta característica rellena automáticamente las clases para equipos con listas de alumnos del sistema de información de estudiantes (SIS) del centro educativo. Los pasos para habilitar esta característica son:
