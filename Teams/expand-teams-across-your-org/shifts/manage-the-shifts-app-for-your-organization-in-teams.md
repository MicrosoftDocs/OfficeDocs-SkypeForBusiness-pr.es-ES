...
Turnos está habilitado de forma predeterminada para todos los usuarios de Teams en su organización. Puede desactivar o activar la aplicación en el [](../../manage-apps.md) nivel de organización en la página Administrar aplicaciones en el Centro de administración de Microsoft Teams.
