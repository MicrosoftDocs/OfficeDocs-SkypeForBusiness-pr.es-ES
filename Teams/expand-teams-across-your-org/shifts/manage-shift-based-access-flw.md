...
Esta característica le permite administrar el acceso a Teams cuando los Firstline Workers están fuera del turno. Puede configurar que Teams muestre un mensaje a los Firstline Workers si acceden a Teams cuando están fuera de su turno. Los Firstline Workers deben hacer **clic en Acepto** para aceptar el mensaje antes de que puedan usar Teams.
