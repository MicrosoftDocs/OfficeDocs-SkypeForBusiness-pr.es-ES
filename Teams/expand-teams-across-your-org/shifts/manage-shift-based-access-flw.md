...
> [!NOTE]
> Use el parámetro **ShiftNoticeMessageType** para establecer el mensaje que quiera mostrar. Para ver una lista de los mensajes predefinidos que puede elegir para este parámetro, vea New-TeamsShiftPolicy.
