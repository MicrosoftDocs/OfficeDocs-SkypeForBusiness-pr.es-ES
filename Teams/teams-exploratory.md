...
Los usuarios que no tengan una licencia de Office 365 que incluya Teams pueden activar la experiencia de Teams Exploratory Por ejemplo, si un usuario tiene Office 365 Empresa (que no incluye Teams), puede optar a la experiencia de Teams Exploratory
...
> [!NOTE]
> Si su organización no es apta para la experiencia de Teams Exploratory, no verá el conmutador **Dejar que los usuarios instalen aplicaciones y servicios de prueba**. 
...
Si un usuario está usando la experiencia Teams Exploratory, puede desactivarla eliminando la licencia o el plan de servicio.
...
Para actualizar a los usuarios de la licencia de Teams Exploratory, haga lo siguiente:
