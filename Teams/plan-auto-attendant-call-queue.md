...
- Un [número de teléfono De conexión de operador](operator-connect-plan.md) asignado
...
3. [Cree una cuenta de recursos](manage-resource-accounts.md) para cada operador automático y cola de llamadas que desee crear. Asigne a cada cuenta una licencia de cuenta de recursos de teléfono de Teams y, opcionalmente, un número de servicio.
