...
Debes ser [administrador global o administrador de facturación](https://support.office.com/article/da585eea-f576-4f55-a1e0-87090b6aaa9d) para realizar estos pasos.
...
1. Averigüe si **audioconferencia** está disponible en su país o región. [Disponibilidad de países y regiones para planes de llamadas y audioconferencias](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md).

2. Obtenga sus licencias de **Audioconferencia**. Si quiere:

   - **Pruébelo** antes de comprarlo: puede registrarse para obtener una prueba gratuita de Office 365 Enterprise E5 que incluya Audioconferencia. Vea la [versión de prueba de Office 365 Enterprise E5](https://portal.office.com/Signup?OfferId=101bde18-5ffb-4d79-a47b-f5b2c62525b3).

   - **Cómprelo**: consulte [Licencias complementarias de Microsoft Teams](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md).

3. [Asigne licencias a usuarios](/microsoft-365/admin/manage/assign-licenses-to-users) de su organización que vayan a programar o coordinar reuniones.

4. Si ha adquirido licencias de complementos de audioconferencia y licencias de créditos de comunicaciones, asígnelas también. Para obtener instrucciones, consulte [Asignar licencias de complementos de Microsoft Teams](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md).
...
1. Averigüe si **audioconferencia** está disponible en su país o región. [Disponibilidad de país y región para los planes de llamadas y audioconferencias](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md).
...
3. [Configure créditos de comunicaciones para su organización](set-up-communications-credits-for-your-organization.md) . Para configurar Créditos de comunicaciones, vea [¿Qué son los Créditos de comunicaciones?](what-are-communications-credits.md)
...
4. [Asigne licencias a usuarios](/microsoft-365/admin/manage/assign-licenses-to-users) de su organización que vayan a programar o coordinar reuniones.
...
3. [Establecer los idiomas del operador automático para las audioconferencias](set-auto-attendant-languages-for-audio-conferencing-in-teams.md) que el operador automático de Audioconferencia usa para saludar al autor de la llamada cuando llama a un número de teléfono de audioconferencia. Este paso solo se aplica si está usando Microsoft como su proveedor de servicios de audioconferencia.
