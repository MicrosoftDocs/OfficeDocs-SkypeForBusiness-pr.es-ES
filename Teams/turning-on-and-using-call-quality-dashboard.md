...
ms.locfileid: "69245740"
---
# <a name="set-up-the-call-quality-dashboard"></a>Configurar el panel de calidad de llamadas

Abra el panel de calidad de llamadas Microsoft (CQD) en [https://cqd.teams.microsoft.com](https://cqd.teams.microsoft.com) (inicie sesión con sus credenciales de administrador). O vaya al Centro de administración de Teams y seleccione **Análisis & informes** > **Panel de calidad de llamadas**.
...
En la página que se abre, haga clic **en Iniciar sesión** y escriba su cuenta de administrador global o Microsoft información de la cuenta de administrador de Teams. Después de iniciar sesión por primera vez, el CQD comenzará a recopilar y procesar datos. Tenga en cuenta que puede tardar una o más horas en procesar los datos suficientes para mostrar resultados significativos en los informes.
