...
En la página que se abre, haga clic en **Iniciar sesión** y escriba la información de su cuenta de administrador global o de la cuenta de administrador del servicio de Microsoft Teams. Después de la primera vez que inicie sesión, CQD empezará a recopilar y procesar datos. Tenga en cuenta que puede tardar una o más horas en procesar datos suficientes para mostrar resultados significativos en los informes.
...
Para obtener más información sobre estos roles, vea Acerca de los roles de [administrador de Office 365.](/office365/admin/add-users/about-admin-roles)
