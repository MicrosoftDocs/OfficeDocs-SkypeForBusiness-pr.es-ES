...
- Llamar desde una reunión de audioconferencia a su teléfono móvil con la aplicación de Microsoft Teams o skype empresarial instalada en destinos que aún no están incluidos en su suscripción.
    
- Marca cualquier número de teléfono internacional cuando tienes planes **de plan de llamadas** nacionales.
    
- Marque números de teléfono internacionales más allá de lo que se incluye en una suscripción al plan de llamadas nacionales **e internacionales.**
    
- Llama y paga por minuto una vez que has agotado tu asignación de minutos mensuales.
    
> [!NOTE]
> Las llamadas salientes a algunos destinos pueden incluirse en su suscripción de Audioconferencia. Comprueba la información de tu suscripción para obtener más información. 
  
> [!NOTE]
> Si tu organización se encuentra en una región diferente a la dirección de facturación de tu Contrato Enterprise (EA), es posible que no puedas comprar créditos de comunicaciones. Si no puedes adquirir créditos de comunicaciones, abre un incidente de soporte técnico desde el portal y trabajaremos contigo para mitigar este problema hasta que se haya obtenido una solución permanente. 
  
## <a name="what-are-the-communications-credits-rates"></a>¿Cuáles son las tarifas de créditos de comunicaciones?

Si quiere saber cuál es el coste de las [](https://go.microsoft.com/fwlink/p/?LinkId=799523) llamadas en los planes de llamadas, consulte Sistema telefónico basado en la nube para llamadas de voz (desplácese hacia abajo hasta "Vea las tarifas para ver dónde desea llamar").
...
Se recomienda que evalúe detenidamente el uso del servicio RTC de su organización para comprender la mejor configuración para los créditos de comunicaciones. Para obtener más información sobre los servicios RTC, lea preguntas comunes sobre Sistema telefónico, Planes de [llamadas](calling-plan-landing-page.md) y [Audioconferencia.](Audio-Conferencing-common-questions.md)
  
Puede configurar la facturación  del consumo con un pago  único del saldo de preventa O configurando una cantidad de recarga automática **(opción** **recomendada)** con un saldo mínimo que activará una compra para esa cantidad de recarga. Al principio, se recomienda establecer importes de recarga automática que le permitan controlar el uso real para establecer los límites de recarga automática que se ajusten a sus necesidades y patrones de uso. Los créditos de comunicaciones deben supervisarse a lo largo del tiempo y luego ajustar el saldo mínimo y las cantidades de recarga según sea necesario para adaptarse a las necesidades de cada organización.
  
> [!NOTE]
> Para ver los planes y precios, inicia sesión en el Centro de administración de [Microsoft 365](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) y ve a Agregar suscripciones de  >    >  **facturación.** 
...
Cada organización tendrá un uso diferente del volumen y las tarifas de los planes de llamadas para tener en cuenta. You will need to get this type of usage data from your current service provider. Para las organizaciones que ya usan Teams como su proveedor de servicios, puede obtener datos de uso si los revisa en el centro de administración de Microsoft Teams > **Analytics &** informa de informes de uso y, a continuación, selecciona Uso de  >  RTC. 
  
Al configurar los créditos de comunicaciones, deberás investigar el uso de las llamadas de tu organización para determinar los importes que deberás poner. Puede obtener información sobre el uso de llamadas si revisa el informe de uso de RTC. Este informe le permite exportar los registros de datos de llamadas a Excel y crear informes personalizados.

Las notificaciones importantes relacionadas con el saldo de créditos de comunicación de tu organización se enviarán a los siguientes administradores:
