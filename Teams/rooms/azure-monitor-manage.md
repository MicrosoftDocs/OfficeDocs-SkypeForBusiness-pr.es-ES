...
Las siguientes descripciones de eventos se insertan en el campo de descripción del registro de eventos cada cinco minutos, cuando la aplicación Salas de Microsoft Teams registra la información correspondiente en el registro de eventos Windows evento. El Microsoft Monitoring Agent pasa estos registros a Log Analytics en Azure Monitor, que los analiza en el panel que creó en Implementar Salas de Microsoft Teams supervisión con [Azure Monitor](azure-monitor-deploy.md). Con el panel, puede ver entradas de registro individuales para determinar los cursos de acción si es necesario.
