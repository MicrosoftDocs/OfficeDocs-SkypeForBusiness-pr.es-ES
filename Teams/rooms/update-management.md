...
![Captura de pantalla de las actualizaciones de los servicios administrados](../media/update-management-001.jpg)
...
| Estado | Descripción |
| :- | :- |
| Programado | Se programa una actualización para las salas de un anillo determinado. Tenga en cuenta que una actualización solo se mostrará Programada después de que la progresión llegue al anillo en el que se encuentra la sala. Por ejemplo, si una nueva actualización se encuentra en el anillo Ensayo, solo se mostrará Programada para salas en el anillo Ensayo. <p> Otros anillos tendrán el estado "No obligatorio" hasta que la actualización avance a ese anillo.</p> |
...
1. En **Anillo,** haga clic en **Cambiar.**  
...
1. Vaya a la **pestaña Anillos.**
1. Haga clic en el anillo para eliminar.  
