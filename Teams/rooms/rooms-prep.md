...
Consulte el [artículo Seguridad de](./security.md#network-security) red para obtener detalles completos sobre FQDN, puertos e intervalos de direcciones IP necesarios para salas de Microsoft Teams.
