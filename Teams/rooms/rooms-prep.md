...
3. En el **cuadro Windows** cuadro De búsqueda en la parte inferior izquierda de regedit (presione la pantalla larga o haga clic con el botón derecho y elija Ejecutar **como administrador).**
