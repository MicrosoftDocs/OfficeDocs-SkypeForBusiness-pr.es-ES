...
|**Servicio de asistencia al cliente**   |compatibilidad con vales de 24x7x365 a través del centro de operaciones de servicio Premium (SOC) de Microsoft Teams. Escalar en su nombre a otros proveedores principales, cuando corresponda. Para obtener más información, consulta [asistencia al cliente](#customer-support).|
...
Este es un resumen de las características importantes que el servicio de las salas Premium de Microsoft Teams ofrece para admitir las características mencionadas anteriormente.
...
|**Inscripción de salas**   |Incorporación fácil con la inscripción automática de dispositivos de la sala en el servicio de las salas Premium de Microsoft Teams.          |
...
|**Solución de problemas y corrección**     |Diagnósticos automáticos y corrección automática cuando corresponda. Microsoft Team salas Premium corrección de incidentes asistidos por SOC para casos no automatizados. Servicio de integración de ahora para coordinación de incidentes.         |
...
El servicio de las salas Premium de Microsoft Teams es compatible con un SOC Premium de Microsoft Teams. El modo principal para la comunicación de las salas de Microsoft Teams Premium SOC a los clientes es a través del portal Premium de Microsoft Teams. El SOC de Microsoft Team Rooms Premium proporciona la primera respuesta y el aumento adecuado en los vales que ha provocado el sistema o la organización.

|  |  |
|---------|---------|
|**Ámbito**   |Los incidentes relacionados con la aplicación de la sala de reuniones, los dispositivos de la sala y los periféricos se incluyen en el soporte Premium de Microsoft Teams.|
|**Numeroso**  |Solo operaciones de ti         |
|**Idiomas admitidos**    |Inglés         |
|**Disponibilidad de soporte técnico en el portal**   | Funcionamiento      |
|**Tiempo de respuesta inicial para las salas de Microsoft Teams Premium SOC**   |  4 horas       |
...
|**Redireccionamiento a soporte más amplio de Microsoft**   |Los problemas relacionados con otro producto de Microsoft fuera del ámbito de Microsoft Teams Room Premium se dirigen al equipo de soporte técnico correspondiente.         |
|**Redireccionamiento a compatibilidad con el fabricante de equipos originales (OEM)**    |Microsoft Teams Room Premium SOC trabaja para comprender el problema y, si corresponde, ayuda a coordinar el soporte técnico con el OEM. En algunos casos, es posible que sea responsable de participar directamente con su OEM.         |

Además, recuerde que las salas de SOC Premium de Microsoft Teams le ayudarán a realizar operaciones de TI en su organización y no reemplazan los servicios de soporte técnico para los usuarios finales.

Para obtener más información sobre la cobertura de soporte Premium de Microsoft Teams Rooms, consulte [support inclusiones and exclusiones](#support-inclusions-and-exclusions).

## <a name="supported-regions"></a>Regiones admitidas

Microsoft Teams, Premium, está disponible en los siguientes países y regiones.
...
|Los clientes reciben orientación para incorporar sus salas a estándares recomendados por Microsoft Teams Rooms Premium al momento de la incorporación    |Las investigaciones con respecto a las imágenes de software personalizadas internas o no conformes con la orientación de versión del software recomendada de Microsoft Teams Rooms Premium no están en el ámbito.          |         |

## <a name="data-collection"></a>Recopilación de datos

El servicio de salas Premium de Microsoft Teams vigila dispositivos, recopila datos de dispositivos y permite que Microsoft tenga acceso a los dispositivos de la sala y los administre de forma remota. El servicio de Microsoft Teams Photo Premium no tiene acceso al contenido en vivo de una reunión.
...
- [Microsoft Teams salas Premium](https://rooms.microsoft.com)
