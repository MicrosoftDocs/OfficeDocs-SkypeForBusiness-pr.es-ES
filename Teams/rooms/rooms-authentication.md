...
Para que microsoft Teams Rooms use la autenticación moderna con Skype Empresarial y Exchange, habilite la configuración del cliente para la autenticación moderna en el dispositivo Salas de Microsoft Teams. Puede hacerlo en la configuración del dispositivo o en el archivo de configuración XML.
...
Para aplicar la configuración, vea Administrar una configuración de consola de Salas de [Microsoft Teams de forma remota con un archivo de configuración XML.](xml-config-file.md)

## <a name="prepare-your-environment-for-modern-authentication"></a>Preparar el entorno para la autenticación moderna

Antes de empezar, asegúrese de comprender los modelos de identidad que se usarán con Office 365 y Azure AD. Puede encontrar más información en modelos de identidad de [Office 365](/Office365/Enterprise/about-office-365-identity) y Azure Active Directory y en Sincronización híbrida de identidades y directorios para [Microsoft 365 u Office 365.](/Office365/Enterprise/plan-for-directory-synchronization)
...
Le recomendamos que no quite directivas básicas de autenticación para Exchange Online ni deshabilite la autenticación básica para su inquilino hasta que haya validado que los dispositivos Microsoft Teams Rooms pueden iniciar sesión correctamente con Exchange Online, Teams y Skype Empresarial Online.
...
Para asegurarse de que la autenticación se realiza correctamente en su servidor de Exchange local o en el servidor de Skype Empresarial, debe asegurarse de que la cuenta de recursos que se usa con salas de Microsoft Teams está configurada para obtener autorización de Azure AD. 

Los flujos de autenticación de salas de Teams varían en función de la configuración de autenticación. Para los clientes que usan un dominio administrado, Teams Rooms usa credenciales de contraseña de propietario de recursos de [OAuth 2.0](/azure/active-directory/develop/v2-oauth-ropc) con Azure Active Directory. Sin embargo, para los clientes que usan un dominio federado, se usa el flujo de aserción del portador [SAML 2.0 de OAuth 2.0.](/azure/active-directory/develop/v2-saml-bearer-assertion)
...
Los requisitos previos para habilitar la autenticación moderna en la topología híbrida se tratan en Información general sobre autenticación moderna híbrida y [requisitos previos](/office365/enterprise/hybrid-modern-auth-overview)para usarlo con servidores locales de Skype Empresarial y Exchange. Se aplican todos los requisitos previos que se deba en el artículo.
...
- Debe tener Exchange Server CU8 de 2016 o posterior, o Exchange Server CU1 de 2019 o posterior.
...
- Microsoft Teams Rooms no admite la falta de coincidencia de SIP y UPN. Debe crear una cuenta de Salas de Microsoft Teams con el mismo UPN y SIP para que funcione.
...
Puede configurar una cuenta de recurso que se usa con Salas de Microsoft Teams para el acceso basado en ip/ubicación. Para obtener más información, vea [Acceso condicional: Bloquear el acceso por ubicación.](/azure/active-directory/conditional-access/howto-conditional-access-policy-location)

No se admiten otras directivas de acceso condicional. Para obtener más información sobre el cumplimiento de dispositivos, vea [Administrar salas de reuniones de Teams con Intune.](https://techcommunity.microsoft.com/t5/intune-customer-success/managing-teams-meeting-rooms-with-intune/ba-p/1069230)