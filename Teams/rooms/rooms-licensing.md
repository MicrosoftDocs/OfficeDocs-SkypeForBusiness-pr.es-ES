...
En la tabla siguiente se enumeran las características que están disponibles en salas de Microsoft Teams y las licencias que necesita comprar para obtenerlas.
  
> [!NOTE]
> La sala que se configura debe ser un objeto de usuario y disponer de las licencias asignadas.

|  | Tienes Microsoft Teams o Skype Empresarial Online <br/> Esto es lo que debe comprar:   |Tiene Skype Empresarial Server 2015/2019 (local o híbrido). <br/> Esto es lo que debe comprar:|
|:-----|:-----|:-----|
|Unirse a una reunión programada  | Microsoft Teams Rooms Standard o Premium  |Skype Empresarial Servidor Standard CAL  |
|Iniciar una reunión ad hoc | Microsoft Teams Rooms Standard o Premium  |Skype Empresarial Servidor Standard CAL  <br/> Skype Empresarial Servidor Enterprise CAL|
|Iniciar una reunión ad hoc y llamar desde una reunión a números de teléfono |  Microsoft Teams Rooms Standard o Premium |Skype Empresarial Standard CAL  <br/> Skype Empresarial Servidor Enterprise CAL|
...
|Administrar el dispositivo de salón con Microsoft Intune |Microsoft Teams Rooms Standard o Premium  |Suscripción a Microsoft Intune con [MDM local](https://docs.microsoft.com/configmgr/mdm/plan-design/plan-on-premises-mdm) |
|Servicios administrados de Salas de Microsoft Teams | Microsoft Teams Rooms Premium ||
| |||
