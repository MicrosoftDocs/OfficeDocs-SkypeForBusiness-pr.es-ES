...
ms.reviewer: ''
description: Guía que compara los dispositivos Teams para las características de espacios compartidos entre Windows y Android.
ms.collection:
- M365-voice
- M365-collaboration
...
Para ayudarle a guiarle en cuanto a las características disponibles en distintas plataformas, puede consultar el siguiente gráfico, que se actualizará periódicamente. No todas las características de Salas de Teams se incluirán en esta lista, por lo que deberás seguir consultando la [guía básica de Microsoft 365](https://www.microsoft.com/en-us/microsoft-365/roadmap) y los representantes de ventas de Microsoft para obtener detalles adicionales.    

## <a name="teams-devices-for-shared-spaces"></a>Teams dispositivos para espacios compartidos
...
||Unión directa de invitado |Disponible  |Próximamente |
...
||Cortana habilidades de voz |Disponible  |Próximamente |
...
||Sistema operativo |Windows 10  |Android 8.1 y posteriores |
||Características de seguridad del sistema operativo |TPM 2.0, deshabilitar puertos específicos, arranque seguro, Credential Guard, control de acceso de configuración OOBE, protección de acceso directo a la memoria, seguridad de red |Android cifrado de disco completo, características específicas del OEM |
...
||Actualizaciones automáticas de aplicaciones de Teams |Disponible  |Disponible |
