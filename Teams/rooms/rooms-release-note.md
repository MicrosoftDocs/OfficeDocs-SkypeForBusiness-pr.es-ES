...
Hay dos tipos de actualizaciones para Salas de Teams: actualizaciones de aplicaciones Salas de Teams y cliente web de Teams.

Salas de Teams las actualizaciones de las aplicaciones se realizan a través de la Tienda Microsoft o a través de [la actualización manual](manual-update.md). Novedades se aplican a la aplicación de Plataforma universal de Windows (UWP) que se instala localmente en el dispositivo.

Las actualizaciones del cliente web de Teams se realizan a través de los servicios de entrega de aplicaciones web de Teams. El cliente web de Teams es un servicio basado en la nube que no requiere una actualización de la aplicación local para UWP instalada en el dispositivo.

Para obtener más información sobre cómo se actualizan Las actualizaciones de Teams, consulte [Proceso de actualización de Teams](../teams-client-update.md)

Salas de Teams se rige por la directiva moderna de ciclo de vida. Para obtener más información, consulte [Proceso de actualización de Teams](../teams-client-update.md#servicing-agreement).
...
|4.11.17.0 |3/3/2022 |
|4.11.12.0 |1/24/2022 |
|Versión del cliente web de Teams | Diciembre de 2021 |
|Versión del cliente web de Teams | Octubre de 2021 |
|4.10.10.0 |10/1/2021 |
|4.9.12.0 |07/28/2021 |
|4.8.31.0 |05/12/2021 |
|4.8.25.0 |04/22/2021 |
...
- Mejora de las notificaciones en la reunión
- Chat de reunión en galería, galería grande y modo conferencia <sup>1</sup>
...
<sup>1</sup> La configuración de administrador para ocultar el chat de reuniones de todos los diseños de reunión a través de XML puede encontrarse en [Administrar una configuración de consola de Salas de Microsoft Teams de forma remota con un archivo de configuración XML](xml-config-file.md).

### <a name="414240-922022"></a>4.14.24.0 (9/2/2022)

Introducido en esta actualización:

- Actualización de la experiencia de diseño de la fila frontal
- Anclar y ocultar el vídeo de la sala
- Configuración de administrador para desactivar la galería dividida en la pantalla doble Salas de Teams <sup>1</sup>
- La pantalla dual Salas de Teams ahora puede mostrar hasta 18 secuencias de vídeo de participantes
- Soporte técnico para licencias de salas básicas de salas de Teams Salas de Microsoft Teams Pro y Microsoft Teams
...
- Cambia el número de versión para permitir que los sistemas afectados por Windows [KB5013942](https://support.microsoft.com/topic/may-10-2022-kb5013942-os-builds-19042-1706-19043-1706-and-19044-1706-60b51119-85be-4a34-9e21-8954f6749504) vuelvan a registrar la aplicación para que se pueda iniciar. No hay cambios funcionales en esta versión de la aplicación desde 4.1.2.138.0.

> [!NOTE]
> Para obtener más información, consulta "Salas de Teams aplicación no se inicia después de la actualización" en [Problemas conocidos en Salas de Teams y dispositivos](/microsoftteams/troubleshoot/teams-rooms-and-devices/rooms-known-issues).
...
Introducido en esta actualización:
- Los administradores de TI pueden inscribir un dispositivo de salas de Teams para recibir características de vista previa públicas a través de la configuración XML. Una vez inscrito, el dispositivo comenzará a recibir características beta. Todas las características que van a las pruebas beta se anuncian en [Microsoft versión preliminar pública de Teams - Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-teams-public-preview/bd-p/MicrosoftTeamsPublicPreview) <sup>1,2</sup>  
- El administrador de TI puede establecer la resolución de pantalla frontal de la sala y el escalado de forma remota a través de la configuración XML<sup>2</sup>
- El administrador de TI puede deshabilitar la supresión de ruido Microsoft mediante la configuración XML<sup>3</sup> 
- El administrador de TI puede invalidar la limpieza de la carpeta de descarga en el dispositivo mediante la configuración<sup>4</sup> de la clave del Registro
- Permitir a los usuarios unirse a reuniones de Teams hospedadas en otra nube (es decir, el cliente de GCCH puede unirse a reuniones de Teams hospedadas en la nube comercial y viceversa) 
- Las salas de Teams ahora bloquean el inicio del explorador Edge desde direcciones URL en PowerPoint Live como medida de seguridad adicional para salas de Teams con pantallas táctiles 
...
- Compatibilidad con Windows 10 versión de características 21H2 para salas de Teams   
- El nuevo punto de entrada de Cortana en la pantalla de inicio, el botón Compartir/presentar ha vuelto 

> <sup>1</sup> Puedes encontrar instrucciones para inscribir dispositivos MTR Windows de versión preliminar pública [aquí](../public-preview-doc-updates.md#enable-public-preview)
> 
...
- Administración establecer el diseño fila frontal como predeterminado  
- Reunirse ahora y llamar a la actualización de la aplicación solo para Teams, modos de cliente predeterminados<sup>de Teams 1,2</sup>
- Cambiar entre varias cámaras de vídeo en las reuniones de Teams<sup>1</sup> 
- Configuración predeterminada de la cámara de vídeo 
- Actualización del icono pulsar para hablar de Cortana en la consola MTR 
- Inclusión de licencias de Azure AD Premium 1 en sku estándar y premium 
- Las directivas de acceso condicional de AAD son compatibles con<sup>3</sup> 
- Activación por voz de Cortana habilitada de forma predeterminada en la OOBE
- Compatibilidad con los controles PTZ remotos<sup>4</sup>
...
> 
> <sup>2</sup> Las salas de Teams en Windows que se ejecutan en Microsoft Teams solo o Skype Empresarial y Microsoft Teams (predeterminado) se actualizan con las nuevas experiencias de reunión y llamada, pero otros modos no se ven afectados por esta actualización.
> 
...
> 
> <sup>4</sup> Esta característica requiere que los administradores de TI configuren la aplicación de controles PTZ remotos del cliente de escritorio de Teams.
> 
...
Introducido en esta actualización:
- Control de lista unificado con el cliente de escritorio de Teams con agrupación de reuniones estructuradas, opciones de reunión y controles para moderadores/asistentes, criterio de ordenación de levantar la mano y capacidad para invitar a usuarios desde chat o invitación de reunión directamente desde la lista 
...
- Destacar o anclar varios participantes en reuniones de Teams
...
- Compatibilidad con reacciones en las reuniones de Teams 
...
Introducido en esta actualización:
- El control remoto de sala permite a los usuarios controlar la funcionalidad básica de la sala con Teams en su dispositivo móvil *
...
- La galería grande y la compatibilidad con el modo conferencia ya están disponibles en GCC High
- Nuevas habilidades agregadas a Cortana, Agregar persona por nombre a la reunión y Llamar por nombre 
- Pulsar para hablar de Cortana está habilitado de manera predeterminada en todos los dispositivos. Para obtener más información, consulte [Asistencia por voz de Cortana en Teams](../cortana-in-teams.md).

> [!NOTE]
> Soporte técnico 19H1 obsoleto. La versión mínima del sistema operativo compatible con 4.10 es 19H2.

> [!NOTE]
> *Estas características se implementan con el servicio Teams y funcionarán con todas las versiones de la aplicación superiores a 4.9.

> [!NOTE]
> Para unirse a la reunión programada, tanto desde la aplicación móvil de Teams como desde MTR-W, busque la cuenta de sala en la lista de la aplicación Teams Mobile y pulse el menú "Controlar este salón" y puede controlar los controles de llamada desde la aplicación.

### <a name="49120-7282021"></a>4.9.12.0 (7/28/2021)

Introducido en esta actualización:
- Microsoft modo solo de Teams ya está disponible en la configuración de la aplicación, por lo que ya no es necesario configurar una cuenta de Skype Empresarial. En este modo, los dispositivos que hayan iniciado sesión en el modo solo teams se unen a Skype Empresarial reuniones como usuario invitado.
...
- Evite el audio activado en función de los permisos de audio cuando Salas de Teams se una como asistente. Para obtener más información, consulte [Administrar los permisos de audio de los asistentes en reuniones de Teams](https://support.microsoft.com/office/manage-attendee-audio-permissions-in-teams-meetings-f9db15e1-f46f-46da-95c6-34f9f39e671a).
- Destacar el vídeo de alguien desde la consola de salas de Teams y consumir vídeo destacado en pantallas de salas

> [!NOTE]
> Las habilidades de voz de Cortana están disponibles para periféricos de audio seleccionados para inquilinos ubicados en la Estados Unidos. En el futuro se agregarán más países o regiones. Para obtener más información, consulte [Asistencia de voz de Cortana en Teams](../cortana-in-teams.md)

### <a name="46230-10192020"></a>4.6.23.0 (10/19/2020)

Introducido en esta actualización:

- Corrección de la pantalla media blanca al invocar el teclado en pantalla en una reunión de Teams
...
- Buscar y llamar a usuarios federados (inquilino) desde la sala de Teams

> [!IMPORTANT]
> La versión 4.5 es la última versión para admitir Windows 10 versión 1803; las versiones futuras no se ofrecerán a los sistemas en Windows 10 versión 1803. Para obtener más información sobre el soporte de la versión de Windows, consulta [Windows 10 soporte técnico de versiones](./rooms-lifecycle-support.md#windows-10-release-support).
...
- Actualizaciones de directivas para "Windows Novedades para empresas"
...
- Se ha quitado la configuración de estado de Cortana
...
- Actualización de la interfaz de usuario de configuración del Administración del dispositivo con la adición de la configuración del dispositivo en la pestaña Acerca de
...
- Una nueva característica de cámara de contenido que permite a los usuarios incluir de forma inteligente una pizarra tradicional en su reunión de Teams
...
- Marca de la aplicación de la tienda de Sistema de salas de Skype en "Salas de Microsoft Teams"
...
- Barra universal para controles de llamada en la reunión para llamadas o reuniones de Teams con el fin de proporcionar una experiencia coherente con Microsoft pc de Teams/ web/ clientes móviles<sup>1</sup>
- Calificación de comentarios sobre la calidad de las llamadas después de las llamadas y reuniones<sup>de Teams 1</sup>
- Recibir o representar Microsoft Whiteboard en Salas de Microsoft Teams frente a la pantalla de la sala cuando se comparte desde el cliente<sup>1</sup> <sup>2</sup> de PC/Web/Mobile Teams
...
<sup>1</sup> Microsoft implementación del servicio de Teams con anillos de Teams. Es posible que esta característica esté disponible antes o después de la actualización del cliente 4.0.105.0

<sup>2</sup> Requiere que los administradores de TI activen Microsoft Whiteboard. Además, si tiene una pantalla táctil frontal de la sala, debe calibrar varias pantallas táctiles con la configuración de Windows con inicio de sesión del administrador del dispositivo para empezar a usar Microsoft Whiteboard para colaborar desde una pantalla de sala compartida en una reunión de Teams
...
- Teclado DTMF para Microsoft reuniones de Teams P2P y llamadas RTC. Para que Microsoft Teams sea el cliente de llamadas predeterminado, los administradores deben establecer IsTeamsDefaultClient en true
...
- Se ha quitado el icono de proyección frontal de la sala cuando la baliza Bluetooth no está habilitada en Salas de Microsoft Teams dispositivo
...
- Compatibilidad con pantalla doble (delante de la sala) para reuniones de Teams
...
- Cambios que habilitan Microsoft para administrar Windows Novedades de forma más flexible.
...
- Capacidad de Administración de TI para configurar dispositivos de forma remota
