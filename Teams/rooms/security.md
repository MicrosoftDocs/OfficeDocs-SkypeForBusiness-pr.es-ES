...
También puede importar cuentas de dominio en el grupo de administradores de Windows local. Puede hacerlo para cuentas de Azure AD mediante Intune. Para obtener más información, vea [CSP de directiva: grupos restringidos.](/windows/client-management/mdm/policy-csp-restrictedgroups).
