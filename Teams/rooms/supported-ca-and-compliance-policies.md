...
La siguiente lista incluye las directivas de acceso condicional admitidas para Salas de Teams en Windows y en Android. Las directivas de Android admitidas se aplican a todos los dispositivos Android en espacios compartidos, incluidos los teléfonos y paneles de área común.
...
|Aplicaciones cliente |No compatible| No se admite |
...
| Requerir autenticación multifactor | No compatible | No se admite |
| Requerir que el dispositivo se marque como compatible | Compatible | Compatible |
|Requerir un dispositivo unido a Azure AD híbrido | No compatible | No compatible |
|Requerir aplicación cliente aprobada | No compatible | No se admite |
| Requerir directiva de protección de aplicaciones | No se admite |No se admite |
| Requerir cambio de contraseña | No compatible | No compatible |
...
|Versión del sistema operativo (mínimo, máximo) |No compatible | Salas de Teams se actualiza automáticamente a las versiones más recientes de Windows y establecer valores aquí podría impedir que se iniciara sesión correctamente después de una actualización del sistema operativo.|
|Versión del SO para dispositivos móviles (mínimo, máximo) | No admitido. | N/D |
| Compilaciones válidas del sistema operativo | No compatible | N/D |
...
| Google Play Services está configurado | No compatible | Google Play no está instalado en Teams dispositivos Android. |
| Proveedor de seguridad actualizado | No compatible | Google Play no está instalado en Teams dispositivos Android. |
| Examen de amenazas en aplicaciones | No compatible | Google Play no está instalado en Teams dispositivos Android. |
| Atestación de dispositivo SafetyNet | No compatible | Google Play no está instalado en Teams dispositivos Android.|
...
| Aplicaciones restringidas | No compatible |  N/D |
...
|Tipo de contraseña necesario |No compatible | N/D|
