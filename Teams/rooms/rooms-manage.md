...
Le recomendamos que actualice la aplicación Microsoft Teams Rooms OS and Microsoft Teams Rooms para beneficiarse de las actualizaciones y mejoras de productos. Para obtener instrucciones detalladas, consulte [Manage Microsoft Teams Rooms](rooms-operations.md#software-updates). 
...
Para obtener más información sobre la solución de problemas y el modo de administración, consulte [modo de administración y administración de dispositivos](rooms-operations.md#admin-mode-and-device-management). 
