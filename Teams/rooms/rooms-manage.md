...
Si tienes más de una Salas de Teams, puedes realizar la mayoría de las acciones en varios dispositivos al mismo tiempo. Por ejemplo, puede establecer la configuración de la aplicación de Teams en todos los Salas de Teams al mismo tiempo.
...
| **Email dirección para registros y comentarios**                      | Email dirección                                          | Sí                |
| *Coordinar reuniones*                                                     |                                                        |                    |
...
Al quitar un dispositivo, el dispositivo se quita de su organización y ya no aparece en la lista de Salas de Teams en Windows en el Centro de administración de Teams.

Si quitas un dispositivo y sigue configurado con un nombre de usuario y contraseña válidos, se volverá a agregar automáticamente a la lista de Salas de Teams si se conecta de nuevo a Microsoft 365.

Para quitar uno o más dispositivos, haz lo siguiente:

1. Vaya a **Dispositivos** >  de Teams **Salas de Teams en Windows** y seleccione los dispositivos que desea quitar.
2. Seleccione **Quitar**.
...
1. Vaya a **Dispositivos** >  teams **Salas de Teams en Windows** y seleccione el nombre del dispositivo desde el que desea descargar los registros.
