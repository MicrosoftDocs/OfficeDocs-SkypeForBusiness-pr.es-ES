...
|**Estado**|**¿Puede ver el orden?**|**¿Puede editar el orden?**|**¿Puede cancelar el orden?**|**¿Puede eliminar el orden?**|**Descripción**|
|:-----|:-----|:-----|:-----|:-----|:-----|
|**Tratamiento** <br/> |Sí  <br/> |No  <br/> |Sí  <br/> |No  <br/> |El administrador ha creado el pedido y se han recibido por Microsoft.  <br/> |
|**Ponerse en contacto con el operador** <br/> |Sí  <br/> |No  <br/> |Sí  <br/> |No  <br/> |El orden se ha recibido y aprobado por Microsoft, y estamos trabajando con el operador de perder para obtenerlo apruebe.  <br/> |
|**Transferencia de aprobado** <br/> |Sí  <br/> |Firme orden Commitment(FOC)  <br/> |Sí  <br/> |No  <br/> |El orden se ha aceptado por el operador de perder, y se ha establecido la fecha FOC.  <br/> |
|**Transferencia pendiente** <br/> |Sí  <br/> |No  <br/> |No  <br/> |No  <br/> |La transferencia es menor que 24 horas, por lo que ya no se puede editar o cancelar el orden.  <br/> |
|**Error** <br/> |No  <br/> |Sí  <br/> |Sí  <br/> |Sí (en este momento, no se puede eliminar el orden de puerto si se ha producido un error. El orden de puerto debe volver a crearse o necesita ponerse [en contacto con soporte técnico para productos de negocio: Ayuda de administración](https://docs.microsoft.com/office365/admin/contact-support-for-business-products?toc=/microsoftteams/toc.json&bc=/microsoftteams/breadcrumb/toc.json).  <br/> |El operador de perder rechazó el orden.  <br/> |
|**Completado** <br/> |Sí  <br/> |No  <br/> |No  <br/> |No  <br/> |Los números se han transferido correctamente.  <br/> |
|**Cancelar** <br/> |No  <br/> |Sí  <br/> |No  <br/> |No  <br/> |El administrador ha cancelado el orden.  <br/> |
...
> [!NOTE]
> Si necesita obtener más números de teléfono, [póngase en contacto con el soporte de productos para empresas: ayuda para administradores](https://docs.microsoft.com/office365/admin/contact-support-for-business-products?toc=/microsoftteams/toc.json&bc=/microsoftteams/breadcrumb/toc.json).
