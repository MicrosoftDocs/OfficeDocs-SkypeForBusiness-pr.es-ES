...
description: Aprende a administrar las aplicaciones de Teams. Obtenga información sobre cómo permitir o bloquear aplicaciones, comprobar el estado de nivel de organización y las propiedades de las aplicaciones, cargar aplicaciones personalizadas y administrar la configuración de las aplicaciones.
appliesto:
- Microsoft Teams
