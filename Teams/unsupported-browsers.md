...
Cuando Teams detecta un explorador no compatible, muestra automáticamente un mensaje que explica el problema y las limitaciones de la sesión. El mensaje proporciona instrucciones adicionales para obtener acceso al audio de la reunión, como aconsejar al usuario que deje un número de llamada para que Teams pueda llamar al usuario, o indicar al usuario que llame al número de conferencia incluido en la invitación a la reunión. El mensaje también anima al usuario a descargar y usar el cliente de escritorio de [Teams](https://teams.microsoft.com/downloads) para disfrutar de la experiencia completa de Teams.
...
Las personas que usan la aplicación web de Teams en exploradores no admitidos experimentarán las siguientes limitaciones:
...
Para obtener más información sobre el soporte del explorador en Teams, vea [Límites y especificaciones de Teams.](./limits-specifications-teams.md#browsers)
