...
f1.keywords:
- NOCSH
description: Los administradores pueden usar el Microsoft Teams de administración para configurar la aplicación Skype reuniones para que funcione con Teams
ms.collection:
- M365-collaboration
appliesto:
- Microsoft Teams
...
- [Qué es Skype de reuniones (aplicación web de Skype Empresarial)](https://support.office.microsoft.com/article/what-is-skype-meetings-app-skype-for-business-web-app-1ff3d412-718a-4982-8ff2-a4992608cdb5)
- [Requisitos de red mínimos de la aplicación Reuniones de Skype](/previous-versions/office/communications/mt845808(v=ocs.16))