...
ms.reviewer: ''
search.appverid: ''
description: Obtenga información sobre Teams directivas de voz y llamadas.
audience: admin
...
Una [directiva de enrutamiento de voz](manage-voice-routing-policies.md) es un contenedor para los registros de uso de la red telefónica conmutada (RTC). Puede usar estas directivas si su organización ha implementado **Sistema telefónico enrutamiento directo**. Las directivas de enrutamiento de voz se pueden administrar con PowerShell o en el centro de administración de Teams.
