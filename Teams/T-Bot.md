...
---
<a name="use-t-bot-to-help-users-with-microsoft-teams"></a><span data-ttu-id="dc2a9-103">Usar T-Bot para ayudar a los usuarios con Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="dc2a9-103">Use T-Bot to help users with Microsoft Teams</span></span>
============================================

<span data-ttu-id="dc2a9-p101">Para obtener ayuda con el uso de Microsoft Teams, asegúrese de que los usuarios y los expertos se familiaricen con [T-Bot](https://support.office.com/en-us/article/Apps-and-services-cc1fba57-9900-4634-8306-2360a40c665b?ui=en-US&rs=en-US&ad=US#bkmk_bots). T-Bot es un bot con el que los usuarios pueden interactuar. Pueden preguntarle sobre el funcionamiento de Microsoft Teams y las respuestas que obtienen abarcan una amplia variedad de preguntas.</span><span class="sxs-lookup"><span data-stu-id="dc2a9-p101">For help while using Microsoft Teams, ensure your users and champions get familiar with [T-Bot](https://support.office.com/en-us/article/Apps-and-services-cc1fba57-9900-4634-8306-2360a40c665b?ui=en-US&rs=en-US&ad=US#bkmk_bots). T-Bot is a bot which users can interact with to ask it questions about how to use Microsoft Teams and get answers to a wide range of questions.</span></span>
...
<span data-ttu-id="dc2a9-113">En las fichas del bot se ofrece toda una variedad de secciones de ayuda, preguntas más frecuentes, vídeos y notas de la versión.</span><span class="sxs-lookup"><span data-stu-id="dc2a9-113">Providing a full slate of Help, FAQ, Videos and Release Notes sections via the tabs within the bot.</span></span>
