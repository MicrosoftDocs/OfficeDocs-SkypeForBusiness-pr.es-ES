...
Cuando alguien llama a un número de teléfono asociado a una cola de llamadas a través de una [cuenta de recursos](manage-resource-accounts.md): 
1. Escuchan un saludo (si hay alguno configurado) 
2. La llamada se coloca en la cola para esperar al siguiente agente de llamada disponible. 
