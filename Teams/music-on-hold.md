...
- Si el usuario llamado de Teams está habilitado para Location-Based enrutamiento, solo se reproduce la música en espera estándar para el autor de la llamada.
