---
title: Administración de números de teléfono para Hungría
author: CarolynRowe
ms.author: crowe
manager: serdars
...
ms.openlocfilehash: 9a2c6aa507329937b13ba95b14595b960901fe6a
ms.sourcegitcommit: 0dda332951df3b946097d90a4923eb191fd86b4c
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 07/14/2022
ms.locfileid: "66790195"
---
# <a name="phone-number-management-for-hungary"></a>Administración de números de teléfono para Hungría

[!INCLUDE [preview-feature](../includes/preview-feature.md)]

Use esta tabla para obtener información sobre cómo obtener y administrar números de teléfono en Hungría para Microsoft Teams.
...
|:-----|:-----|
|Obtenga nuevos números de teléfono de usuario o servicio que no aparecen en el Centro de administración de Microsoft Teams.<br/> |En Hungría, puede obtener números de teléfono para su organización mediante el Centro de administración de Microsoft Teams. También puedes enviar una nueva solicitud de número de teléfono descargando el formulario y [ponte en contacto con TNS Service Desk para obtener instrucciones](contact-tns-service-desk.md).<br/><br/>[Nueva solicitud de número de teléfono para Hungría (v.1.0) (hu-hu)](https://download.microsoft.com/download/4/d/3/4d3a57e0-c092-492c-a9dc-7a5376e30414/New%20phone%20number%20request%20for%20Hungary.pdf).<br/><br/> Antes de poder asignarle números de teléfono, debe descargar el formulario Conocer el formulario de cliente, completarlo por completo y enviárnoslo.<br/><br>Los pedidos nuevos pueden tardar de dos a tres semanas en llenarse en este mercado.  |
|Transferirnos números de teléfono.<br/> | Descargue este formulario. <br/>[Carta de autorización (LOA) para Hungría (todos los números) (v.1.0) (hu-hu)](https://download.microsoft.com/download/f/b/1/fb17b2df-b5cf-45b7-89f0-0cbf250df1f7/letter-of-authorization-(loa)-for-hungary-(all-numbers)-(v1.0)-(hu-hu)%20(1).pdf) <br/> <br/>Rellénalo y [ponte en contacto con el servicio de asistencia de TNS para obtener instrucciones](contact-tns-service-desk.md). <br/><br/>La transferencia de números puede tardar de dos a tres semanas en completarse en este mercado. <br/><br/>Estos números no se pueden usar para conferencias en este momento.   |
