---
title: Administración de números de teléfono para Finlandia
author: CarolynRowe
ms.author: crowe
manager: serdars
...
ms.custom:
- Calling Plans
description: Use esta tabla para obtener información sobre cómo obtener y administrar números de teléfono en Finlandia para Microsoft Teams.
ms.openlocfilehash: 2f71e95cc873396d8d6b3cef9db4d2db4f4477ab
ms.sourcegitcommit: 0dda332951df3b946097d90a4923eb191fd86b4c
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 07/14/2022
ms.locfileid: "66789155"
---
# <a name="phone-number-management-for-finland"></a>Administración de números de teléfono para Finlandia

[!INCLUDE [preview-feature](../includes/preview-feature.md)]

Use esta tabla para obtener información sobre cómo obtener y administrar números de teléfono en Finlandia para Microsoft Teams.
...
|:-----|:-----|
|Obtenga nuevos números de teléfono de usuario o servicio que no aparecen en el Centro de administración de Microsoft Teams.<br/> |En Finlandia, puede obtener números de teléfono para su organización mediante el Centro de administración de Microsoft Teams. También puedes enviar una nueva solicitud de número de teléfono descargando el formulario y [ponte en contacto con el Servicio de asistencia de TNS para obtener instrucciones](contact-tns-service-desk.md).<br/><br/>Nueva solicitud de número de teléfono para Finlandia (v.1.0) (en-fi)]().<br/><br/> Antes de poder asignarte números de teléfono, debes descargar Conocer al [cliente para Finlandia (v.1.0) (fi-FI)](https://download.microsoft.com/download/d/5/3/d5393c6b-eb6e-45e3-975e-d8a501571366/new-phone-number-request-for-finland-(v1.0)-(fi-FI).pdf) Conocer el formulario de cliente, completarlo en su totalidad y enviárnoslo.<br/><br/>Los pedidos nuevos pueden tardar de dos a tres semanas en llenarse en este mercado.   |
|Transferirnos números de teléfono.| Descargue este formulario. <br/>[Carta de autorización (LOA) para Finlandia (todos los números) (v.1.0) (en-fi)](https://download.microsoft.com/download/a/6/8/a68d6c80-daf5-4d40-ba6e-d0f99db1041b/letter-of-authorization-(loa)-for-finland-(all-numbers)-(v1.0)-(en-fi).pdf) <br/> <br/>Rellénalo y [ponte en contacto con el servicio de asistencia de TNS para obtener instrucciones](contact-tns-service-desk.md). <br/><br/>La transferencia de números puede tardar de dos a tres semanas en completarse en este mercado. <br/><br/> Estos números no se pueden usar para conferencias en este momento.   |
