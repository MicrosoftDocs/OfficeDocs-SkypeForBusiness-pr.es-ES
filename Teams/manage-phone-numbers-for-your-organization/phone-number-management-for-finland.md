...
ms.locfileid: "60777180"
---
# <a name="phone-number-management-for-finland"></a>Teléfono de números para Finlandia

[!INCLUDE [preview-feature](../includes/preview-feature.md)]

Use esta tabla para buscar información sobre cómo obtener y administrar números de teléfono en Finlandia para Microsoft Teams.
...
|Realizar actualizaciones del servicio de directorio para números de cola de llamadas o de operador automático|Para agregar o cambiar números de cola de llamadas o operadores automáticos, póngase en contacto con el servicio de atención al cliente de [TNS para obtener instrucciones.](contact-tns-service-desk.md) |
