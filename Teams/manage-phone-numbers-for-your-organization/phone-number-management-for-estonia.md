---
title: Teléfono de números para Estonia
author: cazawideh
ms.author: czawideh
manager: serdars
ms.reviewer: ''
...
ms.custom:
- Calling Plans
description: Use esta tabla para buscar información sobre cómo obtener y administrar números de teléfono en Estonia para Microsoft Teams.
ms.openlocfilehash: eacb29f37297589971c3f5193cbde5afbf1aeae2
ms.sourcegitcommit: bf350ea47032bd926e75a5433eadce3905e731ca
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 11/03/2021
ms.locfileid: "60732921"
---
# <a name="phone-number-management-for-estonia"></a>Teléfono de números para Estonia

Use esta tabla para buscar información sobre cómo obtener y administrar números de teléfono en Estonia para Microsoft Teams.
...
|:-----|:-----|
|Obtenga nuevos números de teléfono de usuario o servicio que no aparecen en el Centro de administración de Microsoft Teams. |En Estonia, puede obtener números de teléfono para su organización con el centro Microsoft Teams administración. También puede enviar una nueva solicitud de número de teléfono descargando el formulario y ponerse en contacto con el Servicio de atención al cliente de [TNS para obtener instrucciones.](contact-tns-service-desk.md)<br/><br/> [Nueva solicitud de número de teléfono para Estonia (v.1.0).](<https://download.microsoft.com/download/4/2/c/42c560b3-c108-4f99-966f-674f19f7073a/New phone number request for Estonia (v.1.0) (en-us).pdf>) <br/><br/>Los nuevos pedidos pueden tardar de 1 a 4 semanas en completarse en este mercado dependiendo de si tenemos acciones de número en la región específica. |
|Transferirnos números de teléfono. | Descargue este formulario. <br/><br/>[Carta de autorización (LOA) para Estonia (todos los números) (v.1.0)](<https://download.microsoft.com/download/0/a/c/0ac70736-9dbd-4cd9-a195-d98ee5c5ae35/Estonia LOA.pdf>)<br/><br/>Rellene y póngase en contacto con el Servicio de atención al cliente de [TNS para obtener instrucciones.](contact-tns-service-desk.md) También debe incluir una factura de utilidad de la dirección de empresa a la que desea transferir números.<br/><br/>Transferir números puede tardar hasta 3 semanas en completarse en este mercado. Estos números no se pueden usar para conferencias en este momento.|
