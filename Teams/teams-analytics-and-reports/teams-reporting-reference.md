...
Para acceder a los informes, debe ser administrador global en Microsoft 365 u Office 365, en el administrador del servicio de Teams o en el administrador de Skype Empresarial. Para obtener más información sobre los roles de administrador de Teams y qué informes pueden tener acceso a cada rol de administrador, consulte Usar roles de administrador de [Teams para administrar Teams.](../using-admin-roles.md)
...
Mejoramos continuamente la experiencia de los informes de Teams y agregamos características y funcionalidades. Con el tiempo, crearemos funcionalidades adicionales en los informes y agregaremos nuevos informes en el Centro de administración de Microsoft Teams.
