...
Con más información sobre los usuarios internos y externos, ahora puede medir la interacción de los usuarios en [canales compartidos](/Teams/shared-channels.md) internos y externos. Por ejemplo, las métricas como el nombre del inquilino al que pertenece el usuario, los nombres de inquilinos externos en los que interactúa el usuario y si el usuario es externo al inquilino ayudarán a los administradores a medir la inacción de los usuarios a través de las características de canal compartido. 
