...
2. En **Intervalo de fechas**, seleccione un rango y haga clic en **Ejecutar informe**.
    ...
    ![Captura de pantalla del informe de uso de Teams en el Centro de administración de Teams con globos.](../media/teams-reports-teams-usage-with-callouts1.png "Captura de pantalla del informe de uso de Teams en el Centro de administración de Teams con globos")

## <a name="interpret-the-report"></a>Interpretar el informe

|Globo |Descripción  |
|--------|-------------|
|**1**   |Puede visualizar el informe Actividad de uso de Teams para ver las tendencias de los últimos 7 días, 30 o 90 días. |
...
|**8** |Los puntos de datos de series temporales en el gráfico muestran métricas de uso diferentes agregadas en el espacio empresarial|
|**9** |Los datos tabulares representan métricas de uso diferentes agregadas por equipo|
