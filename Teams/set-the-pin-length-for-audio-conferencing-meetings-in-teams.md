...
Al configurar las audioconferencias para Microsoft Teams, recibirá un puente de audioconferencia. Un puente de conferencia puede contener uno o más números de teléfono. El número de teléfono que establezca se incluirá en las invitaciones de reunión para la aplicación Microsoft Teams.
...
- Solo se requiere un PIN para el organizador de la reunión cuando un usuario de Microsoft Teams aún no ha iniciado la reunión. Si todas las personas llaman a la reunión, se necesita el PIN para que el organizador de la reunión inicie la reunión.
