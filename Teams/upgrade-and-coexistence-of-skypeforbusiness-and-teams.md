...
Para recibir orientación sobre el proceso de toma de decisiones, familiarícese con los distintos modos, conceptos y terminología relevantes para actualizar de Skype Empresarial a Teams. Para obtener más información, [vea Microsoft Teams y Skype Empresarial coexistencia e interoperabilidad.](./teams-and-skypeforbusiness-coexistence-and-interoperability.md)

> [!NOTE]
> También tendrá que tener en cuenta los escenarios de migración de voz. Sistema telefónico es la tecnología de Microsoft para habilitar el control de llamadas y las capacidades de Exchange de sucursales privadas (PBX) en la Microsoft 365 o Office 365 nube. Para conectar Sistema telefónico a la red telefónica conmutada (RTC) para que los usuarios puedan realizar llamadas telefónicas en todo el mundo, tiene opciones basadas en sus necesidades empresariales. Para obtener más información sobre las Sistema telefónico y las opciones de conectividad RTC, vea [Voz: Sistema telefónico y conectividad RTC.](cloud-voice-landing-page.md)

Un usuario que ha migrado a Teams ya no usa un cliente de Skype Empresarial, salvo para incorporarse a una reunión mantenida en Skype Empresarial. Todos los chats y llamadas entrantes se aterrizó en el cliente Teams usuario, independientemente de si el remitente usa Teams o Skype Empresarial. Todas las reuniones nuevas organizadas por el usuario actualizado se programarán como reuniones de Teams. Si el usuario intenta usar el cliente de Skype Empresarial, se bloqueará el inicio de chats y llamadas<sup>1</sup>. Sin embargo, el usuario puede (y debe) seguir usando el cliente de Skype Empresarial para incorporarse a las reuniones a las que sea invitado.
...
<sup>1</sup> Los clientes Skype Empresarial que se enviaron antes de 2017 no respetan TeamsUpgradePolicy. Asegúrese de que utiliza el cliente más reciente de Skype Empresarial disponible en su canal de Office.
...
- La comunicación iniciada desde el cliente de Skype Empresarial usuario siempre llegará al cliente de Skype Empresarial usuario A.

- La comunicación iniciada desde el Teams  de un usuario de la misma organización siempre llegará al cliente de Teams usuario A.
...
| Mínimo esfuerzo de administración para empezar a trabajar en Teams. | Puede ser difícil "salir de las islas" y pasar al modo TeamsOnly si los usuarios y los usuarios con los que se comunican periódicamente no usan activamente Teams. Por ejemplo, una vez que un subconjunto de usuarios se actualiza al modo TeamsOnly, esos usuarios solo enviarán Teams. Para el resto de la población en modo Islas, esos mensajes siempre llegarán a Teams. Sin embargo, si parte de esa población no Teams, percibirán estos mensajes como perdidos.|
...
<sup>2</sup> Esto es así incluso si el usuario se encuentra en el entorno local en Skype Empresarial Server. Tanto si el usuario está en local como si está en línea, deje la licencia de Skype Empresarial Online habilitada, dado que actualmente es necesaria para la plena funcionalidad de Teams.

<sup>3</sup> Tenga en cuenta que la migración de Skype Empresarial reuniones a reuniones Teams solo se desencadena al aplicar TeamsUpgradePolicy a usuarios individuales, no por inquilino. Para obtener más información, consulte [Migración de reuniones](/skypeforbusiness/audio-conferencing-in-office-365/setting-up-the-meeting-migration-service-mms).
...
- Los usuarios que siguen en Skype Empresarial reciben todos los chats y llamadas entrantes en su cliente de Skype Empresarial, independientemente de si la comunicación se originó del cliente Teams o Skype Empresarial usuario. Además, para estos Skype Empresarial usuarios, las llamadas y las funciones de chat en el cliente de Teams están deshabilitadas para ayudar a evitar confusiones de los usuarios finales y para garantizar el enrutamiento y la presencia adecuados.
...
|El administrador tiene el control sobre el conjunto de capacidades disponibles para los usuarios al pasar de Skype Empresarial a Teams. Este control incluye la capacidad de introducir de forma incremental Teams capacidades. | |
...
|Permite a los administradores introducir funciones superpuestas (chat, reuniones, llamadas VOIP) en Skype Empresarial y Teams a los usuarios finales (lo que permite la funcionalidad en paralelo), así como nuevas funcionalidades (Teams y Canales) en Teams.     | Permite a los administradores presentar funcionalidades seleccionadas de Teams a los usuarios finales (equipos y canales), sin ofrecer la misma funcionalidad que también existe en Skype Empresarial.        |
...
Después de elegir el mejor viaje de actualización para su organización, [realice la actualización](./upgrade-to-teams.md)a Teams .
