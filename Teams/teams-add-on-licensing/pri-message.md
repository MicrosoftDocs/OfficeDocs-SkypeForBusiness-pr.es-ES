...
Con efecto inmediato, hemos finalizado esta promoción y hemos puesto a disposición de todos los clientes de Teams las notificaciones de prioridad como una funcionalidad básica. Ahora, los usuarios podrán enviar y recibir un número ilimitado de mensajes urgentes con una notificación de prioridad. [Obtenga más información sobre la administración de notificaciones de prioridad.](../messaging-policies-in-teams.md)
