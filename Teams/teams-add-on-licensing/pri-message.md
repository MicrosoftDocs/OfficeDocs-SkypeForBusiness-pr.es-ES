...
Con efecto inmediato, hemos finalizado esta promoción y hemos puesto las notificaciones de prioridad disponibles para todos los clientes de Teams como una funcionalidad básica. Ahora, los usuarios podrán enviar y recibir un número ilimitado de mensajes urgentes con una notificación de prioridad. [Obtenga más información sobre la administración de notificaciones de prioridad.](../messaging-policies-in-teams.md)
