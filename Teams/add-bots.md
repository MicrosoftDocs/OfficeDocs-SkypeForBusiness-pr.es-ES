...
Los bots se pueden probar con el [emulador de Bot Framework](https://go.microsoft.com/fwlink/?linkid=854373) antes de implementarlos en sus equipos.

<a name="side-load-your-own-bot-for-private-chat"></a>Transferir localmente su propio bot para chats privados
---------------------------------------
...
3.  El identificador de la aplicación se resolverá con el **nombre del bot** y después podrá iniciar una conversación de chat con él.
