...
> [!NOTE]
> Las cuentas de recursos usadas para operadores automáticos y colas de llamadas están deshabilitadas para iniciar sesión y deben permanecer así. El chat y la presencia no son disponibles para estas cuentas.
...
Para transferir un número de otro operador, vea [Transferir números de teléfono a Teams](phone-number-calling-plans/transfer-phone-numbers-to-teams.md).
...
> [!NOTE]
> Si desea que los usuarios de Skype For Business Server 2019 puedan buscar la cola de llamadas o el operador automático, debe crear sus cuentas de recursos en Skype For Business Server 2019, ya que las cuentas de recursos en línea no se sincronizan con Active Directory. Cuando los registros SRV de DNS para sipfederationtls se resuelven en Skype Empresarial Server 2019, se deben crear  cuentas de recursos en Skype For Business Server 2019 con el shell de administración de SfB y sincronizarse con Azure AD.
