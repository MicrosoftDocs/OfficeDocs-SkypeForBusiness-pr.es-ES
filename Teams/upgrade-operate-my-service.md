...
- SharePoint Online permite compartir archivos en canales y OneDrive para la Empresa un mecanismo para compartir archivos en un chat privado.
...
En las secciones siguientes se describen las herramientas que puede usar para supervisar [](/office365/servicedescriptions/office-365-platform-service-description/service-health-and-continuity#Anchor_1) incidentes de servicio que afectan al Teams servicio. En la tabla siguiente se incluye un resumen de las ventajas de cada herramienta y cuándo debe usar cada una.
...
El [Centro de administración de Microsoft 365](https://portal.office.com/) proporciona un panel [de estado](https://portal.office.com/adminportal/home#/servicehealth) del servicio donde puede ver el estado actual del servicio de Teams, además de los servicios dependientes.
...
Todas las características publicadas se documentan en las [Notas de la versión para Microsoft Teams](https://support.office.com/article/Release-notes-for-Microsoft-Teams-d7092a6d-c896-424c-b362-a472d5f105de).
...
Las personas **a** las que se les ha asignado un rol de administrador global o un rol de  administrador específico del producto (administrador de **Exchange, Skype Empresarial** administrador, SharePoint **administrador**).
...
2. Trabaje con el equipo de soporte técnico para comprobar que no hay problemas técnicos de tendencia que impidan que los usuarios accedan o utilicen el servicio. Si existen tendencias de problemas, use la [](#endpoint-troubleshooting) sección de solución de problemas del punto de conexión más adelante en este artículo para intentar solucionar el problema antes de obtener soporte técnico.

3. Trabaje con el equipo de aprendizaje y adopción para recopilar comentarios directos de [](#assess-user-sentiment) los usuarios (vea Evaluar el sentimiento de los usuarios más adelante en este artículo) y para comprobar la eficacia de las actividades de concienciación y adopción.
...
- **Principio del proyecto**: al evaluar el sentimiento de los usuarios al principio del proyecto, puede obtener una vista anticipada de cómo se sienten los usuarios sobre su experiencia Teams usuario.
...
| Actualizar la red en función de los cambios Microsoft 365 o Office 365 DIRECCIONES IP y URL | Realice actualizaciones de los componentes de red aplicables (firewalls, servidores proxy, VPN, firewalls del cliente, entre otros) para reflejar los cambios en las direcciones URL de Office 365 y los [intervalos](/microsoft-365/enterprise/urls-and-ip-address-ranges) de direcciones IP. | Según sea necesario | |
...
Le recomendamos encarecidamente que nomine al campeón de calidad al principio. Después de ser designados, deben empezar a familiarizarse con el contenido en [Mejorar](monitor-call-quality-qos.md) y supervisar la calidad de las llamadas para Teams materiales de aprendizaje asociados.
...
| Actualizar datos de creación en CQD | Actualice o agregue nuevas definiciones de edificio en CQD cuando se realicen cambios en la red ([consulte Upload información de creación](/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard#upload-building-information)). | Según sea necesario | |
...
| Controladores Wi-Fi | Pruebe y actualice Wi-Fi controladores en el equipo. Valide los resultados con CQD ([Mejorar y supervisar la calidad de las llamadas para Teams](monitor-call-quality-qos.md)). | Según sea necesario | |
...
| Administración de licencias | Planee las necesidades actuales y futuras de las licencias basadas en usuarios y consumo (planes de llamadas y créditos de [](/skypeforbusiness/skype-for-business-online-reporting/pstn-usage-report) comunicación) aprovechando el informe de uso de RTC y el informe de grupos de minutos [RTC](/skypeforbusiness/skype-for-business-online-reporting/pstn-minute-pools-report). | Cada semana | |
