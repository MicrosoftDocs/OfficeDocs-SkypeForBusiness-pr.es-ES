...
En Reuniones en primer lugar, los usuarios crean su reunión en Teams, mientras siguen usando Skype Empresarial para chat, llamadas y presencia. No hay superposición de modalidades entre Teams y Skype Empresarial. El chat, las llamadas y la presencia están activados en Skype Empresarial y desactivados en Teams. Esto permite escenarios únicos "mejor juntos" entre Skype Empresarial y Teams que mejoran la experiencia del usuario durante la coexistencia, así como escenarios de interoperabilidad con los usuarios **de Teams solo**.
...
Reuniones en primer lugar se diseñó para las organizaciones que usan Skype Empresarial Server con Telefonía IP empresarial que desean acelerar su cambio a las reuniones de Teams, especialmente aquellos con una disciplina de TI fuerte que quieren una ruta de actualización administrada y determinista a Teams.
...
- Experiencia de usuario simplificada en Teams, centrada en reuniones y equipos y canales de Teams (que, opcionalmente, se pueden ocultar mediante la [directiva de permisos](teams-app-permission-policies.md) de aplicaciones); [Los chats privados, las llamadas y la presencia propia de Teams](teams-client-experience-and-conformance-to-coexistence-modes.md) no se exponen en Reuniones en primer lugar, lo que permite que el esfuerzo de implementación y adopción se centre completamente en las reuniones.
...
No se requiere [un Skype Empresarial topología híbrida](/skypeforbusiness/hybrid/configure-federation-with-skype-for-business-online), pero se recomienda. Algunas capacidades, como el servicio de migración de reuniones y la interoperabilidad, dependen de esa topología.
...
Le recomendamos [que conceda el modo **SfBOnly** o **SfBWithTeamsCollab**](/powershell/module/skype/grant-csteamsupgradepolicy?view=skype-ps) como valor predeterminado del espacio empresarial en el momento de conceder la licencia a los usuarios. Esto garantiza que los usuarios no empiecen a usar Teams por su cuenta en el modo **predeterminado de islas** antes de que esté listo para iniciar Reuniones en primer lugar.
...
Una vez que haya autorizado a los usuarios y preparado su organización para las reuniones de Teams, es el momento de habilitar primero a los usuarios para las reuniones. Hemos hecho que sea más fácil: una única configuración lo hará todo.

Todas las capacidades y experiencias de usuario en Reuniones en primer lugar, incluida la configuración del cliente de Teams y la [conformidad automática](teams-client-experience-and-conformance-to-coexistence-modes.md) de la experiencia de usuario, el servicio de migración de reuniones y las capacidades Better Together, se configuran al conceder al usuario (o grupo de usuarios, o valor predeterminado del inquilino) el [modo de coexistencia SfBWithTeamsCollabAndMeetings](setting-your-coexistence-and-upgrade-settings.md) en el [Centro de administración de Microsoft Teams](manage-teams-in-modern-portal.md) o mediante [PowerShell](/powershell/module/skype/grant-csteamsupgradepolicy?view=skype-ps).
...
Opcionalmente, si quiere ocultar la aplicación Equipos y canales en el panel de navegación izquierdo del cliente de Teams de los usuarios para centrar aún más su experiencia en las reuniones, esto se puede lograr mediante la [directiva de configuración](teams-app-setup-policies.md) de aplicaciones.
...
Después de revisar este artículo, es posible que quiera consultar [Elegir el recorrido de la actualización](upgrade-and-coexistence-of-skypeforbusiness-and-teams.md), [las instrucciones de migración e interoperabilidad](migration-interop-guidance-for-teams-with-skype.md) y [Coexistencia con Skype Empresarial](coexistence-chat-calls-presence.md) para obtener más información.
