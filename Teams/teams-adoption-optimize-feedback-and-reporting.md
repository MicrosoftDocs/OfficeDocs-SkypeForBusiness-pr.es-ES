...
Procedimiento recomendado: Mantenga una reunión mensual de Teams para los campeones internos. Divida su agenda entre enseñar nuevas características, enviar comentarios y proporcionar herramientas de autoservicio para la comunidad de empleados.

Procedimiento recomendado: Haga que representantes del departamento de soporte técnico interno o del departamento de soporte técnico de TI se unan a su comunidad de campeones para estar al día sobre la nueva información sobre el uso de Teams. 

## <a name="service-reporting"></a>Informes de servicios

Hay tres tipos de informes que debe revisar a medida que implementa y adopta Microsoft Teams:

- [Estado del](https://status.office365.com/) servicio: de Microsoft 365, Office 365 y su departamento interno de soporte técnico de TI.
- [Informes de Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/activity-reports/activity-reports) en el Centro de administración (desde Microsoft 365 u Office 365 ver Informes de [Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/activity-reports/microsoft-teams-user-activity)en el Centro de administración), la actividad de los usuarios de Microsoft Teams. También puede usar información de otros sistemas de su organización.
- Satisfacción del servicio: recopilados de foros internos de la comunidad y encuestas sobre experiencias específicas
