...
description: Enumera las combinaciones de sistema operativo, modelo y controladores que no están habilitados para la aceleración de hardware debido a problemas con los controladores.
f1.keywords:
- CSH
ms.custom:
...
Las siguientes combinaciones de sistema operativo, modelo y controlador no están habilitadas para la aceleración de hardware debido a varios problemas con los controladores.
...
## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Recomendaciones de controladores de descodificador de hardware: Nvidia
...
## <a name="hardware-decoder-driver-recommendations---amd"></a>Recomendaciones de controladores de descodificador de hardware: AMD

Para los sistemas operativos heredados, solo se habilitan los siguientes Device_ids para la aceleración de hardware.
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Recomendaciones de controladores de codificadores de hardware: AMD
