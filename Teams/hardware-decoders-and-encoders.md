...
## <a name="hardware-decoder-driver-recommendations---intel"></a>Recomendaciones del controlador del descodificador de hardware: Intel

Las siguientes combinaciones de sistema operativo, modelo y controlador no están habilitadas para la aceleración de hardware debido a varios problemas de controlador.

|Sistema operativo           | Modelo (Device_id) | Controlador/rango |
|---------------------------|-------------------|--------------|
...
## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Recomendaciones del controlador del descodificador de hardware: Nvidia
...
## <a name="hardware-decoder-driver-recommendations---amd"></a>Recomendaciones de controlador de descodificador de hardware: AMD

En el caso de los sistemas operativos heredados, solo se Device_ids las siguientes funciones para la aceleración de hardware.
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Recomendaciones de controlador de codificador de hardware: Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Recomendaciones de controlador de codificador de hardware: Nvidia
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Recomendaciones del controlador de codificador de hardware: AMD
