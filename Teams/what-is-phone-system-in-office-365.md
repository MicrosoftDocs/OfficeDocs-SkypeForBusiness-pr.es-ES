...
Una rama privada Exchange (PBX) es un sistema telefónico dentro de una empresa. Sistema telefónico ofrece capacidades pbx, pero sin el equipo complicado y caro. 

Sistema telefónico permite reemplazar el sistema PBX local existente con un conjunto de características que se entregan desde Microsoft 365 o Office 365 que está estrechamente integrado en su experiencia en la nube. Para obtener más información sobre las características, vea Esto es lo [que obtiene con Sistema telefónico](here-s-what-you-get-with-phone-system.md).

## <a name="phone-system-technology"></a>Sistema telefónico tecnología

Sistema telefónico permite el control de llamadas y las capacidades de PBX en la nube con Microsoft Teams y Skype Empresarial online. 
  
Con Sistema telefónico, los usuarios pueden usar Teams o Skype Empresarial Online para realizar y recibir llamadas, transferir llamadas y silenciar o activar llamadas. Sistema telefónico usuarios pueden hacer clic en un nombre en su libreta de direcciones y realizar Teams o Skype Empresarial llamadas en línea a esa persona. Para realizar y recibir llamadas, Sistema telefónico usuarios pueden usar sus dispositivos móviles, auriculares con un portátil o pc, o uno de los muchos teléfonos IP que funcionan con Teams y Skype Empresarial Online. Sistema telefónico administradores pueden administrar las opciones de llamadas y la configuración desde la misma consola que se usa para mensajería, colaboración, entre otros.
...
Para llamadas fuera de su organización, Microsoft ofrece varias opciones para conectarse Sistema telefónico a la red telefónica conmutada (RTC).

## <a name="connect-to-the-public-switched-telephone-network-pstn"></a>Conectar a la red telefónica conmutada (RTC)
  
Sistema telefónico puede conectarse a la RTC de dos maneras:
...
- **Operadores automáticos:** los operadores automáticos se pueden usar para crear un sistema de menús para su organización que permita a los autores de llamadas externos e internos desplazarse por el sistema para localizar y realizar o transferir llamadas a usuarios o departamentos de la empresa de su organización. Vea [¿Qué son los operadores automáticos en la nube?](what-are-phone-system-auto-attendants.md).

- **Colas de llamadas:** los saludos de cola de llamadas se pueden usar cuando alguien llama a un número de teléfono de su organización. Estos saludos incluyen la capacidad de poner automáticamente las llamadas en espera y la capacidad de buscar el siguiente agente de llamada disponible para controlar la llamada mientras las personas que llaman escuchan música en espera. Puede crear una o varias colas de llamadas para su organización. Vea [Crear una cola de llamadas en la nube.](create-a-phone-system-call-queue.md)

- **Correo** de voz: cuando obtiene una Sistema telefónico de correo de voz para un usuario, ese usuario puede obtener el correo de voz que han dejado las personas que llaman. Correo de voz en la nube se configura y aprovisiona automáticamente para los usuarios después de asignarles una licencia de Sistema telefónico y un número de teléfono. Consulte [Configurar Correo de voz en la nube](set-up-phone-system-voicemail.md).

Para obtener más información sobre las características, vea Esto es lo [que obtiene](here-s-what-you-get-with-phone-system.md)con Sistema telefónico . Si está listo para empezar, vea Configurar Sistema telefónico [en su organización.](setting-up-your-phone-system.md)
