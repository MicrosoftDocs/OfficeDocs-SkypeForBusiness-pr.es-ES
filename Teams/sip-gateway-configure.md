...
Asegúrese de que los dispositivos SIP están en la versión de firmware mínima compatible para la incorporación. Durante la incorporación, SIP Gateway insertará la interfaz de usuario predeterminada de configuración y autenticación en el dispositivo. Para conocer la versión de firmware necesaria para dispositivos SIP, vea [Planear SIP Gateway](sip-gateway-plan.md).
...
3. En la esquina superior derecha, seleccione **ActionsProvision**  >  devices y siga uno de estos pasos:
  ...
  - **Para aprovisionar un dispositivo:**
   ...
   - **Para aprovisionar muchos dispositivos:**
     ...
     e. En la parte derecha del **panel Upload direcciones MAC**, seleccione Seleccionar un archivo y seleccione el archivo **Template_Provisioning.csvque contiene** los datos.
...
Para cerrar sesión en un dispositivo en el Teams de administración:
...
2. Seleccione **Teams** **dispositivosSIP** > . Todos los dispositivos SIP que han iniciado sesión se muestran a la derecha.
...
Los detalles de usuario y las directivas se capturarán en dispositivos SIP cuando los usuarios inicien sesión. Los cambios de directiva posteriormente para los usuarios que han iniciado sesión se sincronizarán con el dispositivo en un plazo de una hora. Los dispositivos deben tener su registro actualizado con sip gateway periódicamente. Los teléfonos SIP dependen de la redirección de llamadas, por lo que el administrador debe establecer el `AllowCallRedirect` atributo en `Set-CsTeamsCallingPolicy` `Enabled`.
...
SIP Gateway solo admite IPv4. Microsoft Teams soporte técnico y cliente tanto IPv4 como IPv6. Si desea controlar las comunicaciones a Microsoft Teams, use los intervalos de direcciones IP en Microsoft 365 [direcciones URL e intervalos de direcciones IP](/microsoft-365/enterprise/urls-and-ip-address-ranges).
