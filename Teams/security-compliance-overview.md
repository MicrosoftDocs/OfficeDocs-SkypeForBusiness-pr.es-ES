...
La aplicación de escritorio de Microsoft Teams admite AppLocker.  Para obtener más información sobre los requisitos previos de AppLocker, vea: Requisitos para usar [AppLocker.](/windows/security/threat-protection/windows-defender-application-control/applocker/requirements-to-use-applocker)
...
Los clientes pueden aprovechar eDiscovery o [eDiscovery avanzado según](/microsoft-365/compliance/office-365-advanced-ediscovery) sus requisitos. La siguiente tabla muestra las diferencias entre estos dos métodos:
