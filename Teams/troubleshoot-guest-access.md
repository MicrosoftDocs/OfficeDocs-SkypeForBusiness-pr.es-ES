...
- Para ver si sabemos cuál es su problema, consulte Equipos [de soporte técnico de su organización.](Known-issues.md)
...
> [!NOTE]
> Teams debe estar habilitado en el inquilino de casa de un invitado para que los invitados puedan iniciar sesión y usar Teams como invitado en otro inquilino (recurso).

Si está viendo errores de licencia, asegúrese de leer el modelo de facturación para identidades externas de [Azure AD](https://docs.microsoft.com/azure/active-directory/external-identities/external-identities-pricing) para determinar los requisitos de licencias para satisfacer sus necesidades de acceso de invitado en su organización.
...
- Las licencias se tienen en cuenta en su organización, independientemente de si los invitados provienen de otra organización de Microsoft 365 o están usando sus direcciones de correo electrónico personales.
