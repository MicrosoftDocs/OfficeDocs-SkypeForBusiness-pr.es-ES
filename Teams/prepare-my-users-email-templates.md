...
---
# <a name="facilitate-user-adoption-of-your-new-online-phone-system"></a><span data-ttu-id="8c945-103">Facilitar la adopción por el usuario de su nuevo sistema telefónico en línea</span><span class="sxs-lookup"><span data-stu-id="8c945-103">Facilitate user adoption of your new online phone system</span></span>

<span data-ttu-id="8c945-104">Un teléfono puede ser el salvavidas de un usuario.</span><span class="sxs-lookup"><span data-stu-id="8c945-104">A phone can be a user's lifeline.</span></span> <span data-ttu-id="8c945-105">Cambiar de un sistema telefónico tradicional a un sistema telefónico en línea representa un cambio significativo en la forma de trabajar de los usuarios y puede afectar negativamente a la productividad.</span><span class="sxs-lookup"><span data-stu-id="8c945-105">Switching from a traditional phone system to an online phone system represents a significant change in the way users work, and can negatively affect productivity.</span></span> <span data-ttu-id="8c945-106">Tomar tiempo para informar, guiar y apoyar a los usuarios a través de este cambio puede ayudar a garantizar una experiencia de usuario positiva y maximizar el retorno de la inversión.</span><span class="sxs-lookup"><span data-stu-id="8c945-106">Taking time to inform, guide, and support users through this change can help ensure a positive user experience and maximize your return on investment.</span></span>

<span data-ttu-id="8c945-107">Este artículo contiene plantillas de correo electrónico personalizables para ayudar a informar a los usuarios sobre su nuevo sistema telefónico.</span><span class="sxs-lookup"><span data-stu-id="8c945-107">This article contains customizable email templates to help inform users about their new phone system.</span></span> <span data-ttu-id="8c945-108">Personalice y envíe los correos electrónicos adecuados para alinearse con su implementación de voz específica.</span><span class="sxs-lookup"><span data-stu-id="8c945-108">Customize and send the appropriate emails to align with your specific voice deployment.</span></span> <span data-ttu-id="8c945-109">Hemos usado corchetes para indicar secciones para facilitar la personalización, pero le recomendamos que agregue mensajería específica de la organización para que el anuncio sea más relevante para los usuarios.</span><span class="sxs-lookup"><span data-stu-id="8c945-109">We've used brackets to indicate sections for easy personalization, but we recommend that you add organization-specific messaging to make the announcement most relevant for your users.</span></span> <span data-ttu-id="8c945-110">Si es aplicable para la implementación, reemplace todas las referencias a "Teams" por "Skype Empresarial".</span><span class="sxs-lookup"><span data-stu-id="8c945-110">If applicable for your deployment, replace all references to "Teams" with "Skype for Business."</span></span>

## <a name="email-number-1-send-three-weeks-before-launch"></a><span data-ttu-id="8c945-111">Número de correo electrónico 1: Enviar tres semanas antes del inicio</span><span class="sxs-lookup"><span data-stu-id="8c945-111">Email number 1: Send three weeks before launch</span></span>

<span data-ttu-id="8c945-112">Línea de asunto:</span><span class="sxs-lookup"><span data-stu-id="8c945-112">Subject line:</span></span>

```
IMPORTANT ANNOUNCEMENT about your office desk phone
```

<span data-ttu-id="8c945-113">Cuerpo del correo electrónico:</span><span class="sxs-lookup"><span data-stu-id="8c945-113">Body of email:</span></span>
...
## <a name="email-number-2-send-one-week-before-launch"></a><span data-ttu-id="8c945-114">Número de correo electrónico 2: Enviar una semana antes del inicio</span><span class="sxs-lookup"><span data-stu-id="8c945-114">Email number 2: Send one week before launch</span></span>

<span data-ttu-id="8c945-115">Línea de asunto:</span><span class="sxs-lookup"><span data-stu-id="8c945-115">Subject line:</span></span>

```
ACTION REQUESTED: Are you ready for your new phone system?
```

<span data-ttu-id="8c945-116">Cuerpo del correo electrónico:</span><span class="sxs-lookup"><span data-stu-id="8c945-116">Body of email:</span></span>
...
## <a name="email-number-3-send-on-launch-day"></a><span data-ttu-id="8c945-117">Número de correo electrónico 3: Enviar el día de lanzamiento</span><span class="sxs-lookup"><span data-stu-id="8c945-117">Email number 3: Send on launch day</span></span>

<span data-ttu-id="8c945-118">Línea de asunto:</span><span class="sxs-lookup"><span data-stu-id="8c945-118">Subject line:</span></span>

```
IMPORTANT NOTICE: Your new phone system is live
```

<span data-ttu-id="8c945-119">Cuerpo del correo electrónico:</span><span class="sxs-lookup"><span data-stu-id="8c945-119">Body of email:</span></span>
...
## <a name="email-number-4-send-two-weeks-after-launch"></a><span data-ttu-id="8c945-120">Número de correo electrónico 4: Enviar dos semanas después del inicio</span><span class="sxs-lookup"><span data-stu-id="8c945-120">Email number 4: Send two weeks after launch</span></span>

<span data-ttu-id="8c945-121">Línea de asunto:</span><span class="sxs-lookup"><span data-stu-id="8c945-121">Subject line:</span></span>

```
FEEDBACK REQUESTED: Your new phone system
```

<span data-ttu-id="8c945-122">Cuerpo del correo electrónico:</span><span class="sxs-lookup"><span data-stu-id="8c945-122">Body of email:</span></span>
