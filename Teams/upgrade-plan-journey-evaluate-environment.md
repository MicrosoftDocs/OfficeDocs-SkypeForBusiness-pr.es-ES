...
---
![Etapas del viaje de actualización, con énfasis en la fase de preparación técnica] (media/upgrade-banner-tech-readiness.png "Etapas del viaje de actualización, con énfasis en la fase de preparación técnica")
...
> | ¿Ha realizado una evaluación de la disponibilidad de red? <br/>Para obtener más información, consulte evaluación de la [disponibilidad de red](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Offers?pageState=NetworkReadiness). | <input type="checkbox">Afirmativa <br/> <input type="checkbox">No | |
...
<tr><td><img src="media/audio_conferencing_image9.png" alt="An icon depicting the next step"/><br/>Siguiente paso</td><td><ul><li>Documente los resultados de la evaluación del entorno.</li></ul></td></tr>
</table>
