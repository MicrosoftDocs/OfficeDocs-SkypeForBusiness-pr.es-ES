...
> | Pregunta | Respuesta | Comentarios |
> |---|---|---|
> | Cómo (o cómo) los usuarios en el ámbito de la migración <br>¿tiene acceso a teams cuando están en la oficina? <br/>Seleccione todos los que correspondan. | <input type="checkbox"> Conexión NAT enrutada <br/> <input type="checkbox"> Servidor proxy <br/> <input type="checkbox"> Wi-Fi públicas <br/> <input type="checkbox"> Wi-Fi administrado (no público) <br/> <input type="checkbox"> ExpressRoute (emparejamiento de Microsoft) ||
