...
- La History-Info de entrada se conserva cuando se habilita el parámetro ForwardCallHistory. Se pueden usar History-Info conservados para la prevención del bucle.
