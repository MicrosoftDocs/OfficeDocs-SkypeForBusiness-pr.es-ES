...
| ![Un icono que representa el paso siguiente.](media/audio_conferencing_image9.png)<br/>Paso siguiente|<ul><li>Use las instrucciones siguientes para diseñar y ejecutar el piloto formal.</li></ul>|
