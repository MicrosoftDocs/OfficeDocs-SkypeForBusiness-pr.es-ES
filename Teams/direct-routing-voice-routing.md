...
En la tabla siguiente se resume la configuración mediante tres rutas de voz. En este ejemplo, las tres rutas forman parte del mismo uso de la RTC "Estados Unidos y Canadá".  Todas las rutas se asocian con el uso de la RTC "Estados Unidos y Canadá" y el uso de RTC está asociado a la Directiva de enrutamiento de voz "solo para EE. UU.". 
...
- Crear un único uso de RTC 
- Configurar tres rutas de voz
- Crear una directiva de enrutamiento de voz
- Asignar la política a User Spencer Low
...
```
En el ejemplo siguiente se muestra el resultado de ejecutar el `(Get-CSOnlinePSTNUsage).usage` comando PowerShell para mostrar nombres completos (no truncado):
...
**Paso 2:** En una sesión de PowerShell de Skype empresarial online, cree tres rutas: Redmond 1, Redmond 2 y otros + 1, tal y como se muestra en la tabla anterior.
...
**Paso 4:** Con PowerShell, conceda la Directiva de enrutamiento de voz al usuario Spencer Low:
...
En el ejemplo siguiente, puede crear la Directiva de enrutamiento de voz "sin restricciones". La Directiva reutiliza el uso de la RTC "Estados Unidos y Canadá" creado en el ejemplo 1, así como el nuevo uso de RTC "internacional".  Esta directiva dirige todas las demás llamadas a los sbc2.contoso.biz y sbc5.contoso.biz de SBCs. 
...
- Crear un nuevo uso de RTC denominado internacional
- Crear una nueva ruta de voz denominada internacional
- Crear una directiva de enrutamiento de voz llamada sin restricciones
- Asignar la Directiva al usuario John Woods
