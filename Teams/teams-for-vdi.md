...
##### <a name="teams-cached-content-exclusion-list-for-non-persistent-setup"></a>Lista de exclusión de contenido en caché de Teams para una configuración no persistente
...
#### <a name="new-deployments-of-teams-through-microsoft-365-apps-for-enterprise"></a>Nuevas implementaciones de Teams a través de aplicaciones de Microsoft 365 para empresas
...
Teams a través de Aplicaciones de Microsoft 365 para empresas se instala por usuario. Para obtener más información, vea la [sección Instalar o actualizar la aplicación de escritorio de Teams en VDI.](#install-or-update-the-teams-desktop-app-on-vdi)

#### <a name="teams-deployments-through-microsoft-365-apps-for-enterprise-updates"></a>Implementaciones de Teams a través de aplicaciones de Microsoft 365 para actualizaciones empresariales

Teams también se está agregando a las instalaciones existentes de aplicaciones de Microsoft 365 para empresas. Puesto que Microsoft 365 Aplicaciones para empresas instala Teams solo por usuario, vea la sección Instalar o actualizar la aplicación de escritorio de [Teams en VDI.](#install-or-update-the-teams-desktop-app-on-vdi)
...
Las aplicaciones de Microsoft 365 para empresas no admiten las instalaciones por equipo de Teams. Para usar la instalación por equipo, debe excluir Teams de Las aplicaciones de Microsoft 365 para empresas. Vea las [secciones Implementar la aplicación de escritorio de Teams](#deploy-the-teams-desktop-app-to-the-vm) en la máquina virtual y Cómo excluir la implementación de Teams a través de las aplicaciones de Microsoft [365](#how-to-exclude-teams-deployment-through-microsoft-365-apps-for-enterprise) para empresas.
...
1. Descargue el paquete MSI de Teams que coincida con su sistema operativo VDI VM con uno de los vínculos siguientes:
    ...
    La versión mínima de la aplicación de escritorio de Teams que se requiere es la versión 1.3.00.4461. (La retención RTC no es compatible con versiones anteriores).
...
2. Instale msi en la máquina virtual VDI ejecutando uno de los siguientes comandos:
    ...
    - Instalación por equipo
        ...
        Este proceso instala Teams en la carpeta Archivos de programa (x86) en un sistema operativo de 64 bits y en la carpeta Archivos de programa de un sistema operativo de 32 bits. En este punto, se ha completado la configuración de la imagen dorada. La instalación de Teams por equipo es necesaria para las configuraciones no persistentes.

        La siguiente sesión interactiva de inicio de sesión inicia Teams y pide credenciales.
...
- Características deshabilitadas en VDI: Teams deshabilita las características que requieren uso intensivo de GPU para VDI, lo que puede ayudar a mejorar el uso transitorio de la CPU. Las siguientes características están deshabilitadas:
...
> [!IMPORTANT]
> Si actualmente ejecuta Teams sin optimización av en VDI y usa características que aún no son compatibles con la optimización (como Ceder y tomar el control al compartir aplicaciones), debe establecer directivas de proveedor de virtualización para desactivar el redireccionamiento de Teams. Esto significa que las sesiones multimedia de Teams no se optimizarán. Para obtener pasos sobre cómo establecer directivas para desactivar el redireccionamiento de Teams, póngase en contacto con su proveedor de virtualización.

### <a name="network-requirements"></a>Requisitos de red

Le recomendamos que evalúe su entorno para identificar los riesgos y requisitos que puedan influir en la implementación general de voz y vídeo en la nube. Use la [Herramienta de evaluación de red de Skype Empresarial](https://www.microsoft.com/download/details.aspx?id=53885) para comprobar si su red está lista para Teams.
...
Teams on Chrome browser doesn't provide a replacement for the Teams desktop app for VDI with AV optimization. La experiencia de chat y colaboración funciona según lo esperado. Cuando se necesitan medios, hay algunas experiencias que podrían no cumplir las expectativas de los usuarios en el explorador Chrome:
...
- Es posible que también sea necesario establecer la configuración del dispositivo en la administración de dispositivos windows.
...
- Botones HID y controles LED entre la aplicación y los dispositivos de Teams
...
Para ver los problemas conocidos de Teams que no están relacionados con VDI, vea [Equipos de soporte técnico de su organización.](/MicrosoftTeams/troubleshoot/teams-welcome)
