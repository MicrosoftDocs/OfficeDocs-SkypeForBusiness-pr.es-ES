...
1. En el centro de administración de Teams, vaya a **UsuariosAdministrar**  >  usuarios y seleccione un usuario.
...
- [Get-CsUserCallingSettings](/powershell/module/teams/get-csusercallingsettings?view=teams-ps) : muestra la configuración del desvío de llamadas, los delegados y la información del delegador de un usuario.

- [Set-CsUserCallingSettings](/powershell/module/teams/set-csusercallingsettings?view=teams-ps) : establece la configuración del desvío de llamadas para un usuario.
