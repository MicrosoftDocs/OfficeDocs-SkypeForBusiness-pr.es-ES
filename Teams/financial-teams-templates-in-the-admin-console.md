...
Este artículo le interesa si es responsable de planear, implementar y administrar varios equipos en la organización financiera. Ya ha implementado el servicio de Teams en su organización. Si aún no ha implementado Teams, empiece por leer [cómo implementar Microsoft Teams](How-to-roll-out-teams.md).
...
## <a name="global-crisis-or-event"></a>Crisis global o evento
...
Centraliza la colaboración para los empleados de las sucursales en huddles, las reuniones de clientes, los procesos empresariales, como la colaboración de hipotecas, y mantén a todos en el bucle con anuncios y Kudos.
