...
Microsoft Teams puede tardar desde unos minutos hasta un máximo de 2 horas en reflejar los cambios dinámicos de pertenencia una vez que entren en vigor en el grupo de Microsoft 365 para un equipo.
...
Para crear un equipo que use la pertenencia dinámica, empiece [por crear un grupo dinámico de Microsoft 365](/azure/active-directory/users-groups-roles/groups-create-rule) y, a continuación, [cree un equipo a partir de ese grupo](https://support.microsoft.com/en-us/office/create-a-team-from-an-existing-group-24ec428e-40d7-4a1a-ab87-29be7d145865).
