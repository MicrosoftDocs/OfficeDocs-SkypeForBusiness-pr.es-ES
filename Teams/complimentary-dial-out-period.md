...
- Los 115 usuarios comparten un grupo de (115 usuarios x 900 min) = 103.500 minutos de llamadas salientes por mes natural, que se puede usar para realizar llamadas salientes a cualquiera de los países y regiones de la zona [A.](audio-conferencing-zones.md)

- Todas las llamadas que superen los 103.500 minutos por mes natural se facturan por minuto con créditos de comunicaciones con las tarifas publicadas para ese destino. (Nota: el inquilino debe configurar los créditos de comunicaciones y asignar la licencia de créditos de comunicaciones al organizador de la reunión).
