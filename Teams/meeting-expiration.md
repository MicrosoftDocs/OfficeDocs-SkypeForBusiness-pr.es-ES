...
## <a name="what-happens-when-the-meeting-join-link-and-conference-id-expire"></a>¿Qué sucede cuando el vínculo de unión a la reunión y el id. de conferencia expiran?
...
Cuando la configuración de la directiva de reunión está establecida en **"On",** los usuarios a los que se asigna la directiva pueden iniciar o programar reuniones de ese tipo y todos los usuarios pueden unirse. Cuando cambia la configuración de la directiva de reunión a **Desactivado,** los usuarios a los que se asigna la directiva no pueden iniciar o programar reuniones nuevas de ese tipo, y los vínculos para unirse a la reunión e id. de conferencia de las reuniones existentes que el usuario programó previamente expirarán.
