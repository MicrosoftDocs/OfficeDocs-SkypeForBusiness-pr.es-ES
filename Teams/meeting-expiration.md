...
- [Programación privada de reuniones](meeting-policies-in-teams-general.md#private-meeting-scheduling): controla si un usuario puede programar una reunión privada en Teams. Una reunión es privada cuando no se publica en un canal de un equipo.
...
> [!NOTE]
> Una copia de la transcripción de la reunión se guarda en OneDrive SharePoint y una segunda copia se guarda en Exchange almacenamiento temporal. La copia de OSDP expira cuando el TMR expira automáticamente.
...
La característica de expiración automática está pensada únicamente como un mecanismo de limpieza ligero para reducir el desorden de almacenamiento creado a partir de grabaciones de reuniones Teams reuniones.
...
Verá estadísticas de archivos que muestran:

- El número de visores únicos
- El número de vistas totales
- La tendencia de los visores y las vistas día a día de los últimos 90 días
- Retención de audiencia (qué parte del vídeo se ha visto o no)
