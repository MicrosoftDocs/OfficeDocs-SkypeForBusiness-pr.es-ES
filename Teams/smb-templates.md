...
#### <a name="request"></a><span data-ttu-id="8b1db-152">Solicitud</span><span class="sxs-lookup"><span data-stu-id="8b1db-152">Request</span></span> 
```http 
POST https://graph.microsoft.com/beta/teams 
Content-Type: application/json 
{
