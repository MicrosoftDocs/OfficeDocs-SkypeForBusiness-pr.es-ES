...
:::image type="content" source="media/manage-apps-new-page.png" alt-text="Captura de pantalla que muestra la página de administración de aplicaciones de licencias de compra.":::
