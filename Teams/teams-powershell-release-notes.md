...
|------- | -------------------- | ------------------------------ |
| Mayo de 2021 | [3.0.0] |<li>Actualizaciones para el inicio de sesión de AccessToken con Connect-MicrosoftTeams: matriz de tokens unificada en lugar de parámetros de token de acceso específicos de recursos</li><li>Se han quitado todas las referencias de AADGraph cuando AADGraph está a punto de finalizar su vida útil</li>|
