...
La primera vez que use el Asesor de Teams, se creará un Equipo de administración del servicio para usted en Teams. Se agregan canales para cada carga de trabajo que desea implementar. 
...
Una vez que el Asesor cree el Equipo de administración del servicio, el bot del Asesor entregará el siguiente mensaje.

>**¡Le damos la bienvenida al Equipo de administración del servicio de Microsoft Teams!**
>  
...
>- Vaya al Equipo de administración del servicio en Teams. Seleccione su canal de carga de trabajo (por ejemplo, chat, equipos, canales y aplicaciones) y seleccione la pestaña **Planner** para empezar.
> 
...
>
> [!IMPORTANT]
> El bot del Asesor de Teams solo se usa para enviar un mensaje de bienvenida al equipo de administración del servicio. No se recopilan datos adicionales.
...
### <a name="can-i-delete-the-service-management-team"></a>¿Puedo eliminar el Equipo de administración del servicio?
Cuando el Asesor de Teams haya creado el Equipo de administración del servicio, administre el equipo como cualquier otro, incluyendo la posibilidad de eliminarlo. Tenga en cuenta que, si no elimina el equipo con el centro de administración de Teams, se le indicará que el equipo existe.

### <a name="can-i-add-or-remove-channels-in-the-service-management-team"></a>¿Puedo agregar o quitar canales en el Equipo de administración del servicio?
Sí, una vez que se haya creado el Equipo de administración del servicio, podrá administrar los canales de la misma forma que lo haría con cualquier otro equipo.

### <a name="can-i-add-or-remove-project-team-members-in-the-service-management-team"></a>¿Puedo agregar o quitar miembros del equipo del proyecto en el Equipo de administración del servicio?
Sí, una vez que se haya creado el Equipo de administración del servicio, podrá administrarlo de la misma forma que lo haría con cualquier otro equipo.

### <a name="can-i-modify-the-planner-plans"></a>¿Puedo modificar los planes de Planner?
Sí, cuando el Asesor de Teams haya creado el Equipo de administración del servicio, debe actualizar el plan de Planner para mejorar la compatibilidad con la implementación de Teams. Puede modificar cualquier cosa (los depósitos, las tareas, los detalles de las tareas), al igual que cualquier otro plan de Planner.


### <a name="can-i-modify-the-forms-survey"></a>¿Puedo modificar la encuesta de Forms?
Sí, una vez que el Asesor de Teams haya creado el Equipo de administración del servicio, puede modificar la encuesta de Forms según sea necesario.
...
Sí, FastTrack aprovecha el Asesor de Teams para todos los clientes que buscan implementar Teams. Pueden ayudarle con la configuración inicial de su Equipo de administración del servicio utilizando el Asesor de Teams (si lo requiere) y también ofrecer soporte técnico (si es necesario) sobre temas específicos durante la implementación de Teams.

### <a name="can-i-use-advisor-for-teams-with-a-partner"></a>¿Puedo usar el Asesor de Teams con un asociado?
Sí, puede usar el Asesor de Teams mientras usa también un asociado de implementación para la implementación de Teams. Si su asociado es un CSP y administra el inquilino en su nombre, puede usar el asesor de Teams para crear el Equipo de administración del servicio y ayudarle a ejecutar el proyecto global. Además, puede trabajar con cualquier asociado si agrega a estos usuarios como invitados en el Equipo de administración del servicio, para que puedan participar como miembros del equipo del proyecto global.
