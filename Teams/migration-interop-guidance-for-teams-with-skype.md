...
|---|---|---|---|---|
|**TeamsOnly <sup>2</sup>**</br>*Solo es posible si el usuario no tiene una cuenta local en Skype Empresarial Server*|Teams|Teams|Sí|Estado final de la actualización. También es el valor predeterminado para los nuevos espacios empresariales.|
