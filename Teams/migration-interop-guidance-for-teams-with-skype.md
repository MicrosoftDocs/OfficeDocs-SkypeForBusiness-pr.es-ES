...
ms.locfileid: "67657270"
---
# <a name="coexistence-modes---reference"></a>Modos de coexistencia: referencia

> [!Important] 
> - Después de la retirada de Skype Empresarial Online el 31 de julio de 2021, ya no es posible asignar un modo de coexistencia distinto de TeamsOnly a un usuario alojado en la nube. Como era el caso antes de la retirada, a los usuarios alojados en Skype Empresarial Server locales se les puede asignar cualquier modo *que no sea* TeamsOnly. 
...
Desde el punto de vista técnico, el modo de un usuario rige varios aspectos de la experiencia del usuario:
...
Para obtener más información sobre el enrutamiento y el comportamiento de presencia según el modo, vea [Coexistencia con Skype Empresarial](./coexistence-chat-calls-presence.md).

Sin embargo, desde el punto de vista de la experiencia, el modo puede describirse como definiendo la experiencia para:
...
Los modos se muestran a continuación. Los usuarios en la nube deben ser TeamsOnly y los usuarios locales deben ser cualquier modo distinto de TeamsOnly. 
</br>
</br>
...
|NotifySfbUsers|Booleano|*Falso* o verdadero|Indica si se muestra un banner en el cliente de Skype Empresarial para informar al usuario de que Teams reemplazarán pronto Skype Empresarial. Esto no puede hacerse si Mode=TeamsOnly.|
|||||
...
- Para actualizar un usuario ($SipAddress) a Teams, conceda la instancia de "UpgradeToTeams":</br>
...
## <a name="the-teams-client-user-experience-when-using-skype-for-business-modes"></a>La experiencia del usuario cliente de Teams al usar modos de Skype Empresarial

Cuando un usuario se encuentra en cualquiera de los modos Skype Empresarial (SfBOnly, SfBWithTeamsCollab, SfBWithTeamsCollabAndMeetings), todos los chats y llamadas entrantes se enrutan al cliente de Skype Empresarial del usuario. Para evitar confusiones entre el usuario final y garantizar que la funcionalidad correcta de enrutamiento, llamadas y chat en el cliente de Teams se deshabilita automáticamente cuando un usuario se encuentra en cualquiera de los modos Skype Empresarial. De forma similar, la programación de reuniones se deshabilita automáticamente cuando los usuarios se encuentran en los modos SfBOnly o SfBWithTeamsCollab, y se habilita automáticamente cuando un usuario está en el modo SfBWithTeamsCollabAndMeetings. Para obtener más información, vea [Experiencia del cliente Teams y conformidad con los modos de coexistencia](./teams-client-experience-and-conformance-to-coexistence-modes.md).
