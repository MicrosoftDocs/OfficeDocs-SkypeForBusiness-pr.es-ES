...
En este artículo se describe cómo configurar un controlador de borde de sesión (SBC) y conectarlo a Sistema telefónico enrutamiento directo.  Este es el paso 1 de los pasos siguientes para configurar enrutamiento directo:
...
|¿Obligatorio?|Microsoft Teams configuración del Centro de administración|Parámetro de PowerShell|Descripción|Valor predeterminado|Valores posibles|Tipo y restricciones|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
