...
|Haga esto  |Si...  | Usar...
|---------|---------|----|
|[Asignar una directiva a usuarios individuales](#assign-a-policy-to-individual-users)    | Es nuevo en Teams y solo tiene que asignar una o un par de directivas a un pequeño número de usuarios. |El Microsoft Teams de administración o cmdlets de PowerShell en el módulo Teams PowerShell
...
1. En el panel de navegación izquierdo del Microsoft Teams de administración, vaya a la página de tipo de directiva. Por ejemplo, vaya a **Directivas de reunión de**  >  **reuniones.**
...
Es posible que también desee descargar e instalar el módulo [Azure AD PowerShell](/powershell/azure/active-directory/install-adv2) para Graph (si aún no lo ha hecho) y conectarse Azure AD para que pueda recuperar una lista de usuarios de su organización.
