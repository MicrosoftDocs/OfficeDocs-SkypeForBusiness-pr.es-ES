...
- **Cambiar los idiomas de los mensajes de correo de voz y de saludo de correo de voz de un usuario individual.** Puede cambiar el idioma preferido de los usuarios, que cambiará el idioma del saludo del correo de voz y de los mensajes de correo de voz enviados a su buzón de Outlook. Para obtener instrucciones, consulte [Cómo establecer la configuración de idioma y región para Microsoft 365 u Office 365] ( https://docs.microsoft.com/office365/troubleshoot/access-management/set-language-and-region) . 
...
- **¿Quiere cambiar el idioma del mensaje de voz?** Para Skype Empresarial, [https://mysettings.lync.com/voicemail](https://mysettings.lync.com/voicemail) y elige un nuevo idioma en Idioma de **mensaje.** Para Microsoft Teams: los usuarios pueden cambiar el saludo del correo de voz desde la [configuración del cliente de escritorio de Teams](https://support.office.com/article/manage-your-call-settings-in-teams-456cb611-3477-496f-b31a-6ab752a7595f)
...
2. En el Centro de administración de Microsoft 365, elija Configuración  >  **del perfil de** la  >  **organización.** 
...
- [Planear el sistema telefónico en Microsoft 365 u Office 365 con conectividad con RTC local en Skype Empresarial Server](https://go.microsoft.com/fwlink/?LinkId=717947)
    
## <a name="related-topics"></a>Temas relacionados

- [Cambiar el idioma y la zona horaria de la presentación en Microsoft 365 u Office 365 para empresas](https://support.office.com/article/Change-your-display-language-and-time-zone-in-Office-365-for-Business-6f238bff-5252-441e-b32b-655d5d85d15b)
